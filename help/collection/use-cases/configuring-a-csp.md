...
Bovendien moet CSP nonce als attribuut aan de [!DNL Experience Platform Web SDK] [&#x200B; markering van het basiscode &#x200B;](../js/install/library.md) manuscript worden toegevoegd. [!DNL Experience Platform Web SDK] gebruikt deze code vervolgens eenmaal wanneer u inline script- of stijltags aan de pagina toevoegt:

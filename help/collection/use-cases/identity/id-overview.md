...
* Voor terugkerende bezoekers wordt [!DNL ECID] opgehaald uit het `kndctr_{YOUR-ORG-ID}_AdobeOrg_identity` -cookie en toegevoegd aan de payload van de aanvraag door de Edge Network.

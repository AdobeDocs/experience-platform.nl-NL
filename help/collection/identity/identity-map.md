...
* **Orchestrate dwars-kanaalreizen.** [&#x200B; Journey Optimizer &#x200B;](https://experienceleague.adobe.com/docs/journey-optimizer/using/ajo-home.html?lang=nl-NL) gebruikt opgeloste identiteiten om reizen over e-mail, duw, en in-app kanalen teweeg te brengen en te personaliseren die op voor authentiek verklaard gedrag van een bezoeker worden gebaseerd.

...
* **Toepassingsgebied**: De reikwijdte van het besluit.
   ...
   * Voor [!DNL Offer Decisioning], dit zijn de Base64 gecodeerde koorden van JSON die de activiteit en plaatsing IDs bevatten u de dienst van de offer decisioning wilt gebruiken om aanbiedingen voor te stellen.
...
| --- | --- | --- |
| `schemas` | `String[]` | *Optioneel*. Lijst van schema&#39;s die in het besluit worden gebruikt, om het type teruggekeerde aanbiedingen te selecteren. |
...
| `payload.scopeDetails.decisionProvider` | Tekenreeks | Dit zal ofwel `TGT` bij gebruik van Adobe Target of `ODE` indien [!DNL Offer Decisioning]. |
...
## Inhoud ophalen {#retrieve-content}

...
U kunt de Dienst van de Vraag gebruiken om de online-aan-off-line klantenreis aan te sluiten en omni-channel attributie voor uw merk te begrijpen. De volgende video toont hoe een ervaringszaken de Dienst van de Vraag kunnen gebruiken om zeer belangrijke gebruiksgevallen te richten en verklaart hoe de Dienst van de Vraag werkt.

>[!VIDEO](https://video.tv.adobe.com/v/3464267?captions=dut&quality=12&learn=on)
...
Met Adobe Experience Platform kunt u alle opgeslagen datasets, waaronder gedragsgegevens, CRM en verkooppunten, opnemen, opslaan, structureren en ophalen. Gebruikend de Dienst van de Vraag, kunt u deze datasets vragen en specifieke bedrijfsvragen beantwoorden, producerend impactful inzichten. Leer hoe te om douanedashboards te bouwen en te beheren waar u, op maat gemaakte widgets kunt creëren toevoegen en uitgeven om zeer belangrijke metriek met [&#x200B; te visualiseren user-defined dashboards &#x200B;](../dashboards/standard-dashboards.md). U kunt ook [&#x200B; uw eigen rapporten van Real-Time CDP &#x200B;](../dashboards/data-models/cdp-insights-data-model-b2c.md) voor uw marketing en KPI gebruiksgevallen aanpassen door SQL vragen met de Modellen van Gegevens van Real-Time Customer Data Platform te gebruiken Inzichten.

## Volgende stappen en extra bronnen

Door dit document te lezen, bent u geïntroduceerd aan de Dienst van de Vraag en hoe het binnen het grotere werkingsgebied van Experience Platform functioneert. Als u meer wilt weten over de functies van Query Service, wordt u aangeraden de volgende documenten te lezen:

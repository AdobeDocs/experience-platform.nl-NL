...
Gebruik het tabblad **[!UICONTROL Admin]** om gelijktijdige sessies van de Query-editor binnen uw organisatie te controleren en te beheren. Deze mogelijkheid is bedoeld voor beheerders en is niet vereist voor het schrijven of uitvoeren van query&#39;s.

Vanuit het tabblad **[!UICONTROL Admin]** kunnen beheerders actieve sessies weergeven in verschillende sandboxen en inactieve sessies beëindigen om de gedeelde capaciteit vrij te maken. Deze actie onderbreekt geen vragen die actief lopen. Zie [&#x200B; de zittingsgids van de Dienst van de Vraag beheren &#x200B;](session-management.md) voor gedetailleerde instructies en toestemmingsvereisten.

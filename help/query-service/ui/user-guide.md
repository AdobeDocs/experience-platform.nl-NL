...
Gebruik sessiebeheer om actieve Query Editor-sessies in sandboxen weer te geven, inactieve sessies te identificeren en deze te beëindigen om de gedeelde capaciteit vrij te maken. U kunt geen sessies onderbreken die actief query&#39;s uitvoeren. Deze mogelijkheid is alleen bedoeld voor beheerders en vereist de machtiging **[!UICONTROL Manage Query Session]** .

Als u sessiebeheer wilt openen, selecteert u het tabblad **[!UICONTROL Admin]** in de werkruimte van Query Service. Voor geleidelijke instructies aan meningszittingsdetails, interpreteer zittingsstatus, en eind nutteloze zittingen, zie [&#x200B; de zittingen van de Dienst van de Vraag beheren &#x200B;](session-management.md).

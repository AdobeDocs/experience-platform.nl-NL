...
| Resulterende limiet | <ul><li>De Dienst UI van de vraag - het aantal outputrijen kan [&#x200B; met een UI worden gevormd die &#x200B;](./ui/user-guide.md#result-count) aan tussen 50-1000 rijen plaatsen.</li><li>Externe klanten - 50.000</li><li>[!DNL PostgresSQL] client - 50.000</li></ul> | CTAS en ITAS de vragen produceren slechts succesberichten aangezien de vraagoutput in afgeleide datasets wordt opgeslagen. |

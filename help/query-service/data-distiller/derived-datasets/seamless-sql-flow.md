---
title: Naadloze SQL Stroom voor Voortgekomen Datasets
description: SQL van de Dienst van de vraag is uitgebreid om naadloze steun voor afgeleide datasets te verlenen. Leer hoe te om deze SQL uitbreiding te gebruiken om een afgeleide dataset tot stand te brengen die voor profiel wordt toegelaten, en hoe te om de dataset voor de Dienst van het Profiel en van de Segmentatie van de Klant in real time te gebruiken.
...
# Naadloze SQL-stroom voor afgeleide gegevenssets

SQL van de Dienst van de vraag is uitgebreid om naadloze steun voor afgeleide datasets te verlenen. Dit verstrekt een efficiënte alternatieve methode om afgeleide datasets voor uw zaken gebruiksgevallen van het Profiel van de Klant in real time tot stand te brengen.

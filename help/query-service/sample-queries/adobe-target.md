...
In de volgende voorbeelden, zult u SQL moeten uitgeven om de verwachte parameters voor uw vragen in te vullen die op de dataset, variabelen, of timeframe worden gebaseerd u in het evalueren geinteresseerd bent. Geef parameters op waar u ze ziet `{ }` in de SQL.

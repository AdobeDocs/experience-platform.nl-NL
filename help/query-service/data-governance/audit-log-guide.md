...
>[!NOTE]
>
>Handelingen voor sessieverwijdering worden geregistreerd. Voor UI werkschema&#39;s, zie [&#x200B; de zittingen van de Dienst van de Vraag beheren &#x200B;](../ui/session-management.md).
...
Om een controle voor [!DNL Query Service] activiteiten uit te voeren, selecteer **[!UICONTROL Audits]** van de linkernavigatie, die door het pictogram van funnel wordt gevolgd (![&#x200B; A filterpictogram.](/help/images/icons/filter.png)) om een lijst met filterbesturingselementen weer te geven om de resultaten te beperken.

...
In de handleiding voor het analyseren van de toestemming wordt beschreven hoe u een toestemmingsdashboard kunt maken voor verschillende gevallen van gebruik bij het in de handel brengen van Real-Time CDP-gegevens. Als u wilt leren hoe u een dashboard voor de toestemmingsanalyse maakt om te controleren hoe de gebruikerstoestemming in de loop der tijd is verlopen, raadpleegt u de [dashboardgids voor toestemmingsanalyse](../../dashboards/insights-use-cases/consent-analysis.md).

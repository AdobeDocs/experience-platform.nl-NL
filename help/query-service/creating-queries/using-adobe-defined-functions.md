...
topic: queries
type: Tutorial
description: Dit document behandelt Adobe-bepaalde functies (ADFs) om drie zeer belangrijke activiteiten van de Analyse sessionization, attributie, en het kleven te steunen.

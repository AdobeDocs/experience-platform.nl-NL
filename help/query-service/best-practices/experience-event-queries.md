...
topic: queries
type: Tutorial
description: In het volgende document worden voorbeelden gegeven van query's die Experience Events gebruiken.
...
Naast standaard SQL-query&#39;s ondersteunt Adobe Experience Platform [!DNL Query Service] het schrijven van query&#39;s met [!DNL Experience Events]. De Gebeurtenissen van de ervaring worden vertegenwoordigd door de klasse ExperienceEvent van het Gegevensmodel van de Ervaring (XDM), die een onveranderlijke en niet-geaggregeerde momentopname van het systeem vangt wanneer een gebruiker met een website of een dienst interactie heeft, en kan daarom voor tijd-domeinanalyse worden gebruikt.

Meer informatie over XDM en [!DNL Experience Events] kan in [[!DNL XDM System] overzicht](../../xdm/home.md) worden gevonden. Door [!DNL Query Service] te combineren met [!DNL Experience Events], kunt u gedragstrends onder uw gebruikers effectief volgen. In het volgende document worden voorbeelden gegeven van query&#39;s voor [!DNL Experience Events].
...
De tijdstempelkolom in [!DNL Experience Event] datasets is in UTC. In het volgende voorbeeld wordt de functie `from_utc_timestamp()` gebruikt om het tijdstempel te transformeren van UTC naar EDT. Vervolgens wordt de functie `date_format()` gebruikt om de datum te isoleren van de rest van de tijdstempel.

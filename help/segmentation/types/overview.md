...
Na het lezen van dit overzicht hebt u nu een beter inzicht in de verschillende soorten publiek die beschikbaar zijn op Experience Platform. Om over de verschillende evaluatiemethodes te leren, te lezen gelieve het [&#x200B; overzicht van de evaluatiemethode &#x200B;](../methods/overview.md).

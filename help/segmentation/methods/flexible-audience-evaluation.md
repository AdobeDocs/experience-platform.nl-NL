...
- U hebt a **maximum** van 50 flexibele de looppas van de publieksevaluatie per jaar per **productie** zandbak.
   - Een jaar wordt gedefinieerd als één jaar vanaf de datum van uw Experience Platform-contract voor een flexibele publieksevaluatie. Bijvoorbeeld, als u contract op 18 mei begon, zal uw aantal flexibele de looppas van de publieksevaluatie elke 18e mei terugstellen.

...
topic: guide
description: Dit overzichtsdocument verstrekt inleiding op hoog niveau aan elk van de eindpunten van de Dienst API van de Segmentatie, en verbindingen aan de bijbehorende eindpuntgidsen voor details.

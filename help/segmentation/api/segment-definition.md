...
Deze ontwikkelaarsgids verstrekt instructies op de volgende gebieden voor segmentdefinities:

- [Een lijst met segmentdefinities ophalen](#retrieve-a-list-of-segment-definitions)
- [Een nieuwe segmentdefinitie maken](#create-a-new-segment-definition)
- [Een specifieke segmentdefinitie ophalen](#retrieve-a-specific-segment-definition)
- [Een specifieke segmentdefinitie verwijderen](#delete-a-specific-segment-definition)
- [Een specifieke segmentdefinitie bijwerken](#update-a-specific-segment-definition)
...
| `sort` | Opgegeven op welk veld de resultaten moeten worden gesorteerd. |
...
hoofdtekst en koppen verklaren
...
hoofdtekst en koptekst uitleggen

...
U kunt het ![&#x200B; montagespictogram &#x200B;](/help/images/icons/settings.png) selecteren om de montages voor de getoonde gebieden aan te passen.

Voor **[!UICONTROL Available fields]**, kunt u of slechts de gebieden tonen die gegevens of het volledige schema XDM bevatten.

Voor **[!UICONTROL Data sources]**, kunt u filtreren om attributen te tonen die uit de gespecificeerde inspraaktypes komen. Tot de ondersteunde waarden behoren **[!UICONTROL Show batch data]** , **[!UICONTROL Show streaming/edge data]** en **[!UICONTROL Show fields with no ingested data]** .

Voor **[!UICONTROL Merge policy]** kunt u kiezen tot welk samenvoegbeleid de velden behoren.

![&#x200B; het montagegebied wordt getoond binnen de Bouwer van het Segment.](../images/ui/segment-builder/settings.png)
...
| Starts with (Begint met) | De tekst begint met de opgegeven waarde | Identiteitskaart van de klant **begint met** &quot;PREM&quot; |
| Ends with (Eindigt met) | De tekst eindigt met de opgegeven waarde | E-mail **beëindigt met** &quot;@company.com&quot; |
...
Wanneer u een attribuut selecteert, kunt u de summiere gegevens zien door het [&#x200B; informatiepictogram &#x200B;](../../images/icons/info.png) te selecteren. De samenvattingsgegevens bevatten informatie zoals een uitleg van wat het veld is, het aantal records van de waarden en het percentage accounts dat waarden voor deze eigenschap bevat.

In de sectie **[!UICONTROL Top values]** worden de meest voorkomende waarden voor het kenmerk weergegeven. Deze sectie bevat details zoals de waarde, het aantal records dat de waarde bevat, en het percentage van het totale aantal records dat de waarde vertegenwoordigt.

![&#x200B; popover A die de summiere gegevens voor een attribuut &#x200B;](/help/segmentation/images/ui/segment-builder/summary-data.png) toont

Als een attribuut door minder dan 25% van profielen wordt bevolkt, zal het ![&#x200B; pictogram van de gegevensaankondiging &#x200B;](../../images/icons/data-notice.png) in plaats daarvan worden getoond. Dezelfde samenvattingsgegevens worden ongeacht het kenmerk weergegeven.

>[!NOTE]
>
>De hoogste waarden worden slechts getoond als het gebied **&#x200B;**&#x200B;niet teveel verschillende waarden bevat en als de waarden van dat gebied algemeen worden herhaald. Bovendien, wordt deze summiere gegevens bijgewerkt op a **dagelijks** basis.
...
![&#x200B; het innametype voor de attributen wordt getoond.](/help/segmentation/images/ui/segment-builder/ingestion-type.png)
...
| --------------- | ----------- | ------------------- | ------- |
| Vandaag | De attributen of de gebeurtenis die **worden vergeleken moeten** vandaag voorkomen. Dit is de standaardtijdbeperking die is geselecteerd. | Ja | ![&#x200B; een voorbeeld van de &quot;Vandaag&quot;tijdbeperking die wordt gebruikt.](../images/ui/segment-builder/time-constraints/today.png){width="100" zoomable="yes"} |
...
| Nu | Het attribuut of de gebeurtenis die **worden vergeleken moet** recht voorkomen wanneer het publiek wordt geëvalueerd. Deze tijdbeperking kan alleen worden gebruikt als optie op secundair niveau, binnen tijdbeperkingen zoals &quot;Voor&quot; of &quot;Na&quot;. | Ja | ![&#x200B; een voorbeeld van de &quot;Nu&quot;tijdbeperking die wordt gebruikt.](../images/ui/segment-builder/time-constraints/now.png){width="100" zoomable="yes"} |

>[!TIP]
>
>Het verschil tussen de tijdbeperking &#39;Vandaag&#39; en de tijdbeperking &#39;Nu&#39; is subtiel, maar belangrijk.
>
>- Gebruik de &quot;Vandaag&quot;tijdbeperking om te controleren als de attributen of de gebeurtenis die bij **middernacht** van de huidige dag worden vergeleken gebeuren.
>- Gebruik de &quot;Nu&quot;tijdbeperking om te controleren als de attributen of de gebeurtenis die **worden vergeleken nu** gebeurt.
>
>Nochtans, is er één belangrijke uitzondering - als u &quot;Vandaag&quot;als top-level tijdbeperking gebruikt, betekent dat u controleert of de attributen of de gebeurtenis bij **om het even welk** punt vandaag voorkwam.

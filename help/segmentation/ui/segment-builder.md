...
### Query-validatie {#query-validation}
...
De Bouwer van het segment analyseert en bevestigt automatisch uw publieksvragen om u aan de beste praktijken van de publieksdefinitie te verzekeren. Deze beste praktijken kunnen in twee categorieën worden geplaatst: kritieke bevestiging en prestatiesoptimalisering.

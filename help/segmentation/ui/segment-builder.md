...
>abstract="Geschatte profielen geven een geschat aantal profielen aan, gebaseerd op de voorbeeldtaak, die in aanmerking zouden komen voor de regels van de segmentdefinitie. Dit betekent dat de steekproefgegevens worden geprojecteerd op de grotere profielreeks, resulterend in een geschat aantal dat van het daadwerkelijke aantal gekwalificeerde profielen kan verschillen. Het geschatte profielmonster heeft een 95% betrouwbaarheidsinterval. <br><br> Dit aantal wordt bijgewerkt wanneer de steekproefbaan wordt bijgewerkt, die voorkomt wanneer er een grotere dan 5% verandering in klantengegevens is of de laatste steekproefbaan ouder is dan 7 dagen."
...
Dit aantal wordt bijgewerkt wanneer de steekproefbaan wordt bijgewerkt, die voorkomt wanneer er een meer dan 5% verandering in klantengegevens is of de laatste steekproefbaan ouder is dan 7 dagen.&quot;

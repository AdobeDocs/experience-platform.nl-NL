...
>
>* Voor klanten in de Verenigde Staten, Canada, Australië, Nieuw-Zeeland en EMEA: Adobe raadt Real-Time CDP Prime en Ultimate aan samenwerkingsaanvragen voor overgangsgegevens in te voeren van [!DNL Segment Match] naar Real-Time CDP Collaboration. Bekijk de [&#x200B; documentatie &#x200B;](https://experienceleague.adobe.com/en/docs/real-time-cdp-collaboration/using/home) en [&#x200B; gids snel-begin &#x200B;](https://experienceleague.adobe.com/en/docs/real-time-cdp-collaboration/using/quick-start-guide) voor Real-Time CDP Collaboration en contacteer uw de rekeningsteam van Adobe om meer te leren.

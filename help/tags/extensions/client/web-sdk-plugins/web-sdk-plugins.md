---
title: Algemeen overzicht van SDK-plug-ins voor het web
...
# Algemeen overzicht van SDK-plug-ins voor het web
...
>[!IMPORTANT]
>
>De gemeenschappelijke uitbreiding van de Insteekmodules van SDK van het Web is bedoeld om de uitbreiding van SDK van het Web van Adobe Experience Platform te versterken, nochtans, te hoeven u niet om het geïnstalleerd voor de uitbreiding te hebben om te werken zoals verwacht.
...
* `"latitude=[LATITUDE] | longtitude=[LONGITUDE]"`: waarbij `[LATITUDE]/[LONGITUDE]` respectievelijk de breedte en lengte is
...
* `rp` (optioneel, geheel getal OF tekenreeks): Het aantal dagen voordat de teller van het bezoeknummer opnieuw wordt ingesteld.  Wordt standaard ingesteld op `365` wanneer niet ingesteld.
   * Wanneer dit argument `"w"` is, stelt de teller aan het eind van de week (deze Zaterdag bij 11 :59 PM) terug

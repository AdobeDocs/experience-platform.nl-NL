...
# Opmerkingen bij de release Web SDK-tagextensie

In dit document worden de releaseopmerkingen voor de Adobe Experience Platform Web SDK-tagextensie besproken. Voor de recentste versienota&#39;s op SDK zelf, zie de [&#x200B; de versienota&#39;s van SDK van het Web van Adobe Experience Platform &#x200B;](/help/collection/js/release-notes.md).

## Versie 2.34.2 - 23 maart 2026

- Bevat [&#x200B; versie 2.32.0 &#x200B;](/help/collection/js/release-notes.md) van het Web SDK van Adobe Experience Platform.
- Probleem verholpen met betrekking tot het kopiëren van een eigenschap Codes waarbij handelingen Variabele bijwerken verwijzingen naar gegevenselementen van de oorspronkelijke eigenschap konden behouden. Om bestaande gekopieerde eigenschappen te herstellen, opent en bewaart elke beïnvloede actie van de Verandering van de Update en zijn regel opnieuw. Vermijd het hernoemen van de gekopieerde gegevenselementen tot na het opnieuw opslaan.

## Versie 2.34.1 - 11 februari 2026

- Bevat [&#x200B; versie 2.31.1 &#x200B;](/help/collection/js/release-notes.md) van het Web SDK van Adobe Experience Platform.
- Vaste een kwestie waar [&#x200B; de configuratiemontages van Adobe Advertising &#x200B;](configure/advertising.md) niet konden worden uitgegeven in [&#x200B; verzendt de acties van de Gebeurtenis &#x200B;](actions/send-event.md).
- Toegevoegd een reserve aan `edge.adobedc.net` voor [&#x200B; Edge domein &#x200B;](configure/general.md) configuratie die wanneer a `tenant-id` niet beschikbaar is.

## Versie 2.34.0 - 9 februari 2026

**Nieuwe functies**

- Bevat [&#x200B; versie 2.31.0 &#x200B;](/help/collection/js/release-notes.md) van het Web SDK van Adobe Experience Platform.

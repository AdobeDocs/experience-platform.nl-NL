...
* **[!UICONTROL Surfaces]**: Een array met oppervlakken die moeten worden opgevraagd met de gebeurtenis. Zie [ Webervaringen ](https://experienceleague.adobe.com/docs/journey-optimizer/using/web/create-web.html) in de documentatie van Adobe Journey Optimizer voor meer informatie creëren. Wanneer u handmatig oppervlakken invoert, vertegenwoordigt elk veld één oppervlak. Selecteer **[!UICONTROL Add surface]** om meer oppervlakken aan de actie toe te voegen.
* **geeft visuele verpersoonlijkingsbesluiten terug:** checkbox A die, wanneer toegelaten, u gepersonaliseerde inhoud op de pagina laat teruggeven. Zie [ gepersonaliseerde inhoud ](/help/collection/use-cases/personalization/rendering-personalization-content.md#automatically-rendering-content) voor meer informatie teruggeven.

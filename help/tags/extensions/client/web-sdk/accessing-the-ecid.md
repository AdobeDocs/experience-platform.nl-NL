...
U kunt tot ECID of via [&#x200B; Prep van Gegevens voor de Inzameling van Gegevens &#x200B;](/help/datastreams/data-prep.md) (geadviseerd) of via markeringen toegang hebben.

## Toegang tot de ECID via Data Prep (voorkeursmethode) {#accessing-ecid-data-prep}

Deze methode gebruikt [&#x200B; Prep van Gegevens voor de Inzameling van Gegevens &#x200B;](/help/datastreams/data-prep.md) om een douanetoewijzing voor `ECID` te vormen.

Zie [&#x200B; Prep van Gegevens voor de documentatie van de Inzameling van Gegevens &#x200B;](/help/datastreams/data-prep.md) leren hoe te om deze eigenschap te gebruiken.
...
1. Verzeker uw bezit met [&#x200B; wordt gevormd regelcomponent die &#x200B;](/help/tags/ui/managing-resources/rules.md#sequencing) wordt toegelaten rangschikken.

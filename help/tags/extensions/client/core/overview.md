...
**is Waarheid:** de voorwaarde keert waar terug als de waarde na wordt omgezet in boolean waar is. Zie [&#128279;](https://developer.mozilla.org/en-US/docs/Glossary/Truthy) van de Vertrouwelijke documentatie van 0&rbrace; MDN voor voorbeelden van waarheidswaarden.
...
De handeling wordt rechtstreeks toegewezen aan de [`track` methode ](../../../ui/client-side/satellite-object.md#track) in het `satellite` -object, dat kan worden benaderd door code aan de clientzijde.

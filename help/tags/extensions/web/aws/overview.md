...
![De [!UICONTROL Install] knop die wordt geselecteerd voor de [!UICONTROL AWS] in de UI voor gegevensverzameling.](../../../images/extensions/aws/install.png)
...
![De toegangs belangrijkste identiteitskaart en geheime toegangssleutel die in de mening van de uitbreidingsconfiguratie worden toegevoegd.](../../../images/extensions/aws/credentials.png)
...
![De [!UICONTROL Send Data to Kinesis Data Stream] actietype dat voor een regel in de Inzameling UI van Gegevens wordt geselecteerd.](../../../images/extensions/aws/select-action-type.png)
...
![De configuratieopties voor de [!UICONTROL Send Data to Kinesis Data Stream] actietype dat in UI wordt getoond.](../../../images/extensions/aws/data-stream-details.png)

...
### Voeg de [!UICONTROL Algolia Event Details] veldgroep toe aan uw schema {#add-algolia-field-group}

De veldgroep [!UICONTROL Algolia Event Details] toevoegen:
...
Selecteer de **[!UICONTROL Algolia Event Details]** veldgroep > **[!UICONTROL Add field group]** knop > **[!UICONTROL Save]** .

...
| [!UICONTROL Phone] | Telefoon fungeert als id die overeenkomt met de conversiegebeurtenis. Het telefoonnummer moet de E164-notatie `[+][country code][area code][local phone number]` hebben voordat u het hasht. | `+911234567875` | Vereist als er geen andere id is toegevoegd. |
...
* [[!DNL Twitter]  Token van de Toegang van 0&rbrace; Gebruiker](https://developer.twitter.com/en/docs/authentication/oauth-1-0a/obtaining-user-access-tokens)

...
![De [!UICONTROL Google Global Site Tag (gtag)] die onder de [!UICONTROL Extensions] in de [!UICONTROL Data Collection] UI.](../../../images/extensions/server/google-ads-enhanced-conversions/install-gtag-extension.png)
...
![De [!UICONTROL Send an event] actietype dat binnen de mening van de actieconfiguratie van de regel het uitgeven werkschema wordt geselecteerd.](../../../images/extensions/server/google-ads-enhanced-conversions/select-client-action.png)
...
![De [!UICONTROL Google Ads Enhanced Conversions] die onder de [!UICONTROL Extensions] in de [!UICONTROL Data Collection] UI.](../../../images/extensions/server/google-ads-enhanced-conversions/install-enhanced-conversions.png)
...
![De [!UICONTROL Send Conversion] actietype dat binnen de mening van de actieconfiguratie van de regel het uitgeven werkschema wordt geselecteerd.](../../../images/extensions/server/google-ads-enhanced-conversions/select-server-action.png)
...
>
>![De [!UICONTROL Normalize & Hash] schakelen ingeschakeld voor de [!UICONTROL Email] invoer binnen de [!UICONTROL Send Conversion] actieconfiguratieformulier.](../../../images/extensions/server/google-ads-enhanced-conversions/hash-user-id-values.png)

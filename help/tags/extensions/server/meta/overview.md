...
>[!NOTE]
>
>Met de functie Geleide installatie kunt u eenvoudig en efficiënt aan de slag gaan. Met dit gereedschap worden meerdere stappen geautomatiseerd die worden uitgevoerd in Adobe-tags en het doorsturen van gebeurtenissen. Het zal geen eind-aan-eind, volledig functionele implementatie leveren die alle gebruiksgevallen aanpast.

Om met de geleide opstelling begonnen te worden, volg de instructies in de [&#x200B; Gebeurtenis door:sturen geleide opstelling &#x200B;](../../../ui/event-forwarding/guided-setup.md).

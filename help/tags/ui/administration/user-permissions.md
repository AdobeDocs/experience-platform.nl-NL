...
| **Publish** | Hierdoor kunt u goedgekeurde bibliotheken publiceren naar de productieomgeving. |
...
| Het IT-team | Wijzig eigenlijk geen markeringen, maar zij hebben volledige controle over de het opvoeren en productiemilieu&#39;s en wat in hen is. | Automatisch opnemen | (Geen) | <ul><li>Goedkeuren</li><li>Publish</li><li>Omgevingen beheren</li></ul> |
...
| De supergebruiker | Doe alles. | Automatisch opnemen | <ul><li>Ontwikkelen</li><li>Goedkeuren</li><li>Publish</li><li>Extensies beheren</li><li>Omgevingen beheren</li></ul> | <ul><li>Eigenschappen beheren</li></ul> |

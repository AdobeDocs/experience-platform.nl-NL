...
Er zijn verschillende niveaus van gebruikerstoestemmingen die voor de het publiceren stroom belangrijk zijn; specifiek, [!UICONTROL Develop], [!UICONTROL Approve], en [!UICONTROL Publish] bezitsrechten:
...
Zie [gebruikerstoestemmingengids](../administration/user-permissions.md) voor meer informatie over het beheren van toestemmingen voor markeringen.
...
Deze vier staten worden vertegenwoordigd als kolommen binnen **[!UICONTROL Publishing Flow]** lusje in de UI van de Inzameling van Gegevens.
...
Wanneer nieuwe bibliotheken worden gecreeerd, beginnen zij in de [!UICONTROL Development] staat. Wijzigingen in een bibliotheek moeten worden aangebracht terwijl de bibliotheek zich in [!UICONTROL Development] bevindt. Wanneer de ontwikkeling en het testen zijn voltooid, kan de bibliotheek ter goedkeuring worden ingediend.
...
| [!UICONTROL Submit for Approval] | Wijzig de toewijzing van de bibliotheek uit de ontwikkelomgeving en verplaats de bibliotheek naar de kolom [!UICONTROL Submitted] zodat een gebruiker met goedkeuringsmachtigingen eraan kan werken. Deze optie is alleen ingeschakeld als de meest recente build voor de bibliotheek is gelukt. |
...
| [!UICONTROL Approve for Publishing] | Verplaats de bibliotheek naar de kolom [!UICONTROL Approved] voor een gebruiker met het publiceren toestemmingen om aan te werken. |
| [!UICONTROL Approve & Publish to Production] | Dit kan alleen worden uitgevoerd door een gebruiker met zowel Goedkeuren als Publicatierechten. Met deze handeling wordt de toewijzing van de bibliotheek uit de testomgeving verwijderd, wordt de bibliotheek naar de status [!UICONTROL Approved] verplaatst en wordt de bibliotheek naar de productie gepubliceerd. Nadat de productiebuild is voltooid, wordt de bibliotheek verplaatst naar de status [!UICONTROL Published]. Dit kan met ons zonder een succesvolle bouwstijl in het opvoeren van milieu worden uitgevoerd. |
| [!UICONTROL Reject] | Wijzig de toewijzing van de bibliotheek in de staging-omgeving en verplaats de bibliotheek terug naar de kolom [!UICONTROL Development] voor verdere wijzigingen. |
...
| [!UICONTROL Reject] | Wijzig de toewijzing van de bibliotheek in de testomgeving en verplaats de bibliotheek naar de kolom [!UICONTROL Development] voor verdere wijzigingen. |

### [!UICONTROL Published] {#published}

De kolom [!UICONTROL Published] toont welke bibliotheken zijn gepubliceerd en hun publicatiedata. De momenteel gepubliceerde bibliotheek wordt weergegeven met een groene stip ernaast. Tenzij u een republish op een vorige bibliotheek hebt uitgevoerd, zal dit altijd de bibliotheek bij de bovenkant van de kolom zijn.
...
De sectie breidt zich uit om de individuele middelen te tonen die van upstream worden geërft. U kunt de linkerspoorlijn gebruiken om tussen [!UICONTROL Rules], [!UICONTROL Data Elements], en [!UICONTROL Extensions] te filtreren, of de onderzoeksbar te gebruiken om een specifieke middel door naam op te zoeken.

![](./images/approval-workflow/upstream-resources.png)

## Volgende stappen

Deze handleiding biedt een uitgebreid overzicht van de publicatiestroom voor bibliotheken in Adobe Experience Platform. Raadpleeg het [publicatieoverzicht](./overview.md) voor meer informatie over het publiceren van bibliotheken.

...
* Een extensieontwikkelaar kan een extensiepakket dat in ontwikkeling was, stoppen en zo een probleem creëren waarbij de ontwikkelaar geen nieuwe versies van het extensiepakket meer kon POSTEN of PATCH.  Dit is opgelost door de mogelijkheid te verwijderen om extensiepakketten in ontwikkeling te stoppen. Zie [Een ExtensionPackage beëindigen](https://developer.adobelaunch.com/api/reference/1.0/extension_packages/discontinue/) voor meer informatie.

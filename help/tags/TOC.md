...
* Gebeurtenis doorsturen {#event-forwarding}
   ...
   * [Instellingen met instructies](./ui/event-forwarding/guided-setup.md)
...
* Extensies {#extensions}
   ...
   * Tagextensies (client-side) {#client}
      ...
      * Adobe Experience Platform Web SDK {#web-sdk}
         ...
         * [Aan de slag](extensions/client/web-sdk/getting-started.md)
         * Configureren {#configure}
            * [Overzicht](extensions/client/web-sdk/configure/config-overview.md)
            * [Opties voor samenstellen](extensions/client/web-sdk/configure/custom-build-components.md)
            * [SDK-exemplaar](extensions/client/web-sdk/configure/general.md)
            * [Gegevensstromen](extensions/client/web-sdk/configure/datastreams.md)
            * [Toestemming](extensions/client/web-sdk/configure/consent.md)
            * [Identiteit](extensions/client/web-sdk/configure/identity.md)
            * [Personalisatie](extensions/client/web-sdk/configure/personalization.md)
            * [Dataverzameling](extensions/client/web-sdk/configure/data-collection.md)
            * [Streaming media](extensions/client/web-sdk/configure/streaming-media.md)
            * [Pushmeldingen](extensions/client/web-sdk/configure/push-notifications.md)
            ...
            * [Configuratieoverschrijvingen](extensions/client/web-sdk/configure/configuration-overrides.md)
            * [Geavanceerde instellingen](extensions/client/web-sdk/configure/advanced-settings.md)
         * [Gebeurtenistypen](extensions/client/web-sdk/event-types.md)
         * Typen handelingen {#actions}
            * [Overzicht](extensions/client/web-sdk/actions/actions-overview.md)
            * [Proposities toepassen](extensions/client/web-sdk/actions/apply-propositions.md)
            * [Antwoord toepassen](extensions/client/web-sdk/actions/apply-response.md)
            * [Regels evalueren](extensions/client/web-sdk/actions/evaluate-rulesets.md)
            * [Media Analytics-tracker ophalen](extensions/client/web-sdk/actions/get-media-analytics-tracker.md)
            * [Omleiden met identiteit](extensions/client/web-sdk/actions/redirect-with-identity.md)
            * [Y-ID van gebeurtenis opnieuw instellen](extensions/client/web-sdk/actions/reset-event-merge-id.md)
            * [Gebeurtenis Send](extensions/client/web-sdk/actions/send-event.md)
            * [Media-gebeurtenis verzenden](extensions/client/web-sdk/actions/send-media-event.md)
            * [Push-abonnement verzenden](extensions/client/web-sdk/actions/send-push-subscription.md)
            * [Goedkeuring instellen](extensions/client/web-sdk/actions/set-consent.md)
            * [Variabele bijwerken](extensions/client/web-sdk/actions/update-variable.md)
      ...
      * [!DNL Algolia] Inzichten {#algolia-insights}
         * [Overzicht](./extensions/client/algolia/overview.md)
      ...
      * [&#x200B; Analytics van de Speler JW &#x200B;](https://exchange.adobe.com/apps/ec/101523)
   ...
   * Gebeurtenis die uitbreidingen (server-kant) door:sturen {#server}
      ...
      * [!DNL Nextdoor] {#nextdoor}
         * [Overzicht](./extensions/server/nextdoor/overview.md)
      * [&#x200B; Hub van het Besluit van de Klant van Pega &#x200B;](https://exchange.adobe.com/apps/ec/107597)
      * [!DNL Pinterest] {#pinterest}
         * [Overzicht](./extensions/server/pinterest/overview.md)
      * [!DNL Reddit] {#reddit}
         * [Overzicht](./extensions/server/reddit/overview.md)
      * [!DNL Snapchat] {#snap}
         * [Overzicht](./extensions/server/snap/overview.md)
      * [!DNL Snowflake] {#snowflake}
         * [Overzicht](./extensions/server/snowflake/overview.md)
      * [!DNL Splunk] {#splunk}
...
* Uitbreiding {#extension-dev}
   ...
   * Verzendproces {#submit}
      ...
      * [Een zip met een extensiepakket maken](./extension-dev/submit/create-extension-package-zip.md)
   ...
   * [Gedeelde privé-extensies](./extension-dev/shared-private-extensions.md)
* Reactor-API {#api}

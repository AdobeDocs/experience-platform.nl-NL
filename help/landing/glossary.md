...
# Verklarende woordenlijst van het Adobe Experience Platform {#adobe-experience-platform-glossary}
...
**Handeling:** In de Lancering van het Platform van de Ervaring, is een actie een specifiek type van regelcomponent die bepaalt wat zou moeten gebeuren nadat een gebeurtenis voorkomt en de voorwaarden worden geëvalueerd en overgegaan.

**Activeren:** In het Real-Time Customer Data Platform is activate de actie die een gebruiker heeft ondernomen om een segment of profielen toe te wijzen aan een bestemming zoals Oracle Eloqua, Google of Salesforce Marketing Cloud.

**Activiteit:** In de Beslissingsdienst, is een activiteit een reeks aanbiedingen de teler wil de besluitvormingsmotor de beste aanbieding van selecteren.

**Adobe Admin Console:** Adobe Admin Console verstrekt een centrale plaats voor het beheren van toegang en eigenschaptoestemmingen voor uw organisatie.

**Adobe Experience Platform:** Het Adobe Experience Platform zorgt voor standaardisering van gegevens en inhoud in de hele onderneming, zodat u in real-time consumentenprofielen kunt gebruiken, gegevenswetenschap kunt inschakelen en de snelheid van de inhoud kunt versnellen om de persoonlijke functionaliteit van de klant te verbeteren.

**Adobe-connectors:** Adobe Connectors zijn vooraf geconfigureerde verbindingen die door Adobe zijn gemaakt om gegevens in- en uit-van-ervaringsplatform te laten stromen. De schakelaars omvatten de Dynamica van Microsoft, Salesforce, Amazon S3, en Azure Blob.

**Adobe Intelligent Services:** Adobe Sensei is het intelligentiekader dat het Platform van de Ervaring drijft. Het verstrekt ook een reeks diensten AI die merken machtigt om hun capaciteit te verbeteren om in real time, gepersonaliseerde klantenervaringen te leveren.

**Adobe I/O:** Adobe I/O maakt deel uit van het Experience Platform en biedt toegang tot alles wat ontwikkelaars nodig hebben om het Adobe Experience Platform te integreren, uit te breiden en aan te passen, inclusief API&#39;s, gebeurtenissen, de ontwikkelaarsconsole en handige gereedschappen.

**Adobe Sensei:** Adobe Sensei is het intelligentiekader dat het Platform van de Ervaring drijft. Het verstrekt ook een reeks diensten AI die merken machtigt om hun capaciteit te verbeteren om in real time, gepersonaliseerde klantenervaringen te leveren.

**Amazon S3 bucket:** Amazon S3 buckets zijn de basiscontainers voor gegevens die in het Amazon-ecosysteem worden opgeslagen. Emmers bevatten objecten. Elk object wordt opgeslagen en opgehaald met een unieke door de ontwikkelaar toegewezen sleutel.

**Amazon S3-connector:** Met de Amazon S3-connector kunnen klanten van Experience Platform veilig verbinding maken met en toegang krijgen tot hun Amazon S3-gegevens.

**Opslagstrategie toevoegen:** De `Append` opslagstrategie is een optie die wordt gebruikt wanneer gegevens van derden worden opgegeven die via een verbinding moeten worden ingevoerd en wanneer nieuwe gegevens of rijen aan het einde van de gegevensset worden toegevoegd. De eerder opgenomen rijen blijven ongewijzigd en alleen de rijen die zijn gemaakt sinds de laatste geplande uitvoering, worden opgenomen in Experience Platform. Alle rijen die zijn gewijzigd in het bronsysteem blijven ongewijzigd op het Experience Platform.
...
**Kunstmatige inlichtingen:** Kunstmatige intelligentie is een theorie en ontwikkeling van computersystemen die taken kunnen uitvoeren die normaal menselijke intelligentie vereisen, zoals visuele waarneming, spraakherkenning, besluitvorming en vertaling tussen talen.
...
**Batch-id:** De batch-id is een door Adobe gegenereerde id voor een batch met gegevens.

**Batchinname:** Met het inslikken van batterijen kunnen gebruikers petabytes aan gegevens innemen en deze beschikbaar maken in bedrijfssystemen. Met de recentste technologieën, kunnen de gebruikers om het even welk schema XDM en niet-XDM in het Platform van de Ervaring nu opnemen.
...
**Opbouwen:** In de Lancering van het Platform van de Ervaring, is een bouwstijl een opgestelde bibliotheek. De build is een bestand of set bestanden met alle configuraties en code die nodig zijn om de bedrijfslogica in die bibliotheek uit te voeren.

**Business Intelligence Tools:** De bedrijfsintelligentie, die ook &quot;BI&quot;hulpmiddelen wordt bekend is hoofdzakelijk geïntegreerd met de Dienst van de Vraag van het Platform van de Ervaring. BI-gereedschappen zijn typen toepassingssoftware die grote hoeveelheden ongestructureerde gegevens van interne en externe systemen verzamelen en verwerken.

[Terug naar boven](#adobe-experience-platform-glossary)

## C

**Afbeelding:** In de Dienst van Beslissing, wordt het maximum gebruikt in beslissingsregels om te bepalen hoe vaak een aanbieding wordt voorgesteld. Er zijn twee soorten plafonds, hoeveel keer een aanbod kan worden voorgesteld over het gecombineerde doelpubliek, ook bekend als &quot;Global Cap&quot; en hoeveel keer een aanbod kan worden voorgesteld aan dezelfde eindgebruiker, ook wel bekend als &quot;Profile Cap&quot;.

**Catalogus:** In het Real-time platform van de Gegevens van de Klant, in bronnen en bestemmingen, is een catalogus met beschikbare verbindingen aan de toepassingen van Adobe en de technologieën van de 3de Partij.
...
**Client:** Een cliënt is een extern hulpmiddel of een toepassing die met de Dienst van de Vraag via postgres protocol of HTTP API verbindt.

**Verzameling:** In de Beslissingsdienst, zijn de inzamelingen ondergroepen aanbiedingen die op vooraf bepaalde voorwaarden worden gebaseerd door een marktspeler, zoals categorie van de aanbieding worden bepaald.

**Opdrachtregelinterface:** De Interface van de Lijn van het bevel is een hulpmiddel van de bevellijn dat wordt gebruikt om met de Dienst van de Vraag voor ruwe vraaguitvoering te verbinden.

**Compositie**: Een samenstelling is een groepering van componenten die samen vormen om omhoog het schema te maken.

**Verbinding:** Een verbinding is een virtuele pijpleiding die gegevens om binnen en uit het Platform van de Ervaring toelaat te stromen. Verbindingen worden nu vervangen door Bronnen.

**Connector:** Met de Adobe Experience Platform Source-connectors kunnen gebruikers eenvoudig gegevens uit meerdere bronnen innemen, zodat ze gegevens kunnen structureren, labelen en verbeteren met behulp van Experience Platform Services. Gegevens kunnen worden ingevoerd uit verschillende bronnen, zoals cloudgebaseerde opslag, software van derden en CRM-systemen.

**Voorwaarde:** In de Lancering van het Platform van de Ervaring, is een voorwaarde een regelcomponent die een logische verklaring evalueert die moet terugkeren `true` of `false`. Alle voorwaarden moeten evalueren aan `true` en alle uitzonderingsvoorwaarden moeten evalueren aan `false` alvorens om het even welke acties op de regel worden uitgevoerd.

**Console:** In de Dienst van de Vraag, verstrekt de console informatie over de status en de verrichting van een Vraag. De console toont de verbindingsstatus aan de Dienst van de Vraag, vraagverrichtingen die, en om het even welke foutenmeldingen worden uitgevoerd die uit die vragen voortvloeien.
...
**Tabel maken als selectie:** Creeer Lijst zoals Uitgezocht is een SQL bevel dat, wanneer uitgevoerd als deel van een volledige en geldige SQL vraag, de Dienst van de Vraag zal instrueren om de resultaten van de vraag in een dataset op het Meer van Gegevens voort te zetten. De volgende opties zijn beschikbaar: Nieuw maken, Alle vorige overschrijven en Toevoegen aan vorige.
...
**Klant-AI:** Klantenservice AI is een Adobe Sensei-service die klantprofielen verrijkt met op AI gebaseerde eigenschappen en die de segmentering en doelgerichtheid van klanten mogelijk maakt.

[Terug naar boven](#adobe-experience-platform-glossary)

## D

**Gegevenswoordenboek:** In de Lancering van het Platform van de Ervaring, is een gegevenswoordenboek een reeks gegevenselementen die binnen een bezit worden bepaald.

**Gegevenselement:** In de Lancering van het Platform van de Ervaring, is een gegevenselement een wijzer die binnen regels en uitbreidingen wordt gebruikt om aan een specifiek stuk van gegevens te richten die op het cliëntapparaat bestaan.

**Gegevenslaag:** In de Lancering van het Platform van de Ervaring, is een gegevenslaag een gegevensstructuur die op het cliëntapparaat bestaat die meta-gegevens over de context bevat waarin een pagina of het scherm wordt bekeken.
...
**Partners voor gegevensintegratie:** De partners van de gegevensintegratie vereenvoudigen en automatiseren het laden en de transformatie van enorme hoeveelheden gegevens van meer dan 200 bronnen aan het Platform van de Ervaring zonder code te schrijven.
...
**Beslissingsservice:** De beslissingsdienst is inzameling van de diensten en UI die marketers toelaat om eindgebruiker gepersonaliseerde aanbiedingservaringen over kanalen en toepassingen tot stand te brengen en te leveren gebruikend bedrijfslogica en besluitvormingsregels.
...
**Doelcategorie:** Een bestemmingscategorie is een groepering van de bestemmingen van het Platform van Gegevens van de Klant in real time die gelijkaardige kenmerken hebben.

**Doelcatalogus:** Een bestemmingscatalogus is een lijst van beschikbare bestemmingen in het Platform van de Gegevens van de Klant in real time.
...
**Gebeurtenis** in de Lancering van het Platform van de Ervaring, is een gebeurtenis een specifiek type van regelcomponent, een trekker die op een cliëntapparaat voorkomt om met de uitvoering van een regel te beginnen.

**Gebeurtenissen:** Gebeurtenissen zijn de gedragsgegevens die aan een profiel zijn gekoppeld.

**Experience Data Model (XDM):** Experience Data Model (XDM) is het concept van het gebruik van standaardschema&#39;s voor het verenigen van gegevens voor gebruik met Experience Platform en Adobe Experience Cloud toepassingen. XDM gestandaardiseert hoe de gegevens gestructureerd zijn en versnelt en vereenvoudigt het proces om inzichten van enorme hoeveelheden gegevens te verkrijgen.
...
**GDPR-gegevenslabel:** Het GDPR-governansetiket wordt gebruikt om de velden te definiëren die persoonlijke id&#39;s kunnen bevatten voor gebruik in GDPR-toegang en/of verzoeken tot verwijdering.

[Terug naar boven](#adobe-experience-platform-glossary)

## H

**Host:** In de Lancering van het Platform van de Ervaring, specificeert een gastheer de plaats, het domein, en gebruikersgeloofsbrieven noodzakelijk voor Lancering om een bouwstijl te leveren.
...
**Naamruimte identiteit:** Een naamruimte van een identiteit is een id, zoals een cookie-id, apparaat-id of e-mailadres, waarmee de context wordt aangegeven waarin gegevens afkomstig zijn. Deze id wordt gebruikt om id&#39;s in Experience Cloud te herkennen en aan elkaar te koppelen.

**Identiteitsservice:** De gebruikersinterface van de Experience Platform Identity Service maakt en beheert de identiteitstypen om het koppelen van identiteiten tussen apparaten en kanalen mogelijk te maken voor een volledige gebruikersweergave vanuit het Real-time Klantprofiel.
...
**I2-gegevenslabel:** Het `I2` gegevensetiket wordt gebruikt om indirect identificeerbare gegevens te classificeren die in combinatie met andere gegevens kunnen worden gebruikt om een specifieke persoon te identificeren of contact op te nemen.

**Samenvatting:** Ingestie is het proces om gegevens van een bron aan het Platform van de Ervaring toe te voegen. Gegevens kunnen op een aantal manieren worden opgenomen in Experience Platform, zoals gestreamd, in batches of via connector toegevoegd.

**Ingestieschema:** Ingestieschema biedt op tijd gebaseerde opties bij het opnemen van een bron naar het Experience Platform.
...
**Intelligente services:** Intelligente services zoals Attribution.ai en Customer.ai zijn computertraining, kunstmatige, op intelligentie gebaseerde, speciaal gebouwde modellen die het Experience Platform nodig hebben om te werken en te werken.

**Op rente-gebaseerde gericht of Personalisatie:** Rentegerichte gericht zijn, ook bekend als verpersoonlijking, komt voor als aan de volgende drie voorwaarden wordt voldaan: gegevens die on-site worden verzameld, worden gebruikt om conclusies te trekken over de belangen van de gebruiker, gegevens worden gebruikt in een andere context, zoals op een andere site of een andere app (off-site), en als gegevens worden gebruikt om te selecteren welke inhoud of advertenties op basis van die conclusies worden aangeboden.

[Terug naar boven](#adobe-experience-platform-glossary)

## J

**JupyterLab:** Een open-bron web-based interface voor Project Jupyter en is strak geïntegreerd in het Platform van de Ervaring.

**Jupyter-laptop:** Een opensource webtoepassing waarmee gebruikers documenten kunnen maken en delen die live code, vergelijkingen, visualisaties en beschrijvende tekst bevatten.
...
**Bibliotheek:** In de Lancering van het Platform van de Ervaring, is een bibliotheek een reeks bedrijfslogica die instructies voor bevat hoe de bibliotheek van de Lancering zich op het cliëntapparaat zou moeten gedragen.

[Terug naar boven](#adobe-experience-platform-glossary)

## M

**Machine Learning (ML):** Het leren van de machine is het gebied van studie dat computers de capaciteit toelaat om te leren zonder uitdrukkelijk geprogrammeerd te zijn.

**Model voor machinaal leren:** Een model voor machinaal leren is een exemplaar van een recept voor machinaal leren dat met behulp van historische gegevens en configuraties wordt opgeleid om een geval voor zakelijk gebruik op te lossen. In de Werkruimte van de Wetenschap van Gegevens van Adobe, worden de modellen van het machinleren genoemd recepten.

**Toewijzing:** In het platform van de Gegevens van de Klant in real time, is de gegevenstoewijzing het proces om brongegevensgebieden aan bestemmings verwante doelgebieden in kaart te brengen.

**Handeling voor marketing:** Een marketingactie, in het kader van het gegevensbeheerkader, is een actie die een gebruiker van het ervaringsplatform onderneemt en waarvoor moet worden gecontroleerd op schendingen van het gegevensgebruiksbeleid.
...
**Samenvoegingsbeleid:** Een samenvoegingsbeleid is een reeks regels die door Profiel worden gebruikt om te bepalen hoe de gegevens aan voorrang zullen worden gegeven en in een verenigde mening onder bepaalde voorwaarden zullen worden gecombineerd.
...
**Module:** In de Lancering van het Platform van de Ervaring, is een module een fragment van uitvoerbaar JavaScript die door een uitbreiding wordt verstrekt, die acties in een cliëntmilieu zonder de behoefte van de gebruiker van de Lancering uitvoert om een regel tot stand te brengen.
...
**Laptops:** De laptops worden ontworpen gebruikend *Jupyter Notitieboekje* en bevatten analysebeschrijving, resultaten, en kunnen worden in werking gesteld om gegevensanalyse uit te voeren.

[Terug naar boven](#adobe-experience-platform-glossary)

## O

**Voorstel:** In de beslissingsservice is een aanbieding een marketingbericht dat mogelijk regels bevat die bepalen wie in aanmerking komt om de aanbieding te zien.

**Beslissing voorstel:** In de Beslissingsdienst, laat de aanbiedingsbeslissing een teler toe de regels en de opgeleide modellen van aanbiedingsvoorstellen te beheren wanneer het in dienst nemen met een eindgebruiker die op gegevens wordt gebaseerd die over kanalen en toepassingen worden verzameld.

**Bibliotheek voorstel:** In de Beslissingsdienst, is de aanbiedingsbibliotheek een centrale bibliotheek die wordt gebruikt om gepersonaliseerde en reserveaanbiedingen, besluitvormingsregels en activiteiten te beheren.
...
**Eigenschap:** In de Lancering van het Platform van de Ervaring, is een bezit een container voor alles nodig om een reeks markeringen op te stellen.
...
**Gegevensplatform voor realtime klanten:** In het realtime klantgegevensplatform van Adobe worden bekende en onbekende klantgegevens samengebracht om vertrouwde klantprofielen te maken met vereenvoudigde integratie, intelligente segmentatie en realtime activering tijdens de digitale reis van de klant.

**Klantprofiel in realtime:** Klantprofiel in realtime is een gecentraliseerd profiel voor gericht en gepersonaliseerd ervaringsbeheer.

**Recipe:** Een recept is de term van Adobe voor een modelspecificatie en is een container van het hoogste niveau die een specifiek machine het leren, AI algoritme of een samenstel van algoritmen, verwerkingslogica, en configuratie vertegenwoordigt die wordt vereist om een opgeleid model te bouwen en uit te voeren en daardoor helpen specifieke bedrijfsproblemen oplossen.

**Opnemen:** Een record is gegevens die als rijen in een dataset blijven bestaan.

**Herhaling:** Een herhaling bepaalt of een vraag van de Dienst van de Vraag gepland is om slechts eenmaal of op een terugkomende basis te lopen.

**Weergave:** In de Beslissingsdienst, is een vertegenwoordiging informatie die door een kanaal, zoals plaats of taal wordt gebruikt om een aanbieding te tonen.

**Bron:** In de Lancering van het Platform van de Ervaring, is het middel een generische termijn die naar opties verwijst de gebruiker van de Lancering binnen het cliëntmilieu, met inbegrip van uitbreidingen, gegevenselementen, en regels kan vormen.

**Op rollen gebaseerd Toegangsbeheer:** Op rollen gebaseerd toegangsbeheer laat beheerders toe om toegang en toestemmingen aan gebruikers van het Platform van de Ervaring toe te wijzen. De toestemmingen omvatten de capaciteit om de eigenschappen van het Platform van de Ervaring te bekijken en/of te gebruiken, zoals het creëren van zandbakken, het bepalen van schema&#39;s, en het beheren van datasets.

**Regel:** In de Lancering van het Platform van de Ervaring, is een regel een inzameling van regelcomponenten die een specifieke reeks gebeurtenissen, voorwaarden, en acties bepalen die logisch gezien zouden moeten worden gegroepeerd.
...
**Sandbox opnieuw instellen:** Met de sandbox-reset verwijdert u alle gegevens, inclusief gegevens, profielen en segmenten binnen een sandbox. Het terugstellen van de zandbak kon gegevens beïnvloeden die met interne of externe bestemmingen worden verbonden.

**Sandbox-switch:** Met het besturingselement voor de sandbox-switch in Experience Platform kunnen gebruikers navigeren tussen sandboxen waartoe ze toegang hebben. Als u overschakelt op een sandbox, wordt alle inhoud gewijzigd en wordt mogelijk de toegang tot de functie gewijzigd op basis van machtigingen.

**Planning:** Plan is een door de gebruiker gedefinieerde specificatie over de frequentie waarmee of het tempo waarin gegevens worden ingevoerd van een gegevensbron van derden naar het Adobe Experience Platform.

**Scores:** Scores is het proces om inzichten van gegevens te produceren gebruikend een opgeleid model.

**Schema:** Het schema bestaat uit een klasse en een optionele mix en wordt gebruikt om gegevenssets en gegevensstromen te maken. Een schema bevat gedragskenmerken, tijdstempel, identiteit, kenmerkdefinities en relaties.

**Schemabeschrijving:** De beschrijver van het schema is een extra schema verwante meta-gegevens die gedrag beschrijven dat door het Platform van de Ervaring kan worden gebruikt om bedoeld schemagedrag zoals het verband tussen twee schema&#39;s te begrijpen.

**Geheime toegangstoets:** Een geheime toegangstoets is een Amazon S3-sleutel die samen met de toegangstoets-id wordt gebruikt om AWS-aanvragen te ondertekenen.
...
**Gevoelige gegevenslabels:** Gevoelige labels &#39;S&#39; worden gebruikt om gegevens te categoriseren die gevoelig worden geacht, zoals verschillende soorten gedrag of geografische gegevens die u als gevoelig wilt markeren.
...
**Bronaansluiting:** Met de Adobe Experience Platform Source-connectors kunnen gebruikers eenvoudig gegevens uit meerdere bronnen innemen, zodat ze gegevens kunnen structureren, labelen en verbeteren met behulp van Experience Platform Services. Gegevens kunnen worden ingevoerd uit verschillende bronnen, zoals cloudgebaseerde opslag, software van derden en CRM-systemen.

**Broncategorie:** Een broncategorie is een groepering van Real-time bronnen van het Platform van Gegevens van de Klant die gelijkaardige kenmerken hebben.

**Broncatalogus:** Een broncatalogus is een lijst met beschikbare bronnen in het Real-time platform van de Gegevens van de Klant.

**Standaardnaamruimte:** Standaard-naamruimten zijn vooraf gedefinieerde Adobe-id&#39;s, waaronder Adobe en industriestandaard oplossingen die worden gebruikt om gebruikers te identificeren.

**Standaardschema:** Standaardschema&#39;s bestaan uit klassen en mengsels en zijn bestemd voor hergebruik.

**Streaming inname:** Streaming opname biedt gebruikers een methode om gegevens van client- en serverapparaten naar Experience Platform in real-time te verzenden.
...
**Systeemweergave:** De Mening van het systeem is een visuele vertegenwoordiging van brondatasets die door het Profiel van de Klant in real time aan bestemmingen stromen.
...
**Unieschema:** Het schema van de Unie is een consolidatie van schema&#39;s die voor het Profiel van de Klant in real time zijn toegelaten.
...
**XDM (Experience Data Model):** XDM (Experience Data Model) is het concept van het gebruik van standaardschema&#39;s voor het verenigen van gegevens voor gebruik met de toepassingen Experience Platform en Adobe Experience Cloud. XDM is een formele specificatie die wordt gebruikt om alle gegevens van de klantenervaring in één enkele taal of standaardgegevensmodel te vertegenwoordigen en gestandaardiseerd hoe het gegeven gestructureerd is en het proces versnelt en vereenvoudigt om inzichten van enorme hoeveelheden gegevens te verkrijgen.

...
**Adobe Admin Console:** Adobe Admin Console biedt een centrale locatie voor het beheer van de toegang en de machtiging voor functies voor uw organisatie.
...
**Adobe-connectors:** Adobe Connectors zijn vooraf geconfigureerde verbindingen die door Adobe zijn gemaakt om het in- en uitstromen van gegevens mogelijk te maken [!DNL Experience Platform]. De schakelaars omvatten [!DNL Microsoft Dynamics], [!DNL Salesforce], [!DNL Amazon S3], en [!DNL Azure Blob].

**Adobe Intelligent Services:** Adobe Sensei is het inlichtingenkader dat bevoegdheden heeft [!DNL Experience Platform]. Het verstrekt ook een reeks diensten AI die merken machtigt om hun capaciteit te verbeteren om in real time, gepersonaliseerde klantenervaringen te leveren.
...
**Amazon S3 bucket:** [!DNL Amazon S3] emmers zijn de basiscontainers voor gegevens die in het [!DNL Amazon] ecosysteem worden opgeslagen. Emmers bevatten objecten. Elk object wordt opgeslagen en opgehaald met een unieke door de ontwikkelaar toegewezen sleutel.
...
**Attributie AI:** [!DNL Attribution AI] is een Adobe Sensei Service die algoritmische multi-channel attributiemogelijkheden over de volledige klantenlevenscyclus levert.
...
**Backfill-periode:** `Backfill period` is een optie om de tijdsduur in te stellen voor het invoeren van historische gegevens van derden via een verbinding. Het selecteren van een backfill periode van voor altijd zal de volledige geschiedenis van de brongegevens aan innemen [!DNL Experience Platform].
...
**Batchinname:** Met het inslikken van batterijen kunnen gebruikers petabytes aan gegevens innemen en deze beschikbaar maken in bedrijfssystemen. Met de recentste technologieën, kunnen de gebruikers om het even welk schema XDM en niet-XDM in nu opnemen [!DNL Experience Platform].
...
**Opbouwen:** In [!DNL Experience Platform Launch], is een bouwstijl een opgestelde bibliotheek. De build is een bestand of set bestanden met alle configuraties en code die nodig zijn om de bedrijfslogica in die bibliotheek uit te voeren.

**Gereedschappen voor Businessen Intelligence:** Zakelijke intelligentie, ook wel &#39;BI&#39;-tools genoemd, is vooral geïntegreerd met de [!DNL Experience Platform Query Service]software. BI-gereedschappen zijn typen toepassingssoftware die grote hoeveelheden ongestructureerde gegevens van interne en externe systemen verzamelen en verwerken.
...
**Catalogus:** In [!DNL Real-time Customer Data Platform]bronnen en bestemmingen wordt een catalogus gemaakt met beschikbare verbindingen met Adobe-toepassingen en technologieën van derden.
...
**Gegevenswoordenboek:** Een gegevenswoordenboek is [!DNL Experience Platform Launch]een set gegevenselementen die zijn gedefinieerd binnen een eigenschap.

**Gegevenselement:** Een gegevenselement is [!DNL Experience Platform Launch]een aanwijzer die wordt gebruikt binnen regels en uitbreidingen om te wijzen naar een specifiek stuk gegevens dat op het clientapparaat bestaat.

**Gegevenslaag:** Een gegevenslaag [!DNL Experience Platform Launch]is een gegevensstructuur die op het clientapparaat aanwezig is en die metagegevens bevat over de context waarin een pagina of scherm wordt weergegeven.
...
**Partners voor gegevensintegratie:** De partners van de gegevensintegratie vereenvoudigen en automatiseren het laden en de transformatie van enorme hoeveelheden gegevens van meer dan 200 bronnen aan [!DNL Experience Platform] zonder code te schrijven.
...
**Werkruimte voor gegevenswetenschap:** [!DNL Data Science Workspace] binnen [!DNL Experience Platform] , kunnen klanten modellen voor machinaal leren maken met behulp van gegevens in [!DNL Experience Platform] en Adobe-toepassingen om intelligente inzichten en voorspellingen te genereren om prachtige digitale ervaringen voor eindgebruikers te wekken.
...
**Dataset-uitvoer:** De output van de gegevensset verstrekt een mechanisme om te bepalen wat *Create Lijst als Uitgezochte* optie voor een bepaalde [!DNL Query Service] looppas zal worden gebruikt.
...
**Doel:** In [!DNL Real-time Customer Data Platform] een doel is een algemene term voor een systeem, zoals een Adobe-toepassing, een advertentieserver of een ad-netwerk, waarin een publiek wordt geactiveerd en geleverd.
...
**Experience Data Model (XDM):** [!DNL Experience Data Model] (XDM) is het concept van het gebruiken van standaardschema&#39;s om gegevens voor gebruik met [!DNL Experience Platform] en de toepassingen van de Wolk van de Ervaring te verenigen van Adobe. XDM gestandaardiseert hoe de gegevens gestructureerd zijn en versnelt en vereenvoudigt het proces om inzichten van enorme hoeveelheden gegevens te verkrijgen.
...
**ExperienceEvent:** ExperienceEvent is een [!DNL Experience Platform] standaardschema dat waarnemingen vastlegt, inclusief het tijdstip en de identiteit van het desbetreffende onderwerp. De Gebeurtenissen van de ervaring zijn feitenverslagen van wat voorkwam, die wat vormde zonder samenvoeging of interpretatie.

**Extensie:** Een extensie is [!DNL Experience Platform Launch]een pakket met functionaliteit dat aan een [!DNL Launch] eigenschap wordt toegevoegd.  Een uitbreiding is gewoonlijk geconcentreerd rond een bepaalde marketing of analyseoplossing en verstrekt de hulpmiddelen nodig om die technologie in een cliëntmilieu op te stellen.

**Extensiepakket:** Een extensiepakket is [!DNL Experience Platform Launch]een ZIP-bestand dat is gemaakt en geüpload door een extensieontwikkelaar en dat alles bevat wat [!DNL Launch] gebruikers nodig hebben om de extensie binnen hun eigenschap te installeren.  Een extensiepakket bevat een manifest dat informatie bevat over de extensie, HTML en JavaScript die eindgebruikers nodig hebben om het gedrag van de [!DNL Launch] extensie en het uitvoerbare JavaScript dat aan de clientomgeving wordt geleverd, indien nodig te configureren.
...
**Host:** In [!DNL Experience Platform Launch], specificeert een gastheer de plaats, het domein, en gebruikersgeloofsbrieven noodzakelijk voor [!DNL Launch] om een bouwstijl te leveren.
...
**Naamruimte identiteit:** Een naamruimte van een identiteit is een id, zoals een cookie-id, apparaat-id of e-mailadres, waarmee de context wordt aangegeven waarin gegevens afkomstig zijn en waarmee identiteiten worden herkend en gekoppeld [!DNL Experience Cloud].
...
**Samenvatting:** Ingestie is het proces waarbij gegevens uit een bron worden toegevoegd aan [!DNL Experience Platform]. Gegevens kunnen op verschillende manieren worden ingevoerd, [!DNL Experience Platform] zoals gestreamd, in batches of via connector worden toegevoegd.

**Ingestieschema:** Ingestieschema biedt op tijd gebaseerde opties bij het opnemen van een bron naar [!DNL Experience Platform].
...
**Intelligente services:** [!DNL Intelligent Services] zoals [!DNL Attribution AI] en [!DNL Customer AI] zijn machinaal leren, kunstmatige intelligentie-gebaseerde speciaal-gebouwde modellen die het [!DNL Experience Platform] moeten leiden en werken.
...
**Bibliotheek:** In [!DNL Experience Platform Launch], is een bibliotheek een reeks bedrijfslogica die instructies voor bevat hoe de [!DNL Launch] bibliotheek zich op het cliëntapparaat zou moeten gedragen.
...
**Model voor machinaal leren:** Een model voor machinaal leren is een exemplaar van een recept voor machinaal leren dat met behulp van historische gegevens en configuraties wordt opgeleid om een geval voor zakelijk gebruik op te lossen. In Adobe [!DNL Data Science Workspace]worden leermodellen voor computers recepten genoemd.
...
**Module:** In [!DNL Experience Platform Launch], is een module een fragment van uitvoerbaar JavaScript die door een uitbreiding wordt verstrekt, die acties in een cliëntmilieu zonder de behoefte uitvoert voor de [!DNL Launch] gebruiker om een regel tot stand te brengen.
...
**Profiel:** [!DNL Profile] is een [!DNL Experience Platform] standaardgegevensmodel dat wordt gebruikt om kenmerken van consumenten te definiëren. Een profiel kan ook een aggregaat zijn van gebeurtenisgegevens en -kenmerken die betrekking hebben op een persoon en/of apparaat.
...
**Eigenschap:** In [!DNL Experience Platform Launch], is een bezit een container voor alles nodig om een reeks markeringen op te stellen.
...
**Platform voor realtime klantgegevens:** Met Adobe&#39;s [!DNL Real-time Customer Data Platform] worden bekende en onbekende klantgegevens samengebracht om vertrouwde klantprofielen te maken met vereenvoudigde integratie, intelligente segmentatie en realtime activering tijdens de digitale reis van de klant.
...
**Regel:** In [!DNL Experience Platform Launch], is een regel een inzameling van regelcomponenten die een specifieke reeks gebeurtenissen, voorwaarden, en acties bepalen die logisch gezien zouden moeten worden gegroepeerd.

**Regelcomponent:** In [!DNL Experience Platform Launch], zijn de regelcomponenten de gebeurtenissen, de voorwaarden, en de acties die omhoog een regel maken.
...
**Planning:** Plan is een door de gebruiker gedefinieerde specificatie over de frequentie waarmee of de frequentie waarmee gegevens van een gegevensbron van derden naar Adobe worden ingevoerd. [!DNL Experience Platform].
...
**Schemabeschrijving:** De beschrijver van het schema is een extra schema verwante meta-gegevens die gedrag beschrijven dat door kan worden gebruikt [!DNL Experience Platform] om bedoeld schemagedrag zoals het verband tussen twee schema&#39;s te begrijpen.
...
**Segment Builder:** [!DNL Segment Builder] is de visuele ontwikkelomgeving die wordt gebruikt om segmentdefinities te bouwen en dient als gemeenschappelijke component van alle toepassingen die [!DNL Real-time Customer Profile] Segmentatie op gebruiken [!DNL Experience Platform].
...
**Sensei ML Framework:** Sensei ML Framework is een uniform computerleerframework voor heel Adobe dat gegevens gebruikt [!DNL Experience Platform] om gegevenswetenschappers in staat te stellen op een snellere, schaalbare en herbruikbare manier computerleergestuurde inlichtingendiensten te ontwikkelen.
...
**Streaming eindpunt-URL:** Een URL voor een streamingeindpunt is een uniek eindpunt dat door Adobe wordt verschaft en dat is gekoppeld aan de IMS-org van een klant om gegevens in te streamen [!DNL Experience Platform].
...
**Unieschema:** Het schema van de Unie is een consolidatie van schema&#39;s die voor zijn toegelaten [!DNL Real-time Customer Profile].
...
**XDM (Experience Data Model):** XDM (Experience Data Model) is het concept van het gebruik van standaardschema&#39;s voor het verenigen van gegevens voor gebruik met [!DNL Experience Platform] en de toepassingen van de Wolk van de Ervaring. XDM is een formele specificatie die wordt gebruikt om alle gegevens van de klantenervaring in één enkele taal of standaardgegevensmodel te vertegenwoordigen en gestandaardiseerd hoe het gegeven gestructureerd is en het proces versnelt en vereenvoudigt om inzichten van enorme hoeveelheden gegevens te verkrijgen.

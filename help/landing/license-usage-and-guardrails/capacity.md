...
>abstract="Met de waarde voor streamingdoorvoer wordt de gecombineerde piekbinnenkomende gebeurtenissen per seconde gemeten voor het streamen van opname in het profiel, over de productie- en ontwikkelingssandboxen heen."
...
- Het maximale aantal randbereiken is 150
...
- De gecombineerde doorvoer voor randsegmentatie is 1500 records per seconde (rps)
...
![&#x200B; de pagina van het overzicht van de Capaciteit wordt getoond, tonend de waakzame geschiedenis en de secties van de capaciteitsdetails.](/help/landing/images/capacity/capacity-overview.png) {zoomable="yes" width="80%"}
...
### Streaming capaciteiten {#streaming-capacities}

In de sectie Streaming-capaciteiten wordt informatie over de streamingcapaciteit van uw organisatie beschreven. In deze sectie wordt met name capaciteitsinformatie weergegeven over streamingdoorvoer en streaming publiek. U kunt deze informatie per sandbox filteren en de terugzoekperiode wijzigen.
...
In de sectie **[!UICONTROL Streaming throughput]** wordt informatie weergegeven over de streamingdoorvoer in de sandboxen van uw organisatie. Met de waarde voor de streamingdoorvoer wordt de gecombineerde piekbinnenkomende gebeurtenissen per seconde gemeten voor het streamen van opname in het profiel.
...
#### Aantal gestreamde doelgroepen {#streaming-audience-count}

In de sectie **[!UICONTROL Streaming audience count]** wordt het aantal streamingdeelnemers in de sandbox weergegeven, evenals het maximale aantal streamingdeelnemers dat binnen de sandbox is toegestaan.
...
| Gebruik | Het aantal streamingdeelnemers in de sandbox. |
| Capaciteit | Het maximum aantal streaming publiek dat is toegestaan in de sandbox. |

### Edge-capaciteiten {#edge-capacities}

De sectie **[!UICONTROL Edge capacities]** bevat informatie over de randcapaciteiten van uw organisatie. Specifiek, toont deze sectie capaciteitsinformatie over de productie van de randsegmentatie en randpubliek. U kunt de terugzoekperiode voor de randcapaciteiten van de organisatie wijzigen.

![&#x200B; de capaciteitssectie van Edge wordt getoond. Dit schetst informatie met inbegrip van de productie van de randsegmentatie en de telling van het randpubliek.](/help/landing/images/capacity/edge-capacities.png)

#### Edge-segmentatiedoorvoer {#edge-streaming-throughput}

In de sectie **[!UICONTROL Edge segmentation throughput]** wordt informatie weergegeven over de segmentatiedoorvoer van randen binnen uw organisatie en de sandboxen van uw organisatie. De waarde van de de productiegrens van de randsegmentatie meet de gecombineerde piekbinnenkomende gebeurtenissen per seconde voor randopname in Profiel.

![&#x200B; de sectie van de de segmenteringsproductie van Edge wordt getoond. Dit toont informatie over de productie van de randsegmentatie binnen uw organisatie en zijn zandbakken.](/help/landing/images/capacity/edge-segmentation-throughput.png)

| Kolomnaam | Beschrijving |
| ----------- | ----------- |
| Organisatie | De naam van de organisatie. De beschikbare sandboxen voor de organisatie worden vermeld onder de naam van de organisatie. |
| Gebruik RPS (Piek) | De maximale gegevensdoorvoer in de sandbox binnen de geselecteerde terugzoekperiode. |
| Capaciteit RPS | De maximumpiekproductie voor de organisatie. |
| Schending | Als er een schending is opgetreden, het type van schending voor de doorvoer van de randsegmentatie. |
| Aanbevolen acties | Een kolom die de aanbevolen actie beschrijft om de schending te verlichten. |

U kunt de organisatie selecteren om een meer gedetailleerde mening van de de randsegmentatie van de organisatie productie te zien.

![&#x200B; de organisatie wordt benadrukt.](/help/landing/images/capacity/select-organization.png)

De pagina **[!UICONTROL Edge Segmentation Throughput]** wordt weergegeven. U kunt een grafiek zien die de verzoekproductie in vergelijking met de capaciteitsgrens toont. Binnen deze pagina kunt u de terugzoekperiode voor de weergegeven grafiek aanpassen.

![&#x200B; de pagina van de Omvoer van de Segmentatie van Edge wordt getoond. Dit toont een grafiek die de productie in vergelijking met de capaciteitsgrens detailleert.](/help/landing/images/capacity/edge-segmentation-throughput-details.png)

#### Aantal Edge-gebruikers {#edge-audience-count}

In de sectie **[!UICONTROL Edge audience count]** wordt het aantal doelgroepen voor de randen in elke sandbox weergegeven, evenals het maximumaantal doelgroepen voor de randen dat binnen de sandbox is toegestaan.

![&#x200B; de sectie van de het publiekentelling van Edge wordt getoond. Dit toont informatie met betrekking tot de telling van het randpubliek.](/help/landing/images/capacity/edge-audience-count.png)
...
## Best practices voor streaming doorvoer {#streaming-throughput-suggestions}

U kunt uw inbreuken op de doorvoer verhelpen door een van de volgende aanbevelingen uit te voeren:
...
## Aanbevolen werkwijzen voor Edge-segmentatiedoorvoer {#edge-best-practices}

U kunt de schendingen van de Edge-segmentatiedoorvoer verhelpen door een van de volgende aanbevelingen uit te voeren:

1. Identificeer hoge gegevensstromen van de productiestroom in het [&#x200B; controledashboard &#x200B;](/help/dataflows/ui/monitor-edge.md) en pas throttling of het filtreren tegen deze gegevensstromen indien nodig toe.
2. Optimaliseer uw inname door batch-inname te gebruiken voor een lagere latentie.
3. Neem contact op met uw Adobe-medewerker voor klantenservice als de problemen zich blijven voordoen.

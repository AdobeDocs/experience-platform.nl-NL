...
>[!AVAILABILITY]
>
>Adobe Experience Platform die op Amazon Web Services (AWS) wordt uitgevoerd, is momenteel beschikbaar voor een beperkt aantal klanten. Neem contact op met uw Adobe-accountteam voor meer informatie over Experience Platform op AWS.
...
De keuze tussen Experience Platform op Azure of AWS is afhankelijk van verschillende factoren die specifiek zijn voor uw bedrijf:
...
* **de technologievertrouwen van de Wolk**: Als uw zaken sterk op de technologieën van Microsoft baseren, zou Azure beter kunnen passen. Als je meer vertrouwt op Amazon services, kan AWS de beste optie zijn.
...
Experience Platform is beschikbaar in zes Microsoft Azure ontvangende plaatsen, één Amazon Web Services (AWS) het ontvangen plaats, en routegegevens aan de diensten van Adobe door zeven [ knopen van Edge Network ](../collection/home.md#edge) die over de wereld worden verdeeld.

### Microsoft Azure-gebieden {#azure-regions}

In de onderstaande tabel worden de Microsoft Azure-regio&#39;s aangegeven waar Experience Platform wordt gehost.
...
In de onderstaande tabel worden de AWS-regio&#39;s aangegeven waar Experience Platform wordt gehost. Controleer regelmatig of er extra locaties zijn toegevoegd.
...
Adobe heeft zich ertoe verbonden om functiepariteit aan te bieden op verschillende cloudplatforms, voor alle toepassingen die op Experience Platform worden uitgevoerd, zoals:
...
Sommige functies kunnen echter afwijken voor Azure- en AWS-implementaties. Deze verschillen worden beschreven in de onderstaande sectie en in andere delen van de productdocumentatie, indien van toepassing.

### Verschillen tussen Experience Platform uitvoeren op Microsoft Azure en AWS {#azure-aws-differences}

In de onderstaande tabel worden de grote verschillen aangegeven tussen Experience Platform op Microsoft Azure en AWS.
...
Experience Platform biedt flexibiliteit en keuze door u de mogelijkheid te bieden om op Microsoft Azure of Amazon Web Services te draaien. Evalueer uw bedrijfsbehoeften en bestaande infrastructuur om een geïnformeerde beslissing te nemen over welk cloudplatform moet worden gebruikt.

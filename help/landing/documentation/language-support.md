...
Voor meer informatie over de typen documentatie die beschikbaar zijn, gaat u naar het overzicht [van de documentatietypen van het](overview.md)Platform. Voor meer informatie over een bepaalde [!DNL Platform] functie of service selecteert u een hulplijn op de landingspagina [Documentatie](https://experienceleague.corp.adobe.com/docs/experience-platform.html?lang=en)Experience Platform.
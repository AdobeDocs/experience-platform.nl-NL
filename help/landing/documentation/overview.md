...
## Ondersteunde documentatietaal

De documentatie van het Experience Platform is beschikbaar in verscheidene talen. Als u de taal wilt wijzigen, selecteert u het vervolgkeuzemenu voor de taal en kiest u de gewenste taal.
...
* **Experience Platform Launch:** Experience Platform Launch biedt een eenvoudige manier om alle benodigde analyses-, marketing- en advertentietags te implementeren en te beheren om uw klanten een persoonlijke, relevante en real-time ervaring te bieden.
...
* **Schema**&#39;s: Gedreven door Adobe, is het Model van de Gegevens van de Ervaring (XDM) een inspanning om de gegevens van de klantenervaring te standaardiseren en schema&#39;s voor het beheer van de klantenervaring te bepalen. De schema&#39;s XDM steunen de interoperabiliteit van gegevens over [!DNL Experience Platform] componenten.
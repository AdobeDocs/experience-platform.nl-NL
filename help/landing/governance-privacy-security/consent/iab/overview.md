...
Om deze gids te volgen, moet u een Platform van het Beheer van de Toestemming (CMP), of commercieel of uw gebruiken, gebruiken die met IAB TCF wordt geïntegreerd en volgzaam is. Zie de [Lijst van conforme CMP&#39;s](https://iabeurope.eu/cmp-list/) voor meer informatie .
...
De `setConsent` bevel verwacht twee argumenten: (1) een tekenreeks die het opdrachttype aangeeft (in dit geval &quot;setConsent&quot;) en (2) een payload die een `consent` array, die ten minste één object moet bevatten dat de vereiste toestemmingsvelden bevat, zoals hieronder wordt getoond:

...
Alvorens aan de hieronder getoonde stappen vooruit te gaan, lees [&#x200B; Destination SDK die &#x200B;](../getting-started.md) pagina voor informatie begonnen wordt over het verkrijgen van de noodzakelijke de authentificatiegeloofsbrieven van Adobe I/O en andere eerste vereisten om met Destination SDK APIs te werken.
...
* Als u `"authenticationRule": "CUSTOMER_AUTHENTICATION"` in de bestemmingsconfiguratie selecteerde, zie de volgende secties voor de authentificatietypen die door Destination SDK voor op dossier-gebaseerde bestemmingen worden gesteund:
   ...
   * [SFTP-verificatie met SSH-sleutel](../functionality/destination-configuration/customer-authentication.md#sftp-ssh-key-auth)
   * [SFTP-verificatie met wachtwoord](../functionality/destination-configuration/customer-authentication.md#sftp-password-auth)
...
Na vestiging kunt uw bestemming die de configuratieeindpunten in de vorige stappen gebruiken, u het [&#x200B; bestemmings testende hulpmiddel &#x200B;](../testing-api/batch-destinations/file-based-destination-testing-overview.md) gebruiken om de integratie tussen [!DNL Adobe Experience Platform] en uw bestemming te testen.

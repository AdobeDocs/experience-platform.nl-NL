...
Door dit artikel te lezen, weet u nu hoe u een aangepaste versie kunt maken [!DNL Azure Data Lake Storage] doel met behulp van Destination SDK. Vervolgens kan uw team de opdracht [activeringsworkflow voor op bestanden gebaseerde doelen](../../../ui/activate-batch-profile-destinations.md) om gegevens naar het doel te exporteren.

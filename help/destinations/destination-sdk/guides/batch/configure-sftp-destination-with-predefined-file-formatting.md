---
description: Leer hoe u Destination SDK kunt gebruiken om een SFTP-bestemming te configureren met vooraf gedefinieerde opties voor bestandsindeling en aangepaste configuratie van bestandsnamen.
...
De nuttige lading omvat hieronder een generische configuratie SFTP, met vooraf bepaalde, standaard [ CSV dossier het formatteren ](../../functionality/destination-server/file-formatting.md) configuratieparameters die de gebruikers in Experience Platform UI kunnen bepalen.
...
U weet nu hoe u een aangepaste SFTP-bestemming kunt ontwerpen met Destination SDK. Daarna, kan uw team het [ activeringswerkschema voor op dossier-gebaseerde bestemmingen ](../../../ui/activate-batch-profile-destinations.md) gebruiken om gegevens naar de bestemming uit te voeren.

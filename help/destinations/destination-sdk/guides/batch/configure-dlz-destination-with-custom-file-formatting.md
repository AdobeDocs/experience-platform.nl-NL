---
description: Leer hoe u Destination SDK kunt gebruiken om een DLZ-bestemming (Data Landing Zone) te configureren met aangepaste opties voor bestandsindeling en aangepaste configuratie van bestandsnamen.
...
Deze pagina beschrijft hoe te om Destination SDK te gebruiken om a [!DNL Data Landing Zone] bestemming met douane [ dossier te vormen formatterend opties ](configure-file-formatting-options.md) en een de naamconfiguratie van het douanedossier [ ](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration).
...
U weet nu hoe u een aangepaste [!DNL Data Landing Zone] -bestemming kunt ontwerpen met Destination SDK. Daarna, kan uw team het [ activeringswerkschema voor op dossier-gebaseerde bestemmingen ](../../../ui/activate-batch-profile-destinations.md) gebruiken om gegevens naar de bestemming uit te voeren.

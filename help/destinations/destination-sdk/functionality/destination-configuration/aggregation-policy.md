...
Na het lezen door dit document, zie de documentatie op [&#x200B; gebruikend het templating &#x200B;](../../functionality/destination-server/message-format.md#using-templating) en de [&#x200B; belangrijkste voorbeelden van de samenvoeging &#x200B;](../../functionality/destination-server/message-format.md#template-aggregation-key) om te begrijpen hoe te om het samenvoegingsbeleid in uw malplaatje van de berichttransformatie te omvatten dat op uw geselecteerd samenvoegingsbeleid wordt gebaseerd.
...
Zie de onderstaande tabel voor meer informatie over de integratietypen die de op deze pagina beschreven functionaliteit ondersteunen.
...
| `bestEffortAggregation.aggregationKey` | Object | *Facultatief*. Voegt de geëxporteerde profielen die aan de bestemming zijn toegewezen samen op basis van de hieronder beschreven parameters. Deze parameter kan worden weggelaten of op `null` worden ingesteld als aggregatie niet nodig is. Indien opgegeven, functioneert deze op dezelfde manier als de aggregatietoets in configureerbare aggregatie. |
...
De configureerbare samenvoeging werkt het best als u eerder in grote partijen, met duizenden profielen op de zelfde vraag zou nemen. Deze optie ondersteunt ook het aggregeren van de geëxporteerde profielen op basis van complexe aggregatieregels.
...
| `configurableAggregation.aggregationKey` | - | Voegt de geëxporteerde profielen die aan de bestemming zijn toegewezen samen op basis van de hieronder beschreven parameters. |

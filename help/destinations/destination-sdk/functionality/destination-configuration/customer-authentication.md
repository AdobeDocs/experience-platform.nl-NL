...
* Voor [&#x200B; Azure Blob &#x200B;](#blob) bestemmingen, moeten de gebruikers hun [!DNL Azure Blob] verbindingskoord verstrekken.
...
Wanneer u het Azure Blob-verificatietype configureert, moeten gebruikers de verbindingstekenreeks invoeren.
...
Wanneer u het verificatietype [!DNL Azure Data Lake Storage] configureert, moeten gebruikers de hoofdgegevens van Azure Service Principal en de huurdersgegevens invoeren.
...
## SFTP met wachtwoordverificatie {#sftp-password-auth}
...
## SFTP met SSH-sleutelverificatie {#sftp-ssh-key-auth}

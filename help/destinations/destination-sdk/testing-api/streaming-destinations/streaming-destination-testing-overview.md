...
Voor beschrijvingen van de verzoek en reactieparameters, zie [&#x200B; het testen van de Bestemming API verrichtingen &#x200B;](../../testing-api/streaming-destinations/destination-testing-api.md).

...
Een bestaande referentieconfiguratie en de bijbehorende `{INSTANCE_ID}`, raadpleegt u het artikel over [ophalen van een referentieconfiguratie](retrieve-credential-configuration.md).
...
**Een update [!DNL Amazon S3] crediteurconfiguratie**
...
**Een update [!DNL SSH] crediteurconfiguratie**
...
**Een update [!DNL Azure Data Lake Storage] crediteurconfiguratie**
...
**Een update [!DNL Azure Blob] crediteurconfiguratie**

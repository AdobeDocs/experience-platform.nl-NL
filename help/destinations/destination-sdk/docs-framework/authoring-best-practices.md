...
Deze pagina beschrijft regels die u zou moeten volgen wanneer [ creërend uw pagina van de bestemmingsdocumentatie ](./documentation-instructions.md), om ervoor te zorgen dat het aan de [!DNL Adobe Experience Platform] normen van de documentatiekwaliteit voldoet.
...
* AEP is geen algemeen aanvaarde term. Gebruik [!DNL Adobe Experience Platform] voor het eerste gebruik, daarna Experience Platform en vervolgens Experience Platform.
   ...
   * **Gebruik**: Alvorens u gegevens van [!DNL Adobe Experience Platform] naar YourDestination kunt uitvoeren, zorg ervoor u leest en deze eerste vereisten voltooit.
...
* Wanneer u schermafbeeldingen gebruikt, moet u ervoor zorgen dat uw schermafbeelding het volledige scherm van de gebruikersinterface van Experience Platform vastlegt.

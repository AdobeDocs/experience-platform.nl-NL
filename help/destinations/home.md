...
Gebruik de controles in de [ werkruimte van bestemmingen ](./ui/destinations-workspace.md) aan:
...
Met toegangsbeheer op basis van kenmerken in [!DNL Adobe Experience Platform] kunnen beheerders de toegang tot specifieke objecten en/of mogelijkheden beheren op basis van kenmerken.
...
* [Advertising-accountbestemmingen - Bombora ABM Audience connection](./catalog/advertising/bombora.md)
* [Advertising-accountbestemmingen - Verbinding met Demandbase](./catalog/advertising/demandbase.md)

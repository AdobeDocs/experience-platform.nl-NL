...
[!DNL Adobe Experience Platform] ondersteunt een groot aantal bestemmingen. De workflow voor publiekactivering varieert per bestemming, op basis van het type publieksgegevens dat door de gebruikers wordt ondersteund en de frequentie waarmee de gegevens worden geëxporteerd.
...
### Soorten publiek vanuit de catalogus met doelen activeren {#activate-from-catalog}
...
### Soorten publiek vanaf de pagina [!UICONTROL Browse] activeren {#activate-from-browse}

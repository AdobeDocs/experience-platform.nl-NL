...
[!DNL Adobe Experience Platform] gebruikt het [ Real-Time Profiel van de Klant ](../../profile/home.md) als enige bron van waarheid voor alle profielgegevens. Voor snelle, real time gegevensherwinning, gebruikt het [ randprofielen ](../../profile/edge-profiles.md), die lichtgewichtprofielen zijn die door [ Edge Network ](../../collection/home.md) worden verdeeld. Dit maakt het mogelijk snel en realtime gebruik te maken van personalisatie.

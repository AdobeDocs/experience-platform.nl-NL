...
>[!AVAILABILITY]
>
>Deze functionaliteit is beschikbaar voor klanten die het [!DNL Real-Time CDP] Prime- en Ultimate-pakket hebben aangeschaft. Neem contact op met uw Adobe-vertegenwoordiger voor meer informatie.

Dit artikel verklaart het werkschema wordt vereist om [ perspectiefpubliek ](/help/segmentation/types/prospect-audiences.md) van [!DNL Adobe Experience Platform] naar uw aangewezen bestemming uit te voeren dat.
...
Gebruik de selectievakjes links van de namen van de mogelijke doelgroepen om het publiek te selecteren dat u naar het doel wilt exporteren en selecteer vervolgens **[!UICONTROL Next]** .

>[!NOTE]
>
>Alleen het beoogde publiek wordt in deze weergave getoond en er worden geen andere doelgroepen weergegeven.
...
>[!NOTE]
>
>Merk op dat in de het plannen stap, het werkschema om perspectiefpubliek te activeren slechts u [ volledige dossiers ](/help/destinations/ui/activate-batch-profile-destinations.md#export-full-files) laat uitvoeren. Incrementele bestandsexport wordt niet ondersteund.
...
Verken gevallen voor verder gebruik die mogelijk zijn via ondersteuning voor partnergegevens in [!DNL Real-Time CDP] :
...
* De steun van derdegegevens van het gebruik in [!DNL Real-Time CDP] om [ uw profielbasis met perspectiefprofielen van gegevenspartners uit te breiden en met hen in gesprek te gaan om nieuwe klanten ](/help/rtcdp/partner-data/prospecting.md) te verwerven of te bereiken.

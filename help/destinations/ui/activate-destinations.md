...
Om gegevens aan bestemmingen te activeren, moet u een bestemming [met succes hebben](./connect-destination.md)verbonden. Als u dit niet reeds hebt gedaan, ga naar de [bestemmingscatalogus](../catalog/overview.md), doorblader de gesteunde bestemmingen, en opstelling één of meerdere bestemmingen.
...
![E-mailadres als identiteit](../assets/ui/activate-destinations/email-as-identity.gif)
...
![identiteitstoewijzing na invullen van velden](../assets/common/identity-mapping.png)
...
![oorsprong van gegevens kiezen](../assets/ui/activate-destinations/choose-data-origin.png)
...
U kunt de bestandsindeling bewerken. Voor meer informatie, ga naar [Configure](#configure) stap voor de bestemmingen van de wolkenopslag en e-mailmarketing van bestemmingen.

...
Selecteer in [!DNL Adobe Experience Platform] de optie **[!UICONTROL Destinations]** in de linkernavigatiebalk voor toegang tot de werkruimte van [!UICONTROL Destinations] .
...
|---------|----------|
| [!UICONTROL Set up] | Maak een verbinding met het doel. |
| [!UICONTROL Activate] | Nadat u een verbinding aan de bestemming vestigt, activeer publiek of voer datasets naar deze bestemming uit. |
| [!UICONTROL Activate audiences] | Nadat u een verbinding aan de bestemming vestigt, activeer publiek aan deze bestemming. |
| [!UICONTROL Export datasets] | Nadat u een verbinding aan de bestemming vestigt, voer datasets aan deze bestemming uit. |
...
>[!NOTE]
>
>Vanwege configuraties met toegangslabels kunnen doelgegevens waarop een gebruiker geen toegang heeft, in een grijze uitstatus in de gebruikersinterface worden weergegeven. Lees de documentatie op [ gebruikend toegangslabels om gebruikerstoegang tot bestemmingsdataflows ](../../access-control/abac/apply-access-labels-destinations.md#important-callouts-and-items-to-know) voor meer informatie te beheren.
...
Selecteer een doelrij om meer informatie over de bestemming in de juiste spoorstaaf, zoals bestemmings identiteitskaart, beschrijving, het aantal geactiveerde doelsoorten, en meer te bekijken.

![ klik bestemmingsrij ](../assets/ui/workspace/click-destination-row.png)

Selecteer de doelnaam om informatie over het publiek te zien dat aan deze bestemming wordt geactiveerd. Selecteer **[!UICONTROL Edit destination]** om [ de bestemmingsmontages ](/help/destinations/ui/edit-destination.md) te wijzigen of **[!UICONTROL Activate audiences]** om nieuwe publiek aan dataflow toe te voegen.
...
* **[!UICONTROL Destination platform]**: Filter de gegevensstroom op specifieke doelplatforms (bijvoorbeeld [!DNL Amazon S3] , [!DNL Facebook Custom Audience] , [!DNL LinkedIn Matched Audience] , enzovoort). U kunt meerdere platforms tegelijk selecteren.
...
* Afzonderlijke filters verwijderen door het pictogram `X` op elke filtertag te selecteren
...
* **beschrijvende namen van het Gebruik**: Creeer markeringen die duidelijk het doel of de categorie van dataflow (bijvoorbeeld, &quot;de Campagnes van de Marketing&quot;, &quot;Behoud van de Klant&quot;, &quot;Seizoensgebonden Bevorderingen&quot;wijzen)
...
* **hiërarchische markeringen van het Gebruik**: Overweeg gebruikend prefixen aan groep verwante markeringen (bijvoorbeeld, &quot;Campagne-Q4&quot;, &quot;Campagne-Q1&quot;)

## [!UICONTROL Accounts] {#accounts}

Het tabblad **[!UICONTROL Accounts]** bevat details over de verbindingen die u hebt gemaakt met verschillende doelen. U kunt bestaande accountgegevens bijwerken of verwijderen van dit tabblad. Zie de onderstaande tabel voor alle informatie die beschikbaar is voor elke doelaccount.
...
| [!UICONTROL Connection Type] | Vertegenwoordigt het type van rekeningsverbinding aan uw opslagemmer of bestemming. Afhankelijk van de bestemming, zijn de authentificatieopties: <ul><li>Voor marketingdoelen voor e-mail: Kan S3, FTP of Azure Blob zijn.</li><li>Voor reclame-bestemmingen in real time: Server-aan-server</li><li>Voor Amazon S3-cloudopslagdoelen: Toegangstoets </li><li>Voor SFTP-cloudopslagdoelen: basisverificatie voor SFTP</li><li>OAuth 1- of OAuth 2-verificatie</li><li>Toekennerverificatie</li></ul> |
...
Op het tabblad **[!UICONTROL System View]** wordt een grafische weergave weergegeven van de activeringsstromen die u hebt ingesteld in [!DNL Adobe Experience Platform] .

![ gegevens-flows1 ](../assets/ui/workspace/system-view-dataflows.png)

Selecteer een van de doelen die op de pagina worden weergegeven en selecteer **[!UICONTROL View dataflows]** om informatie weer te geven over alle verbindingen die u voor elke bestemming hebt ingesteld.

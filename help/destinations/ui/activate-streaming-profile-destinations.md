...
Dit artikel verklaart het werkschema dat wordt vereist om publieksgegevens in [!DNL Adobe Experience Platform] aan het stromen op profiel-gebaseerde bestemmingen te activeren (die ook als [ ondernemingsbestemmingen ](/help/destinations/destination-types.md#advanced-enterprise-destinations) worden bedoeld).
...
[ de beleidsevaluatie van de toestemming ](/help/data-governance/enforcement/auto-enforcement.md#consent-policy-evaluation) wordt momenteel niet gesteund in de uitvoer naar de drie ondernemingsbestemmingen - Amazon Kinesis, de Hubs van de Gebeurtenis van Azure, en HTTP API.

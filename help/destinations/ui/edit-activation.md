...
In [!DNL Adobe Experience Platform], kunt u diverse componenten van bestaande activeringsdataflows aan bestemmingen vormen, zoals:
...
1. Ga naar [&#x200B; UI van Experience Platform &#x200B;](https://platform.adobe.com/) en selecteer **[!UICONTROL Destinations]** van de linkernavigatiebar. Selecteer **[!UICONTROL Browse]** in de bovenste koptekst om de bestaande doelgegevens weer te geven.
...
Selecteer de **[!UICONTROL Scheduling]** -stap in de activeringsworkflow om het activeringsschema en de exportfrequentie voor de gegevensstroom te bewerken. Gebruik deze stap om te configureren hoe vaak gegevens naar de bestemming worden geëxporteerd.
...
Selecteer de stap **[!UICONTROL Mapping]** in de activeringsworkflow om de toegewezen kenmerken en identiteiten voor de activeringsgegevensstroom te bewerken. Gebruik deze stap om aan te passen welke profielkenmerken en identiteiten naar de bestemming worden uitgevoerd.
...
U hebt de doelgegevens bijgewerkt met de werkruimte **[!UICONTROL destinations]** .

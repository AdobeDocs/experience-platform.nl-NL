...
Dit document bevat stappen voor het abonneren op waarschuwingsberichten voor de doelgegevens.

## Aan de slag {#getting-started}

Voor dit document is een goed begrip van de volgende componenten van [!DNL Adobe Experience Platform] vereist:
...
* [&#x200B; Observability &#x200B;](../../observability/home.md): Gebruik [!DNL Observability Insights] om de activiteiten van Experience Platform door statistische metriek en gebeurtenisberichten te controleren.
...
>[!IMPORTANT]
>
>U moet directe meldingen van e-mails inschakelen voor uw Experience Platform-account om e-mailmeldingen voor uw gegevensstromen te ontvangen.
...
U kunt nu zich abonneren op in-context waarschuwingen voor uw doelgegevens. Voor meer informatie, zie het [&#x200B; alarm UI gids &#x200B;](../../observability/alerts/ui.md).

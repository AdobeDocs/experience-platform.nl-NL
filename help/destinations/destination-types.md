...
Lees deze pagina om de verschillende typen en categorieën van [!DNL Adobe Experience Platform] doelen te begrijpen.

## Doeltypen {#destination-types}

In [!DNL Adobe Experience Platform], maken wij onderscheid tussen verschillende bestemmingstypes - verbindingen, datasetuitvoer, en uitbreidingen. Er zijn verscheidene soorten verbindingsbestemmingen, die u toestaan om gegevens naar op API-Gebaseerde bestemmingen, sociale bestemmingen, de platforms van CRM, en vele meer uit te voeren.

Ten slotte kan ook een onderscheid worden gemaakt tussen openbare bestemmingen die beschikbaar zijn in alle organisaties in de lijst met bestemmingen, en particuliere bestemmingen die [!DNL Real-Time CDP] Ultimate-klanten kunnen maken om aan hun specifieke gevallen van exportgebruik te voldoen.
...
Gebruik de geavanceerde gegevensconnectors voor bedrijfsdoelgegevens om Adobe [!DNL Real-Time Customer Data Platform] -profielen in bijna realtime te leveren aan interne systemen of aan andere systemen van derden voor gegevenssynchronisatie, analyse en verdere gebruiksscenario&#39;s voor profielverrijking.
...
>[!NOTE]
>
>De Snowflake-bestemmingen zijn momenteel alleen beschikbaar voor klanten in de VS. Neem contact op met uw Adobe-accountteam als u toegang buiten de VS nodig hebt.
...
Extensies zijn handig wanneer gebeurtenisgegevens een actie activeren of segmentatie uitvoeren in een externe omgeving. Bijvoorbeeld, als de gedragsgegevens aan een extern systeem moeten worden door:sturen zonder aan andere gegevensbronnen op dossier voor een bepaalde gebruiker te worden aangesloten.

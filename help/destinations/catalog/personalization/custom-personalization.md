...
Stel deze bestemming in om externe personalisatieplatforms, contentbeheersystemen en servers en andere toepassingen die op websites van klanten worden uitgevoerd, toe te staan publieksinformatie op te halen uit [!DNL Adobe Experience Platform] .
...
### Voorbeeld van reactie voor [!UICONTROL Custom Personalization With Attributes] {#example-response-custom-personalization-with-attributes}

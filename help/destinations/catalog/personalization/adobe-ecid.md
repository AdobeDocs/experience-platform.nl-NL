...
[!DNL Experience Cloud] ID Service is een personalisatie-uitbreiding in Adobe Experience Platform. Zie [Experience Cloud ID Service extension page](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html) in [!DNL Experience Platform Launch] documentatie voor meer informatie over de extensiefunctionaliteit.
...
Zie [Experience Cloud ID Service extension page](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html) in [!DNL Experience Launch] documentatie voor informatie over de configuratieopties voor extensies en installatieondersteuning.

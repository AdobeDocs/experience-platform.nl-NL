...
Raadpleeg de [Adobe Target v2-extensiepagina](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/targetv2-extension/adobe-target-extension-v2.html) in de [!DNL Experience Launch]-documentatie voor informatie over de configuratieopties voor extensies.

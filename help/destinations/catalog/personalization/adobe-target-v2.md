...
# [!DNL Adobe Target] v2-extensie {#adobe-target-v2-extension}
...
[!DNL Adobe Target] v2 is een personalisatie-uitbreiding in [!DNL Adobe Experience Platform] . Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op [ Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.102722.adobe-target-v2-launch-extension.html).
...
U installeert als volgt de extensie [!DNL Adobe Target] v2:
...
Selecteer de eigenschap waarin u de extensie wilt installeren. U kunt ook een nieuwe eigenschap maken. Een bezit is een inzameling van regels, gegevenselementen, gevormde uitbreidingen, milieu&#39;s, en bibliotheken. Zie het document op [ eigenschappen ](../../../tags/ui/administration/companies-and-properties.md#properties-page) in de markeringsdocumentatie om meer te leren.

Het werkschema begeleidt u door de stappen om de installatie te voltooien.

Voor informatie over de opties van de uitbreidingsconfiguratie, zie de [ Adobe Target v2 uitbreidingspagina ](../../../tags/extensions/client/target-v2/overview.md) in de markeringsdocumentatie.

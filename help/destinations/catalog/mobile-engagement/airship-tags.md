...
Deze integratie gaat [!DNL Adobe Experience Platform] publieksgegevens in [!DNL Airship] als [&#x200B; Markeringen &#x200B;](https://docs.airship.com/guides/audience/tags/) voor het richten of het teweegbrengen over.
...
>[!TIP]
>
>Deze doelconnector en documentatiepagina worden gemaakt en onderhouden door het team van [!DNL Airship] . Voor om het even welke onderzoeken of updateverzoeken, contacteer hen direct bij [&#x200B; support.airship.com &#x200B;](https://support.airship.com/).

## Vereisten {#prerequisites}

Voordat u uw [!DNL Adobe Experience Platform] publiek naar [!DNL Airship] kunt sturen, moet u:
...
## Dragertoken genereren {#generate-bearer-token}
...
Geef uw token een gebruikersvriendelijke naam, bijvoorbeeld &quot;Doel Adobe-tags&quot;, en selecteer &quot;Alle toegang&quot; voor de rol.

Klik op **[!UICONTROL Create Token]** en sla de details op als vertrouwelijk.

## Gebruiksscenario&#39;s {#use-cases}

Om u beter te helpen begrijpen hoe en wanneer u de [!DNL Airship Tags] bestemming zou moeten gebruiken, zijn hier voorbeelden van gebruiksgevallen die [!DNL Adobe Experience Platform] klanten kunnen oplossen door deze bestemming te gebruiken.
...
U kunt een-op-een berichten in realtime activeren wanneer gebruikers binnen [!DNL Adobe Experience Platform] naar een bepaald publiek gaan.
...
[!DNL Airship] -tags kunnen worden ingesteld op een kanaal dat apparaatinstantie vertegenwoordigt, bijvoorbeeld iPhone, of op een benoemde gebruiker, die alle apparaten van een gebruiker toewijst aan een gemeenschappelijke id, zoals een klant-id. Als u normale (niet-gehashte) e-mailadressen als primaire identiteit in uw schema hebt, selecteert u het e-mailveld in uw **[!UICONTROL Source Attributes]** en wijst u deze toe aan de [!DNL Airship] benoemde gebruiker in de rechterkolom onder **[!UICONTROL Target Identities]** , zoals hieronder wordt weergegeven.

![&#x200B; Benoemde Toewijzing van de Gebruiker &#x200B;](../../assets/catalog/mobile-engagement/airship-tags/mapping-option-2.png)

Voor herkenningstekens die aan een kanaal, d.w.z., een apparaat zouden moeten worden in kaart gebracht, om aan het aangewezen die kanaal op de bron wordt gebaseerd. In de volgende afbeeldingen ziet u hoe u een Google Advertising-id toewijst aan een [!DNL Airship] Android-kanaal.

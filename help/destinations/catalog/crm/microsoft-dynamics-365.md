...
description: Gebruik de bestemming Microsoft Dynamics 365 om uw rekeningsgegevens uit te voeren en het binnen Microsoft Dynamics 365 voor uw bedrijfsbehoeften te activeren.
...
Dit [!DNL Adobe Experience Platform] [ doel ](/help/destinations/home.md) hefboomwerkingen [[!DNL Contact Entity Reference API] ](https://docs.microsoft.com/en-us/dynamics365/customerengagement/on-premises/developer/entities/contact?view=op-9-1) om identiteiten binnen een publiek in [!DNL Dynamics 365] bij te werken.
...
Als markeerteken kunt u uw gebruikers een persoonlijke ervaring bieden op basis van kenmerken uit hun [!DNL Adobe Experience Platform] -profielen. U kunt een publiek maken van uw offlinegegevens en dit publiek naar [!DNL Dynamics 365] sturen, zodat dit in de feeds van de gebruiker wordt weergegeven zodra het publiek en de profielen in [!DNL Adobe Experience Platform] worden bijgewerkt.
...
#### Toepassings- en toepassingsgebruikers registreren in Azure Active Directory {#prerequisites-app-user}

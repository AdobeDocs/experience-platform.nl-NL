...
>[!TIP]
>
>* Als u onderscheid wilt maken tussen aangepaste velden die worden gebruikt voor Experience Platform-publiek en andere aangepaste velden binnen [!DNL Salesforce] , kunt u bij het maken van het aangepaste veld een herkenbaar voor- of achtervoegsel toevoegen. Gebruik bijvoorbeeld `Adobe_test_segment` of `test_segment_Adobe` in plaats van `test_segment` .

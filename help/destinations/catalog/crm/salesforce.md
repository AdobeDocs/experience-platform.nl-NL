...
description: Gebruik de Salesforce CRM-bestemming om uw accountgegevens te exporteren en deze te activeren in Salesforce CRM voor uw zakelijke behoeften.
...
Als markeerteken kunt u uw gebruikers een persoonlijke ervaring bieden op basis van kenmerken uit hun [!DNL Adobe Experience Platform] -profielen. U kunt een publiek maken op basis van uw offline gegevens en dit publiek naar Salesforce CRM sturen om het CRM-lidmaatschap bij te werken zodra het publiek en de profielen in [!DNL Adobe Experience Platform] worden bijgewerkt.
...
Houd rekening met de volgende voorwaarden in [!DNL Salesforce CRM] om gegevens van Experience Platform naar uw Salesforce-account te exporteren:
...
1. Ga ten slotte naar de Salesforce-website en bevestig of de profielen van het publiek zijn bijgewerkt.

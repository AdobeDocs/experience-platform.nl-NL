...
description: Gebruik de Zendesk-bestemming om uw accountgegevens te exporteren en deze in Zendesk te activeren voor uw zakelijke behoeften.
...
1. Ga naar de [!DNL Zendesk] -website en navigeer naar de **[!UICONTROL Contacts]** -pagina om te controleren of de profielen van het publiek zijn toegevoegd. Deze lijst kan worden gevormd om kolommen voor de extra gebieden te tonen die met publiek* worden gecreeerd* [!UICONTROL Mapping ID]** en publieksstatus.

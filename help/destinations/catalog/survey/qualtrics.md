...
description: De Qaltrics Website Feedback uitbreiding is een onderzoeksbestemming in Adobe Experience Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
Met [!DNL Qualtrics Website Feedback] kunt u de bezoekers van uw website op het juiste moment het juiste bericht laten zien. Of u nu feedback op websites wilt verbeteren of de conversie wilt verhogen, [!DNL Qualtrics Website Feedback] heeft u behandeld.
...
[!DNL Qualtrics Website Feedback] is een extensie voor enquêtes in [!DNL Adobe Experience Platform] . Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op [ Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
...
![ de Uitbreiding van de Terugkoppeling van de Website van Qualtrics ](../../assets/catalog/survey/qualtrics/catalog.png)
...
De extensie [!DNL Qualtrics Website Feedback] installeren:
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie de [ pagina van de Terugkoppeling van de Website van Qualtrics op Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).

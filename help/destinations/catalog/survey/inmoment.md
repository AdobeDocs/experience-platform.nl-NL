...
[!DNL InMoment] is een enquêteextensie in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op [Adobe Uitwisseling](https://exchange.adobe.com/experiencecloud.details.100847.html).
...
Voor informatie over de opties van de uitbreidingsconfiguratie, zie [de uitbreiding van de Universele Analyse van Google ](https://exchange.adobe.com/experiencecloud.details.100847.html) op de Uitwisseling van Adobe.

...
# [!DNL InMoment] extensie {#inmoment-extension}

## Overzicht {#overview}

Met de tagextensie [!DNL InMoment] kunt u snel en eenvoudig online feedback geven via het Digital Intercept-product. In de app kunnen intercepten worden geconfigureerd en beheerd via de CXI Cloud Admin, zodat CX-beheerders meer controle over hun programma hebben.

[!DNL InMoment] is een extensie voor enquêtes in [!DNL Adobe Experience Platform] . Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op [ Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.100847.html).

...
description: De Inbox van de Bespreking uitbreiding URL is een stem van de klantenbestemming in Adobe Experience Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
[!DNL Talk URL Inbox] is een stem van de klantenuitbreiding in [!DNL Adobe Experience Platform]. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op [ Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.100583.html).
...
![ Inbox van de Bespreking URL uitbreiding ](../../assets/catalog/voice/talkurl/catalog.png)
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie de [ Inbox van de Bespreking URL op Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.100583.html).

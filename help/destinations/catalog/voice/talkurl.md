...
[!DNL Talk URL Inbox] is een stem van de klantenuitbreiding in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op [Adobe Uitwisseling](https://exchange.adobe.com/experiencecloud.details.100583.html).
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie [Bespreek URL Inbox pagina op de Uitwisseling van Adobe](https://exchange.adobe.com/experiencecloud.details.100583.html).

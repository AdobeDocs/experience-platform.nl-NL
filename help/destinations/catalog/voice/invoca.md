...
[!DNL Invoca] brengt vraaggegevens en steminzichten in de digitale klantenreis. Met [!DNL Invoca’s] oproepinlichtingenplatform, marketers hebben eindelijk analyses om belresultaten te meten en offline conversies terug te koppelen aan digitale uitgaven.

[!DNL Invoca Tags] is een stem van de klantenuitbreiding in Adobe Experience Platform. Zie de extensiepagina op voor meer informatie over de extensiefunctionaliteit [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html).
...
Als u het dialoogvenster [!DNL Invoca Tags] extensie:
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie [Pagina Codes aanroepen op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html).

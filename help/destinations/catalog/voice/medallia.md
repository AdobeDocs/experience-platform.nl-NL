...
Implementeer [!DNL Medallia] snel en naadloos op uw wegeigenschappen. De extensie detecteert ook enquêtegebeurtenissen, legt feedback van klanten in real-time vast via gegevenselementen, gebruikt deze in regels om de ervaring van uw klant aan te passen en deelt gegevens met [!DNL Adobe Analytics] .

[!DNL Medallia] is een stem van de klantenuitbreiding in [!DNL Adobe Experience Platform]. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op [ Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.103279.medallia-for-adobe-launch.html).

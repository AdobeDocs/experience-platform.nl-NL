...
[!DNL Confirmit Digital Feedback] helpt u uw websiteverkeer om te zetten in real-time inzichten. Met [!DNL Confirmit], onopvallende en gerichte enquêtes kunnen worden weergegeven naar wens, waarbij bezoekers worden aangemoedigd feedback te geven, zoals:
...
[!DNL Confirmit] Digital Feedback is een Voice of the Customer extension in Adobe Experience Platform. Zie de extensiepagina op voor meer informatie over de extensiefunctionaliteit [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).
...
Als u het dialoogvenster [!DNL Confirmit] Extensie digitale feedback:
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie [De pagina Digitale feedback bevestigen op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).

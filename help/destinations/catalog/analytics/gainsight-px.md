...
Om u beter te helpen begrijpen hoe en wanneer u de *bestemming van PX van 0&rbrace; Gainsight zou moeten gebruiken, zijn hier de gevallen van het steekproefgebruik die* klanten kunnen oplossen door deze bestemming te gebruiken.[!DNL Adobe Experience Platform]

### Doelstellingen voor in-app-services {#targeting-in-app-engagements}

Een SaaS-bedrijf wil zijn klanten betrekken via een handleiding in de toepassing die op Gainsight PX is samengesteld. Een publiek dat deze betrokkenheid ontvangt, is gebaseerd op [!DNL Adobe Experience Platform] . De bestemming van PX van de Markering ontvangt het publiek en stelt het binnen het milieu van PX van de Markering ter beschikking.
...
|---|----|
| IdentifyID | Algemene gebruikersidentificatie die een gebruiker op unieke wijze identificeert in Gainsight PX en [!DNL Adobe Experience Platform] |
...
![&#x200B; de detailsscherm van de Bestemming in het gebruikersinterface die van Experience Platform tonen hoe te om de gebieden van de Naam en van de Beschrijving in te vullen &#x200B;](../../assets/catalog/analytics/gainsight-px/destination_details.png)
...
De segmentatiegegevens worden gestreamd van de Experience Platform naar Gainsight PX.

...
description: De extensie Google Global Site Tag is een analysedoel in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op de Uitwisseling van Adobe.
...
Gegevens verzenden naar [!DNL Google Analytics], [!DNL Google Ads]en de [!DNL Google Marketing Platform] via [!DNL Google's Global Site Tag], of gtag.js. U kunt meerdere accounts per product configureren.

[!DNL Google Global Site Tag] is een uitbreiding voor analysemogelijkheden in Adobe Experience Platform. Zie de extensiepagina op voor meer informatie over de extensiefunctionaliteit [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html).
...
Als u het dialoogvenster [!DNL Google Global Site Tag] extensie:
...
Voor informatie over de opties van de uitbreidingsconfiguratie, zie de uitbreiding [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html) pagina.

...
description: De SessionCam-extensie is een analysedoel in Adobe Experience Platform. Zie de extensiepagina over Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
[!DNL SessionCam] biedt een essentieel pakket met gereedschappen die het gedrag van de gebruiker weergeven en waarmee u de belangrijkste problemen ziet die u moet oplossen.

[!DNL SessionCam] is een uitbreiding voor analysemogelijkheden in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op [ Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.100517.html).
...
![ SessionCam Uitbreiding ](../../assets/catalog/analytics/sessioncam/catalog.png)
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie de [ pagina SessionCam op Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.100517.html).

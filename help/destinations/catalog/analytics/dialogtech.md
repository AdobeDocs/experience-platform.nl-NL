...
[!DNL DialogTech] is een uitbreiding voor analysemogelijkheden in Adobe Experience Platform. Raadpleeg de [Dialogtech-website](https://www.dialogtech.com/) voor meer informatie over de extensiefunctionaliteit.
...
Als u deze extensie wilt gebruiken, hebt u toegang tot Adobe Experience Platform Launch nodig. Platform starten wordt aangeboden aan Adobe Experience Cloud-klanten als een inbegrepen, waardetoevoegend onderdeel. Neem contact op met uw organisatiebeheerder voor toegang tot Platform Launch en vraag hen om u de **[!UICONTROL manage_properties]** toestemming te geven, zodat u extensies kunt installeren.

## Extensie {#install-extension} installeren

De extensie [!DNL DialogTech] installeren:

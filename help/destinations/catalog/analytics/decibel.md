...
Snel en naadloos implementeren [!DNL Decibel] op uw wegeigenschappen. De extra geavanceerde configuraties kunnen ook met regels worden opgesteld gebruikend acties die door de uitbreiding ter beschikking worden gesteld.

[!DNL Decibel] is een uitbreiding voor analysemogelijkheden in Adobe Experience Platform. Zie de extensiepagina op voor meer informatie over de extensiefunctionaliteit [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100913.html).
...
Als u het dialoogvenster [!DNL Decibel] extensie:
...
Voor informatie over de opties van de uitbreidingsconfiguratie, zie [Decibel extensiepagina](https://exchange.adobe.com/experiencecloud.details.100913.html) op Adobe Exchange.

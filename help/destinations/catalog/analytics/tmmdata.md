...
description: De extensie TMMData is een analysedoel in Adobe Experience Platform. Zie de extensiepagina over Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
[!DNL TMMData's] Het stichtingsplatform voor Adobe Marketing Cloud biedt marketingteams de middelen om al hun kritieke gegevensbronnen (inclusief interne/externe en online/offline gegevens) te openen en te combineren voor een betrouwbare, uitgebreide kanaalanalyse, met automatische campagneinstallatie en rechtstreekse import naar Adobe en andere analytische en BI-tools.

[!DNL TMMData] is een uitbreiding voor analysemogelijkheden in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op [ Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html).
...
![ Uitbreiding TMMData ](../../assets/catalog/analytics/tmmdata/catalog.png)
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie de [ pagina TMMData op Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html).

...
Raadpleeg [Adobe Media Analytics for Audio and Video extension page](../../../tags/extensions/web/media-analytics/overview.md) in de documentatie [!DNL Experience Launch] voor informatie over de configuratieopties voor extensies.

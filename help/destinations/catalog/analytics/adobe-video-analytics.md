...
Adobe Media Analytics for Audio and Video is een uitbreiding van analysemogelijkheden in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op [Adobe Uitwisseling](https://exchange.adobe.com/experiencecloud.details.100157.html).
...
Raadpleeg [Adobe Media Analytics for Audio and Video extension page](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/media-analytics-extension/overview.html) in de documentatie [!DNL Experience Launch] voor informatie over de configuratieopties voor extensies.

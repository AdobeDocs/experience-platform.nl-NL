---
keywords: Nielsen VideoJS Player Handler;nielsen video js player;nielsen video js player;Nielsen;nielsen;Nielsen videojs player;Nielsen Digital SDK;nielsen digital sdk
title: Nielsen VideoJS Player Handler extension
seo-title: Nielsen VideoJS Player Handler extension
description: De Nielsen VideoJS Player Handler-extensie is een analysedoel in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op de Uitwisseling van Adobe.
seo-description: De Nielsen VideoJS Player Handler-extensie is een analysedoel in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op de Uitwisseling van Adobe.
...
# [!DNL Nielsen VideoJS Player Handler] Extensie  {#nielsen-vjs-extension}

## Overzicht {#overview}

[!DNL Nielsen Digital SDK] De extensie launch biedt publieksmeting via de volgende digitale meetproducten:

DCR: Een meetoplossing waarmee dagelijks niet-lineaire digitale inhoud wordt gemeten, inclusief inhoud met advertenties, biedt een uitgebreide weergave van het gebruik van digitale inhoud door het publiek op alle desktops, mobiele apparaten, tablets en aangesloten apparaten.
...
[!DNL Nielsen VideoJS Player Handler] is een uitbreiding voor analysemogelijkheden in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op [Adobe Uitwisseling](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html).
...
De extensie [!DNL Nielsen VideoJS Player Handler] installeren:
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie de [Nielsen Digitale SDK pagina op de Uitwisseling van Adobe](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html).

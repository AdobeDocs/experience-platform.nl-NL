...
description: De Nielsen VideoJS Player Handler-extensie is een analysedoel in Adobe Experience Platform. Zie de extensiepagina over Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie de [ Nielsen Digitale SDK pagina op Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html).

...
De [!DNL Quantum Metric] tagextensie vergemakkelijkt de codeloze implementatie van [!DNL Quantum Metric's] mogelijkheden voor gegevensverzameling. Bovendien biedt deze extensie de mogelijkheid om gegevenselementen vast te leggen die nuttige informatie bevatten van de [!DNL Quantum Metric] API.

[!DNL Quantum Metric] is een uitbreiding voor analysemogelijkheden in Adobe Experience Platform. Zie de extensiepagina op voor meer informatie over de extensiefunctionaliteit [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
...
Als u het dialoogvenster [!DNL Quantum Metric] extensie:
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie [Quantum Metric page op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).

...
Deze extensie installeert de [!DNL JW Player] adapter om te verbinden [!DNL JW Player] gebeurtenissen voor Adobe Video Analytics. Maak gebruik van de kracht van Adobe Video Analytics om meer inzicht te krijgen in de videoweergavegewoonten van uw klanten.

[!DNL JW Player Analytics] (Bèta) is een uitbreiding van analysemogelijkheden in Adobe Experience Platform. Zie de extensiepagina op voor meer informatie over de extensiefunctionaliteit [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html).
...
Als u het dialoogvenster [!DNL JW Player Analytics] (bèta) extensie:
...
Voor informatie over de opties van de uitbreidingsconfiguratie, zie [Uitbreidingspagina voor JW Player Analytics (Bèta)](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html) in Adobe Exchange.

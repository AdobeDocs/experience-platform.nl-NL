...
description: De extensie Nielsen BSDK is een analysedoel in Adobe Experience Platform. Zie de extensiepagina over Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie de [ pagina Nielsen BSDK op Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.101361.html).

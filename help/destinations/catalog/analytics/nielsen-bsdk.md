...
[!DNL Nielsen BSDK] is een uitbreiding voor analysemogelijkheden in Adobe Experience Platform. Zie de extensiepagina op voor meer informatie over de extensiefunctionaliteit [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.html).
...
Als u het dialoogvenster [!DNL Nielsen BSDK] extensie:
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie [Nielsen BSDK-pagina op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.html).

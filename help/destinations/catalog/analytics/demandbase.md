...
Haal [!DNL Demandbase] B2B-accountinzichten in [!DNL Adobe Analytics] waar u verkeer en gedrag kunt segmenteren op basis van de industrie, omzet en uw doelaccounts. Deze op account gebaseerde weergave biedt unieke inzichten in betrokkenheid, conversie en de bron voor uw meest waardevolle bezoekers.

[!DNL Demandbase] is een analytische extensie in [!DNL Adobe Experience Platform] . Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op [ Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.101605.html).

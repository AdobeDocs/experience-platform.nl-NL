...
Gebruik [!DNL Google Universal Analytics] om uw advertentie-ROI te meten en uw Flash-, video- en sociale-netwerksites en -toepassingen bij te houden.

[!DNL Google Universal Analytics] is een analytische extensie in [!DNL Adobe Experience Platform] . Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op [ Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html).

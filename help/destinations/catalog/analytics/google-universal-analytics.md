...
description: De extensie Google Universal Analytics is een analysedoel in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op de Uitwisseling van Adobe.
...
[!DNL Google Universal Analytics] is een uitbreiding voor analysemogelijkheden in Adobe Experience Platform. Zie de extensiepagina op voor meer informatie over de extensiefunctionaliteit [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html).
...
Als u het dialoogvenster [!DNL Google Universal Analytics] extensie:
...
Voor informatie over de opties van de uitbreidingsconfiguratie, zie [Google Universal Analytics-extensiepagina](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html) op Adobe Exchange.

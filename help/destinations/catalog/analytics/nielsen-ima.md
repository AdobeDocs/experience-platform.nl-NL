...
description: De Nielsen IMA Handler-extensie is een analysedoel in Real-time Customer Data Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op de Uitwisseling van Adobe.
seo-description: De Nielsen IMA Handler-extensie is een analysedoel in Real-time Customer Data Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op de Uitwisseling van Adobe.
...
[!DNL Nielsen IMA Handler] is een analytische uitbreiding in het Platform van de Gegevens van de Klant in real time.

...
Als u uw **API sleutel** niet hebt, teken binnen aan uw rekening en verwijs naar [[!DNL Mailchimp]  produceer uw API sleutel &#x200B;](https://mailchimp.com/developer/marketing/guides/quick-start/#generate-your-api-key) documentatie om te creëren.

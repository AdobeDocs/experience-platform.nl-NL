...
Het doel [[!DNL Salesforce Marketing Cloud Account Engagement] &#x200B;](https://www.salesforce.com/products/marketing-cloud/marketing-automation/) (voorheen bekend als [!DNL Pardot] ) exporteert uw [!DNL Adobe Experience Platform] -profielgegevens naar het Salesforce B2B-marketingautomatiseringsplatform.

Dankzij deze integratie kunt u uw klantprofielen in [!DNL Adobe Experience Platform] naadloos synchroniseren met uw marketingcampagnes in [!DNL Salesforce Marketing Cloud Account Engagement] .
...
Als er een overeenkomst wordt gevonden met een van deze id&#39;s, wordt de bestaande perspectiefrecord voor accountbetrokkenheid bijgewerkt met de gegevens van [!DNL Adobe Experience Platform] . Als er geen overeenkomst wordt gevonden, wordt een nieuw perspectiefrecord gemaakt in Account Engagement.
...
Selecteer vervolgens **[!UICONTROL Allow]** om machtigingen te geven aan de **[!DNL Adobe Experience Platform]** -toepassing voor toegang tot uw [!DNL Salesforce Marketing Cloud Account Engagement] -account. *u moet dit slechts eenmaal doen*.
...
Als u publieksgegevens van [!DNL Adobe Experience Platform] naar het [!DNL (V2) Marketing Cloud Account Engagement] -doel wilt verzenden, moet u de XDM-schemavelden (Experience Data Model) toewijzen aan de corresponderende velden in het doel.
...
| `salutation` | String | De aanhef van het vooruitzicht (bijvoorbeeld meneer, mevrouw, dr.) |

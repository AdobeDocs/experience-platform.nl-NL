...
Om publieksgegevens naar [!DNL Oracle Responsys] te verzenden, moet u eerst [ met de bestemming ](#connect-destination) in [!DNL Adobe Experience Platform] verbinden, en dan [ opstelling een gegevensimporteren ](#import-data-into-responsys) van uw opslagplaats in [!DNL Oracle Responsys].

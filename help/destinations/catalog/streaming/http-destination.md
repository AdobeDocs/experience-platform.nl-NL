...
* Als u mTLS wilt gebruiken: voor uw gegevens die eindpunt ontvangen, moet TLS zijn uitgeschakeld en alleen mTLS zijn ingeschakeld. mTLS wordt niet gesteund als uw eindpunt OAuth 2 Wachtwoord of de authentificatie van de Referentie van de Cliënt vereist.
...
mTLS wordt **niet gesteund** als uw eindpunt OAuth 2 Wachtwoord of de authentificatie van de Credentials van de Cliënt vereist.
...
>[!NOTE]
>
>**mTLS beperking:** mTLS wordt niet gesteund met OAuth 2 de authentificatie van het Wachtwoord. Zie de [&#x200B; mTLS overwegingen &#x200B;](#mtls-considerations) sectie voor details.

* **[!UICONTROL Access Token URL]**: De URL aan uw zijde die toegangstokens uitgeeft en, naar keuze, tokens vernieuwt.
* **[!UICONTROL Client ID]**: De [!DNL client ID] die uw systeem toewijst aan [!DNL Adobe Experience Platform] .
* **[!UICONTROL Client Secret]**: De [!DNL client secret] die uw systeem toewijst aan [!DNL Adobe Experience Platform] .
...
>[!NOTE]
>
>**mTLS beperking:** mTLS wordt niet gesteund met OAuth 2 de authentificatie van de Referenties van de Cliënt. Zie de [&#x200B; mTLS overwegingen &#x200B;](#mtls-considerations) sectie voor details.
...
>title="HTTP-eindpunt"
>abstract="De URL van het HTTP-eindpunt waarnaar u de profielgegevens wilt verzenden. Dit zijn uw gegevens die eindpunt ontvangen en steunt mTLS indien gevormd (niet beschikbaar met 2 Wachtwoord OAuth of de authentificatie van de Referentie van de Cliënt)."

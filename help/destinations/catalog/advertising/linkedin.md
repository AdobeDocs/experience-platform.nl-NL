...
Installeer de [!DNL LinkedIn Insight Tag] conversietracering, herbestemming en demografische kenmerken van websites gebruiken.

[!DNL LinkedIn Insight Tag] is een advertentie-uitbreiding in Adobe Experience Platform. Zie voor meer informatie over de extensiefunctionaliteit [linkedIn Insight-tag](https://business.linkedin.com/marketing-solutions/insight-tag).
...
Als u het dialoogvenster [!DNL LinkedIn Insight Tag] extensie:
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie [linkedIn Insight-tag](https://business.linkedin.com/marketing-solutions/insight-tag).

...
Gebruik deze doelconnector om publiekssegmenten van [!DNL Adobe Experience Platform] rechtstreeks te exporteren naar het programmatic advertentieplatform van [!DNL Index Exchange] .

Zodra uitgevoerd, richten deze publiekssegmenten doelovereenkomsten door media eigenaars, marktplaatspartners, of gedeeld met uitgevers en curators door marktplaatsverkopers.
...
#### Ondersteunde id-typen {#supported-identifier-types}

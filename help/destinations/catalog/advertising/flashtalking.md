...
description: De Flashtalk OneTag-extensie is een advertentiebestemming in Adobe Experience Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# [!DNL Flashtalking OneTag] extensie {#flashtalking-extension}

## Overzicht {#overview}

Met de tagextensie [!DNL Flashtalking OneTag] kunt u gemakkelijk handelingen van sites toewijzen aan weergave, video en mobiele advertentieactiviteiten. Implementeer de [!DNL Flashtalking OneTag] met tags op uw wegeigenschappen.

[!DNL Flashtalking OneTag] is een advertentie-extensie in [!DNL Adobe Experience Platform] . Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op [ Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
...
![ het fletsen uitbreiding ](../../assets/catalog/advertising/flashtalking/catalog.png)
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie [ het Flashtalk OneTag pagina op Adobe Exchange ](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).

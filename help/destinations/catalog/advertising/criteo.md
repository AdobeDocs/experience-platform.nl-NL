...
>[!IMPORTANT]
>
>Deze bestemmingsschakelaar en documentatiepagina worden gecreeerd en door Criteo gehandhaafd. Voor om het even welke onderzoeken of updateverzoeken, direct contactCriteo [&#x200B; &#x200B;](mailto:criteoTechnicalPartnerships@criteo.com).
...
Voor een beter inzicht in het gebruik van de [!DNL Criteo] -bestemming zijn er enkele doelen die [!DNL Adobe Experience Platform] klanten kunnen bereiken met [!DNL Criteo] :

### Gebruik geval 1: Krijg verkeer {#use-case-1}

Laat uw bedrijf zien met relevante productaanbiedingen en flexibele creatieve producten. Met intelligente productaanbevelingen zullen uw advertenties automatisch de producten bevatten die het meest waarschijnlijk bezoeken en betrokkenheid zullen veroorzaken. Met de flexibele optie kunt u doelgroepen maken op basis van de gegevensset Handelsgegevens van Criteo of op basis van uw eigen perspectieflijsten en Adobe CDP-segmenten.

### Hoofdlettergebruik 2: website-conversies verhogen {#use-case-2}
...
### Verifiëren voor commissie {#authenticate}

De stappen om te verbinden zijn als volgt:

1. Meld u aan bij [!DNL Adobe Experience Platform] en maak verbinding met het doel Computer.
...
| Adverteerder-id | Identiteitskaart van Adverteerder van de website van uw organisatie. Neem contact op met de accountmanager van de website voor deze informatie. | Ja |

...
* De bronsleutel voor de rekening of de adverteerder van DSP, die wordt geproduceerd wanneer a [[!DNL Real-Time CDP]  bron in DSP &#x200B;](https://experienceleague.adobe.com/docs/advertising-cloud/dsp/audiences/sources/source-create.html) wordt gecreeerd. Uw DSP-accountteam zal deze sleutel met u delen. U zult het binnen Experience Platform gebruiken om een bestemmingsverbinding aan de bestemming van Advertising DSP tot stand te brengen, zoals [&#x200B; hieronder verklaard &#x200B;](#authenticate).

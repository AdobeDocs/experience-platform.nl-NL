...
De [!DNL Bing Ads Universal Event Tracking] (UET) De uitbreiding van tags is een handige manier om te volgen wat er gebeurt wanneer iemand op de advertentie heeft geklikt. Door één UET-tag te gebruiken om op te nemen wat klanten op uw website doen, kunt u deze gegevens benutten, zodat u conversies of doelgroepen kunt bijhouden met behulp van remarketing lijsten.

[!DNL Bing Ads Universal Event Tracking] (UET) is een advertentie-uitbreiding in Adobe Experience Platform. Zie de extensiepagina op voor meer informatie over de extensiefunctionaliteit [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100154.html).
...
Als u het dialoogvenster [!DNL Bing Ads Universal Event Tracking] (UET) extensie:
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie [Pagina voor Universal Event Tracking (UET) voor Bing Ads op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100154.html).

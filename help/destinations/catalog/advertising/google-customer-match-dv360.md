...
Bepaalde door Google geïntegreerde derden, zoals Adobe [!DNL Real-Time CDP] , kunnen het [!DNL Google Audience Partner API] gebruiken om [!DNL Customer Match] publiek rechtstreeks in de [!DNL Display & Video 360] -account van klanten te maken.
...
## Belangrijke kennisgeving over wijzigingen aan Google-bestemmingen in verband met geactualiseerde toestemmingsvereisten in de Europese Unie {#eu-consent-notice}
...
## Wanneer gebruikt u deze bestemming {#when-to-use}
...
Om u beter te helpen begrijpen hoe en wanneer om deze bestemming te gebruiken, zijn hier voorbeelden van gebruiksgevallen die [!DNL Adobe Experience Platform] klanten kunnen oplossen door deze eigenschap te gebruiken.

...
Selecteer in **[!UICONTROL Verbindingen]** > **[!UICONTROL Doelen]** de optie [!DNL The Trade Desk]en selecteer **[!UICONTROL Configureren]**.
...
In de stap [!UICONTROL Verificatie] moet u [!DNL The Trade Desk] verbindingsgegevens invoeren:

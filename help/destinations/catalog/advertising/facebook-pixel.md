...
De [!DNL Facebook Pixel] is een analyseprogramma waarmee u de doeltreffendheid van uw reclame kunt meten door te begrijpen wat mensen op uw website doen.

[!DNL Facebook Pixel] is een advertentie-uitbreiding in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit raadpleegt u de [Facebook Pixel-website](https://developers.facebook.com/docs/facebook-pixel/).
...
Als u het dialoogvenster [!DNL Facebook Pixel] extensie:

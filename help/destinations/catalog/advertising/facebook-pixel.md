...
[!DNL Facebook Pixel] is een analyseprogramma waarmee u de doeltreffendheid van uw advertenties kunt meten door te begrijpen wat mensen op uw website doen.

[!DNL Facebook Pixel] is een advertentie-extensie in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de [&#x200B; website van het Pixel van Facebook &#x200B;](https://developers.facebook.com/docs/facebook-pixel/).

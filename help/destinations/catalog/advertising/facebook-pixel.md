...
description: De Facebook Pixel-extensie is een reclamebestemming in Adobe Experience Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# [!DNL Facebook Pixel] extensie {#facebook-pixel-extension}

## Overzicht {#overview}

[!DNL Facebook Pixel] is een analyseprogramma waarmee u de effectiviteit van uw advertenties kunt meten aan de hand van de handelingen die mensen op uw website uitvoeren.

[!DNL Facebook Pixel] is een advertentie-extensie in [!DNL Adobe Experience Platform] . Voor meer informatie over de uitbreidingsfunctionaliteit, zie de [ website van het Pixel van Facebook ](https://developers.facebook.com/docs/facebook-pixel/).
...
![ uitbreiding van het Pixel van Facebook ](../../assets/catalog/advertising/facebook-pixel/catalog.png)

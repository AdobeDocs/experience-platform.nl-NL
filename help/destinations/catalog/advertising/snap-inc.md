...
>[!IMPORTANT]
>
>Deze bestemmingsschakelaar en documentatiepagina worden gecreeerd en door het *Onverwachte team van Inc.* gehandhaafd. Voor om het even welke onderzoeken of updateverzoeken, contacteer hen direct in *dev-support@snap.com*
...
1. Vind de *Magnetische Inc.* bestemming van de Catalogus van de Bestemming van [!DNL Adobe Experience Platform] en selecteer **Opstelling**.
...
4. De gegevens voor Snapchat waartoe [!DNL Adobe Experience Platform] toegang heeft, worden weergegeven. Selecteer **verdergaan** met het verbindingsproces te werk te gaan.

![ Scherm 2 van de Auth ](/help/destinations/assets/catalog/advertising/snapchat-ads/auth2.png)

Nadat u doorgaat hebt geselecteerd, wacht u tot u weer bent omgeleid naar [!DNL Adobe Experience Platform] .
...
* **[!UICONTROL Account ID]**: De id van het Advertentieaccount die is gekoppeld aan het Advertentieaccount waarnaar u uw publiek wilt importeren. Voor meer informatie over hoe te om dit te vinden, zie [ deze documentatie op het Centrum van Bedrijfs Hulp van de Snapchat ](https://businesshelp.snapchat.com/s/article/biz-acct-id?language=en_US).
...
Na het activeren van publiek aan de *Magnetische bestemming Inc.*, zult u het publiek in de Magnetische 2} sectie [**van de Manager van Advertenties** kunnen zien. ](https://businesshelp.snapchat.com/s/article/audience-sharing) Ga als volgt te werk om naar deze sectie te navigeren:

1. Logboek in de [ Magnetische Manager van Advertenties ](https://ads.snapchat.com/)
2. Selecteer **Soorten publiek** van het pulldown menu in de hogere linkerhoek van het scherm. U ziet het publiek dat u in [!DNL Adobe Experience Platform] hebt geactiveerd in de Audience Library:

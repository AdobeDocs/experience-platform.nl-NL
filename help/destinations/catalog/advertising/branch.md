...
# [!DNL Branch] extensie {#branch-extension}
...
Branch is een advertentie-extensie in [!DNL Adobe Experience Platform] . Voor meer informatie over de uitbreidingsfunctionaliteit, zie de [ eigenschappen pagina ](https://branch.io/features/) op de website van de Tak.

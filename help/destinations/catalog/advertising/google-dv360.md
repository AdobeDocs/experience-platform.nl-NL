...
* De activering van publieksbackfills naar de [!DNL Google Display & Video 360] -bestemming vindt plaats 24-48 uur nadat een publiek voor het eerst is toegewezen aan een doelverbinding. Deze update is een reactie op het Google-beleid om 24 uur te wachten tot er gegevens zijn ingevoerd. De update is bedoeld om de overeenkomende snelheden tussen [!DNL Real-Time CDP] en [!DNL Google Display & Video 360] te verbeteren. Dit is een achtergrondconfiguratie die op deze bestemming slechts van toepassing is en die niet met om het even welke klant-configureerbare het plannen opties in UI verwant is.

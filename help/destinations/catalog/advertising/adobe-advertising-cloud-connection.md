...
description: Leer hoe u geverifieerde en niet-geverifieerde soorten publiek van de eerste partij kunt delen met Adobe Advertising Cloud Demand-Side Platform (DSP) door gebruik te maken van meerdere identiteitstypen.
...
Met de bestemming Adobe Advertising Cloud Demand-Side Platform (DSP) kunnen gebruikers zowel geverifieerde als niet-geverifieerde soorten publiek van de eerste partij delen met een DSP-account of specifieke adverteerder binnen een account.
...
Deze verbinding vervangt de [&#x200B; Verouderde verbinding van Adobe Advertising Cloud DSP van Adobe &#x200B;](adobe-advertising-cloud-connection-legacy.md), die slechts gehakt e-mailadressen steunt.

>[!IMPORTANT]
>
>Deze pagina is gemaakt door het team van Adobe Advertising [!DNL DSP] . Voor vragen of verzoeken om updates kunt u rechtstreeks contact opnemen met de ondersteuning van Advertising Cloud op `adcloud_support@adobe.com` .
...
* Voor [!DNL RampID activation] geldt dat [!DNL DSP] instellingen op accountniveau en op campagneniveau het delen van gebruikers met [!DNL LiveRamp RampID] mogelijk maken. Hiermee worden klantgegevens naar [!DNL RampIDs] vertaald om doelgerichte segmenten te maken. Uw Adobe-accountteam zal deze configuratie uitvoeren. [!DNL RampID] is beschikbaar via een partnerschap tussen [!DNL DSP] en [!DNL LiveRamp] en u hebt uw eigen [!DNL LiveRamp] -lidmaatschap niet nodig om dit te gebruiken.
...
| `Everesttech cookie` | Cookie van derden voor Adobe Advertising | Vereist voor het maken van op cookies gebaseerde segmenten. |
...
U kunt kiezen welke id&#39;s u naar Adobe Advertising DSP wilt verzenden. Standaard zijn de cookie-id&#39;s geselecteerd voor de adverteerder. U kunt ook [!UICONTROL Hashed Email] , [!UICONTROL IDFA] en [!UICONTROL GAID] toevoegen.
...
Controleer het volgende om te controleren of de publieksgegevens zijn gedeeld met Advertising Cloud:

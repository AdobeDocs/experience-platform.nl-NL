...
Met deze extensie kunt u snel en eenvoudig implementeren [!DNL DoubleClick Floodlight] -tags die de traditionele indeling voor overlopen gebruiken (geen algemene sitetag). Opmerking: Deze extensie is in bèta.

[!DNL DoubleClick Floodlight] (Beta) is een advertentie-uitbreiding in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit raadpleegt u de [!DNL Google] ondersteuningsdocumentatie voor [DoubleClick Floodlight](https://support.google.com/dcm/answer/2823388?hl=en).

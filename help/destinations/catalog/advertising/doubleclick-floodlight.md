...
title: DoubleClick Floodlight-extensie (Beta)
description: De extensie DoubleClick Floodlight (Beta) is een advertentiebestemming in Adobe Experience Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# [!DNL DoubleClick Floodlight] (Beta) -extensie

## Overzicht {#overview}

Met deze extensie kunt u [!DNL DoubleClick Floodlight] -tags snel en eenvoudig implementeren in de traditionele sluimerstand (niet de globale sitetag). Opmerking: deze extensie is in bèta.

[!DNL DoubleClick Floodlight] (Beta) is een advertentie-extensie in [!DNL Adobe Experience Platform] . Voor meer informatie over de uitbreidingsfunctionaliteit, zie de [!DNL Google] steundocumentatie voor [ Dubbelklik Vullende licht ](https://support.google.com/dcm/answer/2823388?hl=en).
...
![ Doubleclick de uitbreiding van de Vullingslicht ](../../assets/catalog/advertising/doubleclick-floodlight/catalog.png)
...
De extensie DoubleClick Floodlight (Beta) installeren:

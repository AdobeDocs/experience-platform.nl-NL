...
description: De extensie DoubleClick Floodlight (Beta) is een advertentiebestemming in Adobe Experience Platform. Zie de extensiepagina over Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
[!DNL DoubleClick Floodlight] (Beta) is een advertentie-extensie in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de [!DNL Google] steundocumentatie voor [ Dubbelklik Vullende licht ](https://support.google.com/dcm/answer/2823388?hl=en).

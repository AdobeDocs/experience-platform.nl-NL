...
description: De extensie Google Ads is een advertentiebestemming in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op de Uitwisseling van Adobe.
...
Met deze extensie worden conversies bijgehouden van gebruikers die op uw [!DNL Google Ads]. U moet ook de extensie gtag.js installeren en deze toevoegen aan uw bibliotheek, zoals [!DNL Google Ads] is ervan afhankelijk.

[!DNL Google Ads] is een advertentie-uitbreiding in Adobe Experience Platform. Zie de extensiepagina op voor meer informatie over de extensiefunctionaliteit [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html).
...
![Google Ads-extensie](../../assets/catalog/advertising/google-ads-extension/catalog.png)
...
Als u het dialoogvenster [!DNL Google Ads] extensie:
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie [Google Ads-pagina op Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html).

...
### Bestaande [!DNL Google Ads] account {#existing-google-ads-account}

>[!IMPORTANT]
>
> [!DNL Google] heeft de nieuwe [!DNL Google Ads] cookie-integratie met externe leveranciers vervangen. Voor het uitvoeren van de stappen van de lijst van gewenste personen in de volgende sectie, moet u bestaande integratie met [!DNL Google Ads] hebben. Het instellen van een [!DNL Google Ads] -integratie wordt daarom aanbevolen voor het gebruik van [!DNL Google Customer Match] . Lees de zelfstudie over het maken van een [!DNL Google Customer Match] -verbinding voor meer informatie over het maken van een [[!DNL Google Customer Match]](./google-customer-match.md) -integratie.

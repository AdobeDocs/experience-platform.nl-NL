...
description: Google Customer Match gebruikt uw online- en offline-gegevens om uw klanten te bereiken en opnieuw contact op te nemen met andere door Google bediende en bediende eigendommen, zoals Zoeken, Winkelen en Gmail.
...
><br/>
>De klanten die geen de Privacy &amp; het Schild van de Veiligheid van Adobe hebben gekocht moeten de [ mogelijkheden van de segmentdefinitie ](../../../segmentation/home.md#segment-definitions) binnen [ de Bouwer van het Segment ](../../../segmentation/ui/segment-builder.md) aan filter uit niet-goedgekeurde profielen gebruiken, om de bestaande [!DNL Real-Time CDP] bestemmingen van Google zonder onderbreking te blijven gebruiken.

[[!DNL Google Customer Match] ](https://support.google.com/google-ads/answer/6379332?hl=en) gebruikt uw online en off-line gegevens om met uw klanten over Google bezeten en in werking gestelde eigenschappen, zoals: [!DNL Search], [!DNL Shopping], en [!DNL Gmail] te bereiken en opnieuw in dienst te nemen.
...
Voor een beter begrip van hoe en wanneer u de [!DNL Google Customer Match] -bestemming gebruikt, zijn voorbeelden van gebruiksgevallen die [!DNL Adobe Experience Platform] -klanten met deze functie kunnen oplossen.
...
Sommige bestemmingen in Experience Platform hebben bepaalde regels en verplichtingen voor gegevens die naar het bestemmingsplatform worden verzonden of van het bestemmingsplatform worden ontvangen. U bent verantwoordelijk voor het begrijpen van de beperkingen en verplichtingen van uw gegevens en hoe u die gegevens gebruikt in [!DNL Adobe Experience Platform] en het doelplatform. [!DNL Adobe Experience Platform] biedt tools voor gegevensbeheer waarmee u sommige van deze gegevensgebruiksverplichtingen kunt beheren. [ leer meer ](../../../data-governance/labels/overview.md) over de hulpmiddelen en het beleid van het gegevensbeheer.
...
Afhankelijk van het type id&#39;s waarin u [!DNL Adobe Experience Platform] invoert, moet u aan de desbetreffende vereisten voldoen.
...
Voordat u de naamruimte `User_ID` kunt gebruiken om gegevens naar Google te verzenden, moet u uw eigen id&#39;s eerst synchroniseren met [!DNL gTag] . Zie de [ officiële documentatie van Google ](https://support.google.com/google-ads/answer/9199250) voor gedetailleerde informatie.
...
Voor details op hoe te om [!DNL App ID] te vinden, zie de [ officiële documentatie van Google ](https://developers.google.com/adwords/api/docs/reference/v201809/AdwordsUserListService.CrmBasedUserList#appid) of vraag uw vertegenwoordiger van Google.

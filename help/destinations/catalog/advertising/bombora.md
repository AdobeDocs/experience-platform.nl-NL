...
>[!AVAILABILITY]
>
>De functionaliteit om rekeningspubliek aan de bestemming van het publiek van Bombora te activeren ABM is beschikbaar voor bedrijven die [ zaken-aan-Zaken ](/help/rtcdp/overview.md#rtcdp-b2b) en [ zaken-aan-Persoon ](/help/rtcdp/overview.md#rtcdp-b2p) uitgaven van [!DNL Real-Time Customer Data Platform] kopen.
...
Om u beter te helpen begrijpen hoe en wanneer u de bestemming zou moeten gebruiken Bombora, zijn hier voorbeelden van gebruiksgevallen die [!DNL Adobe Experience Platform] klanten kunnen oplossen door deze bestemming te gebruiken.

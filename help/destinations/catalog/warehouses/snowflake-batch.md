...
* **TS**: Een timestamp kolom die erop wijst wanneer elke rij van de gedeelde lijst het laatst werd bijgewerkt
* **beleidsidentiteitskaart van de Fusie**: identiteitskaart van het [&#x200B; fusiebeleid &#x200B;](../../../profile/merge-policies/overview.md) dat het publiek dat tot wordt geactiveerd behoort

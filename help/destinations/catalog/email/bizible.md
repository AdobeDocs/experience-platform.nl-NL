...
description: De Bizible-extensie is een e-maildoel in Adobe Experience Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
[!DNL Bizible] is een e-mailextensie in [!DNL Adobe Experience Platform] . Voor meer informatie over Bizible, lees [&#x200B; Attributie van de Marketing &#x200B;](https://experienceleague.adobe.com/docs/bizible/using/introduction-to-bizible/overview-resources/marketing-attribution.html?lang=nl-NL) in de Bizible overzichtsmiddelen.
...
![&#x200B; Bizible uitbreiding &#x200B;](../../assets/catalog/email/bizible/catalog.png)
...
De extensie [!DNL Bizible] installeren:

...
[!DNL Marketo Engagement Platform] vereenvoudigt het plannen, ordenen en meten van de betrokkenheid van klanten en vooruitzichten in elke fase van hun ervaring, van het beheer van leads tot marketing op basis van account.
...
[!DNL Marketo Munchkin] is een e-mailextensie in [!DNL Adobe Experience Platform] . Voor meer informatie over Marketo Munchkin, lees [ Lood Volgend ](https://developers.marketo.com/javascript-api/lead-tracking/) in de documentatie van Marketo.

---
keywords: Marketo;marketo;Marketo-extensie;markeerextensie
title: Marketo-extensie
description: De extensie Marketo is een e-maildoel in Adobe Experience Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
Dankzij de krachtige software voor marketingautomatisering van [!DNL Marketo] kunnen marketers de kunst en wetenschap van digitale marketing onder de knie krijgen en klanten en vooruitzichten tegemoet treden.

[!DNL Marketo] is een e-mailextensie in Adobe Experience Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de [&#x200B; uitbreidingspagina op Adobe Exchange &#x200B;](https://exchange.adobe.com/experiencecloud.details.106250.bounteous-extension-for-adobe-launch-and-marketo.html).
...
![&#x200B; Uitbreiding van Marketo &#x200B;](../../assets/catalog/email/marketo/catalog.png)
...
1. In de [&#x200B; interface van Experience Platform &#x200B;](https://platform.adobe.com/), ga **[!UICONTROL Destinations]** > **[!UICONTROL Catalog]**.
2. Selecteer de extensie in de catalogus of gebruik de zoekbalk.
3. Klik op de bestemming om deze te markeren en selecteer vervolgens **[!UICONTROL Configure]** in de rechtertrack. Als het besturingselement **[!UICONTROL Configure]** grijs wordt weergegeven, ontbreekt de machtiging **[!UICONTROL manage_properties]** . Zie [&#x200B; Eerste vereisten &#x200B;](#prerequisites).
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie de [&#x200B; pagina van Marketo op Adobe Exchange &#x200B;](https://exchange.adobe.com/experiencecloud.details.106250.bounteous-extension-for-adobe-launch-and-marketo.html).

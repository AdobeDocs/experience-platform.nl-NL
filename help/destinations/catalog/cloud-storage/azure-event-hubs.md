...
title: Verbinding met Azure Event Hubs
...
U kunt een uitgaande verbinding in real time maken met uw [!DNL Azure Event Hubs] -opslag om gegevens vanuit [!DNL Adobe Experience Platform] te streamen.
...
Experience Platform biedt een lijst met statische IP&#39;s die u kunt lijsten van gewenste personen voor de [!DNL Azure Event Hubs] -bestemming om aan de beveiligings- en compatibiliteitsvereisten van klanten te voldoen. Zie {de lijst van gewenste personen van het 0} IP adres voor het stromen bestemmingen [&#x200B; voor de volledige lijst van IPs aan lijst van gewenste personen.](/help/destinations/catalog/streaming/ip-address-allow-list.md)
...
![&#x200B; Beeld van het scherm UI die voltooide gebieden voor de standaardauthentificatiedetails van de Hubs van de Gebeurtenis van Azure tonen &#x200B;](../../assets/catalog/cloud-storage/event-hubs/event-hubs-standard-authentication.png)
...
![&#x200B; Beeld van het scherm UI die voltooide gebieden voor de standaardauthentificatiedetails van de Hubs van de Gebeurtenis van Azure tonen &#x200B;](../../assets/catalog/cloud-storage/event-hubs/event-hubs-sas-authentication.png)
...
![&#x200B; Beeld van het scherm UI die voltooide gebieden voor de bestemmingsdetails van de Hubs van de Gebeurtenis van Azure tonen &#x200B;](../../assets/catalog/cloud-storage/event-hubs/event-hubs-destination-details.png)
...
>* [&#x200B; de beleidsevaluatie van de Goedkeuring &#x200B;](/help/data-governance/enforcement/auto-enforcement.md#consent-policy-evaluation) wordt momenteel niet gesteund in de uitvoer naar de bestemming van de Hubs van de Gebeurtenis van Azure. [Meer informatie](/help/destinations/ui/activate-streaming-profile-destinations.md#consent-policy-evaluation).
...
>[!MORELIKETHIS]
>
>* [&#x200B; verbind met de Hubs van de Gebeurtenis van Azure en activeer gegevens gebruikend de Dienst API van de Stroom &#x200B;](../../api/streaming-destinations.md)

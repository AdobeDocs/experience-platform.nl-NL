...
[!DNL Adobe Experience Platform] ondersteunt gegevensexport naar de volgende bestemmingen voor cloudopslag:

* [Amazon Kinesis-verbinding](amazon-kinesis.md)
* [Amazon S3-verbinding](amazon-s3.md)
* [Azure Blob-verbinding](azure-blob.md)
* [Azure Data Lake Storage Gen2](adls-gen2.md)
* [Verbinding met Azure Event Hubs](azure-event-hubs.md)
...
* **de uitvoer van de Dataset**. Gebruik deze functionaliteit om volledige datasets naar de bestemmingen van de wolkenopslag uit te voeren. [Lees meer](/help/destinations/ui/export-datasets.md) over de nieuwe functionaliteit.

...
De [!DNL Kinesis Data Streams] -service van [!DNL Amazon Web Services] verzamelt en verwerkt grote stromen gegevensrecords in realtime.

U kunt een uitgaande verbinding in real time maken met uw [!DNL Amazon Kinesis] -opslag om gegevens vanuit [!DNL Adobe Experience Platform] te streamen.
...
>* [ bestemming van de Hubs van de Gebeurtenis van Azure ](./azure-event-hubs.md)

...
Met de release van het Experience Platform van juli 2023 biedt de [!DNL Azure Blob] -bestemming nieuwe functionaliteit, zoals hieronder wordt weergegeven:
...
[!DNL Azure Blob] (hierna [!DNL Blob] genoemd) is een Microsoft-oplossing voor objectopslag voor de cloud. Deze zelfstudie bevat stappen voor het maken van een [!DNL Blob] -doel met behulp van de gebruikersinterface van [!DNL Platform] .

## Verbinding maken met uw [!UICONTROL Azure Blob] -opslag via API of UI {#connect-api-or-ui}

* Om met uw [!UICONTROL Azure Blob] opslagplaats te verbinden gebruikend het gebruikersinterface van het Platform, lees de secties [ verbinden met de bestemming ](#connect) en [ actief publiek aan deze bestemming ](#activate) hieronder.

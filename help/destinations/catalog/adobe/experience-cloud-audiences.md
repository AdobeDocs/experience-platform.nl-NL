...
Alvorens u publiek naar Adobe Analytics kunt verzenden, moet u de Dienst van de Identiteit van Experience Cloud voor Analytics en Audience Manager [&#x200B; uitvoeren.](https://experienceleague.adobe.com/docs/id-service/using/implementation/setup-aam-analytics.html?lang=nl-NL)

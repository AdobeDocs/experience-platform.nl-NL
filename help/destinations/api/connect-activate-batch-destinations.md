...
In deze zelfstudie vindt u begeleidende referentiedocumentatie voor alle API-bewerkingen. Zie de [&#x200B; documentatie van de Dienst API van de Stroom op Adobe I/O &#x200B;](https://www.adobe.io/experience-platform-apis/references/flow-service/). We raden u aan deze zelfstudie en de API-naslagdocumentatie parallel te gebruiken.
...
### Toegang tot uw gegevens toestaan in [!DNL Experience Platform] {#authorize-access-experience-platform}

...
+++Verouderde [!DNL base connection] tonen voor [!DNL Amazon S3]
...
+++Verouderde [!DNL target connection] tonen voor [!DNL Amazon S3]
...
In de onderstaande tabbladen ziet u de volledige verouderde en nieuwe basisverbinding en voorbeelden van doelverbindingen voor [!DNL Azure Blob] . De parameters die nodig zijn om basisverbindingen voor Azure Blob-doelen te maken, veranderen niet.
...
+++Verouderde [!DNL base connection] tonen voor [!DNL Azure Blob]
...
+++Verouderde [!DNL target connection] tonen voor [!DNL Azure Blob]
...
+++Verouderde versie van SFTP weergeven [!DNL base connection] - wachtwoordverificatie
...
+++Verouderde [!DNL base connection] tonen voor [!DNL SFTP - SSH key] verificatie
...
+++Verouderde versie weergeven [!DNL target connection] voor SFTP
...
+++Nieuwe [!DNL base connection] weergeven voor [!DNL SFTP - SSH key] verificatie
...
+++Een voorbeeld van transformatieparameters na de migratie weergeven

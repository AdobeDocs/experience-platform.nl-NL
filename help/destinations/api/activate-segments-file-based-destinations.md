...
Dit artikel verklaart het werkschema dat wordt vereist om de [&#x200B; Dienst API van de Stroom &#x200B;](https://developer.adobe.com/experience-platform-apis/references/destinations/) te gebruiken om gekwalificeerde profielen van [!DNL Adobe Experience Platform] naar één van de hierboven verbonden plaatsen van de wolkenopslag uit te voeren.
...
Deze handleiding vereist een goed begrip van de volgende componenten van [!DNL Adobe Experience Platform]:
...
* [[!DNL Segmentation Service]](../../segmentation/api/overview.md): [!DNL Adobe Experience Platform Segmentation Service] bouwt een publiek in [!DNL Adobe Experience Platform] op basis van uw [!DNL Real-Time Customer Profile] gegevens.
...
De volgende secties verstrekken extra informatie die u moet weten om gegevens aan op dossier-gebaseerde bestemmingen in Experience Platform te activeren.
...
In deze zelfstudie vindt u begeleidende referentiedocumentatie voor alle API-bewerkingen. Zie de [&#x200B; Dienst van de Stroom - de documentatie van bestemmings API op de website van Adobe Developer &#x200B;](https://developer.adobe.com/experience-platform-apis/references/destinations/). We raden u aan deze zelfstudie en de API-naslagdocumentatie parallel te gebruiken.
...
| Azure Blob-opslag | `6d6b59bf-fb58-4107-9064-4d246c0e5bb2` | `752d422f-b16f-4f0d-b1c6-26e448e3b388` |
...
U hebt deze IDs nodig om diverse entiteiten van de stroomdienst in de volgende stappen van dit leerprogramma te construeren. U moet ook verwijzen naar delen van de verbindingsspecificatie zelf om bepaalde entiteiten in te stellen zodat u de verbindingsspecificaties kunt ophalen van de Flow Service API&#39;s. Zie de voorbeelden hieronder van het terugwinnen van verbindingsspecificaties voor alle bestemmingen in de lijst:
...
>[!TAB  de Opslag van de Blob van Azure ]
...
>[!TAB  Gen 2 van Gegevens van Azure (ADLS Gen2) ]
...
Met behulp van de eigenschappen die zijn opgegeven in de verificatiespecificatie (dat wil zeggen `authSpec` van het antwoord) kunt u een basisverbinding maken met de vereiste referenties, specifiek voor elk doeltype, zoals in de volgende voorbeelden wordt getoond:
...
+++[!DNL Amazon S3] - Verbindingsverzoek baseren met toegangstoets en geheime-sleutelverificatie

>[!TIP]
>
>Voor informatie over hoe te om de vereiste authentificatiegeloofsbrieven te verkrijgen, zie [&#x200B; voor authentiek verklaren aan bestemmings &#x200B;](/help/destinations/catalog/cloud-storage/amazon-s3.md#authenticate) sectie van de pagina van de de bestemmingsdocumentatie van Amazon S3.
...
>[!TIP]
>
>Voor informatie over hoe te om de vereiste authentificatiegeloofsbrieven te verkrijgen, zie [&#x200B; voor authentiek verklaren aan bestemmings &#x200B;](/help/destinations/catalog/cloud-storage/azure-blob.md#authenticate) sectie van de de bestemmingsdocumentatiepagina van de Opslag van Azure Blob.
...
>[!TIP]
>
>Voor informatie over hoe te om de vereiste authentificatiegeloofsbrieven te verkrijgen, zie [&#x200B; voor authentiek verklaren aan bestemmings &#x200B;](/help/destinations/catalog/cloud-storage/adls-gen2.md#authenticate) sectie van de pagina van de de bestemmingsdocumentatie van Gen 2 van de Gegevens van Azure (ADLS Gen2).
...
>[!TIP]
>
>Er zijn geen verificatiereferenties vereist voor de bestemming Landing Zone voor gegevens. Voor meer informatie, zie [&#x200B; voor authentiek verklaren aan bestemmings &#x200B;](/help/destinations/catalog/cloud-storage/data-landing-zone.md#authenticate) sectie van de Gegevens Landing de documentatiepagina van de Zone van de bestemmingsbestemming.
...
>[!TIP]
>
>Voor informatie over hoe te om de vereiste authentificatiegeloofsbrieven te verkrijgen, zie [&#x200B; voor authentiek verklaren aan bestemmings &#x200B;](/help/destinations/catalog/cloud-storage/google-cloud-storage.md#authenticate) sectie van de de bestemmingsdocumentatiepagina van de Opslag van de Wolk van Google.
...
>[!TIP]
>
>Voor informatie over hoe te om de vereiste authentificatiegeloofsbrieven te verkrijgen, zie [&#x200B; voor authentiek verklaren aan bestemmings &#x200B;](/help/destinations/catalog/cloud-storage/sftp.md#authentication-information) sectie van de pagina van de de bestemmingsdocumentatie van SFTP.
...
### Codering toevoegen aan geëxporteerde bestanden {#add-encryption}

U kunt desgewenst versleuteling toevoegen aan uw geëxporteerde bestanden. Hiervoor moet u items toevoegen uit het `encryption` -object. Zie het onderstaande voorbeeld met de verplichte parameters:
...
Zie de `targetSpec` -eigenschappen in de `connection spec` -doelmap voor meer informatie over de ondersteunde eigenschappen voor elk doeltype. Verwijs in de onderstaande tabbladen naar de eigenschappen `targetSpec` van alle ondersteunde doelen.
...
>[!TIP]
>
>Voor informatie over hoe te om de vereiste doelparameters te verkrijgen, zie [&#x200B; invullen bestemmingsdetails &#x200B;](/help/destinations/catalog/cloud-storage/amazon-s3.md#destination-details) sectie van de [!DNL Amazon S3] pagina van de bestemmingsdocumentatie.
...
+++[!DNL Amazon S3] - Verbindingsverzoek als doel instellen met CSV-opties

>[!TIP]
>
>Voor uitgebreide informatie over de beschikbare opties CSV voor dossieruitvoer, zie de [&#x200B; dossier het formatteren configuratiepagina &#x200B;](/help/destinations/ui/batch-destinations-file-formatting-options.md).
...
>[!TIP]
>
>Voor informatie over hoe te om de vereiste doelparameters te verkrijgen, zie [&#x200B; invullen bestemmingsdetails &#x200B;](/help/destinations/catalog/cloud-storage/azure-blob.md#destination-details) sectie van de [!DNL Azure Blob Storage] pagina van de bestemmingsdocumentatie.
...
+++[!DNL Azure Blob Storage] - Verbindingsverzoek als doel instellen met CSV-opties
...
>[!TIP]
>
>Voor informatie over hoe te om de vereiste doelparameters te verkrijgen, zie [&#x200B; invullen bestemmingsdetails &#x200B;](/help/destinations/catalog/cloud-storage/adls-gen2.md#destination-details) sectie van de de bestemmings documentatiepagina van Azure [!DNL Data Lake Gen 2(ADLS Gen2)].
...
+++[!DNL Azure Data Lake Gen 2(ADLS Gen2)] - Verbindingsverzoek als doel instellen met CSV-opties
...
>[!TIP]
>
>Voor informatie over hoe te om de vereiste doelparameters te verkrijgen, zie [&#x200B; invullen bestemmingsdetails &#x200B;](/help/destinations/catalog/cloud-storage/data-landing-zone.md#destination-details) sectie van de [!DNL Data Landing Zone] pagina van de bestemmingsdocumentatie.
...
+++[!DNL Data Landing Zone] - Verbindingsverzoek als doel instellen met CSV-opties
...
>[!TIP]
>
>Voor informatie over hoe te om de vereiste doelparameters te verkrijgen, zie [&#x200B; invullen bestemmingsdetails &#x200B;](/help/destinations/catalog/cloud-storage/google-cloud-storage.md#destination-details) sectie van de [!DNL Google Cloud Storage] pagina van de bestemmingsdocumentatie.
...
+++[!DNL Google Cloud Storage] - Verbindingsverzoek als doel instellen met CSV-opties
...
>[!TIP]
>
>Voor informatie over hoe te om de vereiste doelparameters te verkrijgen, zie [&#x200B; in bestemmingsdetails &#x200B;](/help/destinations/catalog/cloud-storage/google-cloud-storage.md#destination-details) sectie van de de bestemmingsdocumentatiepagina van SFTP vullen.
...
### Soorten publiek toevoegen aan de exportbewerking {#add-audiences}
...
### Een invoerschema maken {#create-input-schema}
...
**Verzoek om identiteiten** te krijgen
...
De reactie retourneert de identiteiten die u kunt gebruiken bij het maken van het invoerschema. Merk op dat deze reactie zowel [&#x200B; standaard &#x200B;](/help/identity-service/features/namespaces.md#standard) als [&#x200B; douane &#x200B;](/help/identity-service/features/namespaces.md#create-namespaces) identiteitsnaamruimten terugkeert die u opstelling in Experience Platform.
...
Vervolgens moet u de reactie van boven kopiëren en deze gebruiken om uw invoerschema te maken. U kunt de gehele JSON-reactie van de bovenstaande reactie kopiëren en deze in het hieronder vermelde `jsonSchema` -object plaatsen.
...
### Een uitvoerschema maken {#create-output-schema}
...
In het onderstaande voorbeeld wordt `connection spec ID` voor Amazon S3 gebruikt. Vervang deze waarde door de specifieke verbindingsspecificatie-id voor uw bestemming.
...
Vervolgens moet u een uitvoerschema maken. Kopieer de JSON-reactie die u hierboven hebt geplaatst en plak deze in het onderstaande `jsonSchema` -object.
...
>[!IMPORTANT]
>
>* In het onderstaande toewijzingsobject accepteert de parameter `destination` geen punten `"."` . Bijvoorbeeld, zou u PersonalEmail_address of segmentMembership_status zoals benadrukt in het configuratievoorbeeld moeten gebruiken.
>* Er is één specifiek geval wanneer het bronattribuut een identiteitsattribuut is en een punt bevat. In dit geval moet het kenmerk worden beschermd door `//` , zoals hieronder wordt gemarkeerd.
>* Hoewel de onderstaande voorbeeldconfiguratie `Email` en `Phone_E.164` bevat, kunt u per gegevensstroom slechts één identiteitskenmerk exporteren.
...
De API-eindpunten in deze zelfstudie volgen de algemene beginselen van het Experience Platform API-foutbericht. Zie [&#x200B; API statuscodes &#x200B;](/help/landing/troubleshooting.md#api-status-codes) en [&#x200B; de fouten van de verzoekkopbal &#x200B;](/help/landing/troubleshooting.md#request-header-errors) in de het oplossen van problemengids van Experience Platform voor meer informatie bij het interpreteren van foutenreacties.

## Volgende stappen {#next-steps}

U hebt Experience Platform verbonden met een van uw voorkeursbestemmingen voor cloudopslag en een gegevensstroom ingesteld naar de respectievelijke bestemming om het publiek te exporteren. Zie de volgende pagina&#39;s voor meer informatie, zoals hoe u bestaande gegevensstromen kunt bewerken met de Flow Service API:

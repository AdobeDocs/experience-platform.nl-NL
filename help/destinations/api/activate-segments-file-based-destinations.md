...
U kunt desgewenst versleuteling toevoegen aan uw geëxporteerde bestanden. Hiervoor moet u items toevoegen vanuit de map `encryptionSpecs` . Zie het onderstaande voorbeeld met de verplichte parameters:

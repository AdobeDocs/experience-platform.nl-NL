...
Dit leerprogramma toont aan hoe te om API vraag te gebruiken om met uw [!DNL Adobe Experience Platform] gegevens te verbinden, een verbinding tot stand te brengen met een het stromen bestemming van de wolkenopslag ([&#x200B; Amazon Kinesis &#x200B;](../catalog/cloud-storage/amazon-kinesis.md) of [&#x200B; de Gebeurtenis van Azure &#x200B;](../catalog/cloud-storage/azure-event-hubs.md)), een dataflow aan uw nieuwe gecreeerde bestemming tot stand te brengen, en gegevens aan uw nieuwe gecreeerde bestemming te activeren.
...
### Toegang tot uw gegevens autoriseren in Experience Platform {#authorize-access-experience-platform}
...
### Toegang tot de streamingbestemming autoriseren {#authorize-access-streaming-destination}
...
## Een gegevensstroom maken {#create-data-flow}
...
## De gegevensstroom valideren {#validate-data-flow}

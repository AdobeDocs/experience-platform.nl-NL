...
Als u liever de gebruikersinterface in Adobe gebruikt om verbinding te maken met een doel in realtime en gegevens te activeren, raadpleegt u de zelfstudies voor [Connect een doel](../ui/connect-destination.md) en [Activate profielen en segmenten aan een doel](../ui/activate-destinations.md) .
...
De volgende secties verstrekken extra informatie die u zult moeten weten om gegevens aan het stromen bestemmingen in Echt - tijd CDP te activeren.
...
* `{REGION}`: *Voor [!DNL Amazon Kinesis] verbindingen.* Het gebied in uw [!DNL Amazon Kinesis] rekening waar CDP in real time uw gegevens zal stromen.
...
* `{EVENT_HUB_NAMESPACE}`: *Voor [!DNL Azure Event Hubs] verbindingen.* Vul de [!DNL Azure Event Hubs] naamruimte in waarin CDP-gegevens in real-time worden gestreamd. Zie [Een naamruimte](https://docs.microsoft.com/en-us/azure/event-hubs/event-hubs-create#create-an-event-hubs-namespace) voor gebeurtenishubs maken in de [!DNL Microsoft] documentatie voor meer informatie.
...
* `{NAME_OF_DATA_STREAM}`: *Voor [!DNL Amazon Kinesis] verbindingen.* Geef de naam op van de bestaande gegevensstroom in uw [!DNL Amazon Kinesis] account. CDP in realtime exporteert gegevens naar deze stream.
* `{REGION}`: *Voor [!DNL Amazon Kinesis] verbindingen.* Het gebied in uw Amazon Kinesis-account waar CDP-gegevens in real-time worden gestreamd.
* `{EVENT_HUB_NAME}`: *Voor [!DNL Azure Event Hubs] verbindingen.* Vul de [!DNL Azure Event Hub] naam in waar CDP in real time uw gegevens zal stromen. Zie [Een gebeurtenishub](https://docs.microsoft.com/en-us/azure/event-hubs/event-hubs-create#create-an-event-hub) maken in de [!DNL Microsoft] documentatie voor meer informatie.
...
>[!IMPORTANT]
>
> Naast de profielkenmerken en de segmenten in de stap Gegevens [activeren naar uw nieuwe bestemming](#activate-data), bevatten de geëxporteerde gegevens in [!DNL AWS Kinesis] en [!DNL Azure Event Hubs] ook informatie over het identiteitskaart. Dit geeft de identiteiten van de geëxporteerde profielen aan (bijvoorbeeld [ECID](https://experienceleague.adobe.com/docs/id-service/using/intro/id-request.html), mobiele id, Google-id, e-mailadres, enz.). Zie een voorbeeld hieronder.
...
Voor deze specifieke zelfstudie zijn de volgende [!DNL Postman] verzamelingen toegevoegd:
...
* [De bijgevoegde verzamelingen downloaden](../assets/api/streaming-destination/DestinationPostmanCollection.zip) en decomprimeren;

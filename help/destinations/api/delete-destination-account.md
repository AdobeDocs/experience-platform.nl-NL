...
De volgende secties bevatten aanvullende informatie waarvan u moet weten dat u een doelaccount met de [!DNL Flow Service] API kunt verwijderen.
...
De API-eindpunten in deze zelfstudie volgen de algemene beginselen van het Experience Platform API-foutbericht. Zie [ API statuscodes ](../../landing/troubleshooting.md#api-status-codes) en [ de fouten van de verzoekkopbal ](../../landing/troubleshooting.md#request-header-errors) in de het oplossen van problemengids van Experience Platform.

## Volgende stappen {#next-steps}

U hebt de API van [!DNL Flow Service] gebruikt om bestaande doelaccounts te verwijderen. Voor meer informatie bij het gebruiken van bestemmingen, zie het [ overzicht van bestemmingen ](/help/destinations/home.md).
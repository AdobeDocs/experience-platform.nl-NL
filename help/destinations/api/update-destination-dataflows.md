...
Voor deze zelfstudie moet u ook goed begrijpen wat de volgende componenten van [!DNL Adobe Experience Platform] zijn:

* [ Doelen ](../home.md): [!DNL Destinations] zijn pre-gebouwde integratie met bestemmingsplatforms die voor de naadloze activering van gegevens van [!DNL Adobe Experience Platform] toestaan. U kunt bestemmingen gebruiken om uw bekende en onbekende gegevens te activeren voor cross-channel marketingcampagnes, e-mailcampagnes, gerichte advertenties en vele andere gebruiksscenario&#39;s.
* [ Sandboxes ](../../sandboxes/home.md): Experience Platform verstrekt virtuele zandbakken die één enkele instantie van Experience Platform in afzonderlijke virtuele milieu&#39;s verdelen helpen digitale ervaringstoepassingen ontwikkelen en ontwikkelen.

In de volgende secties vindt u aanvullende informatie die u nodig hebt om de gegevensstroom met de API [!DNL Flow Service] bij te werken.
...
>[!IMPORTANT]
>
>**bestemming-specifieke kaartvereisten**
>
>De methode `profileSelectors` die in deze sectie wordt beschreven, werkt voor de meeste streamingdoelen. Voor sommige streamingdoelen, waaronder **[!DNL Adobe Target]** , is echter de workflow voor de gegevensvoorvertoningenset vereist.
>
>**als uw profielattributen niet in Experience Platform UI na een succesvolle API reactie (202)** verschijnen, moet u de kaartsetmethode gebruiken die in [ wordt gedocumenteerd actief publiek aan partijbestemmingen ](../api/activate-segments-file-based-destinations.md#attribute-and-identity-mapping).
...
U hebt geleerd hoe u verschillende componenten van een doelgegevensstroom kunt bijwerken, zoals het toevoegen of verwijderen van soorten publiek of profielkenmerken met de API [!DNL Flow Service] . Voor meer informatie over bestemmingen, zie het [ overzicht van bestemmingen ](../home.md).

...
Het volgende verzoek werkt de parameters van een [[!DNL Azure Blob]  bestemming &#x200B;](/help/destinations/catalog/cloud-storage/azure-blob.md#authenticate) verbinding bij om het verbindingskoord bij te werken dat wordt vereist om met een instantie van Azure Blob te verbinden.
...
U hebt geleerd hoe u verschillende componenten van een doelverbinding kunt bijwerken met de [!DNL Flow Service] API. Voor meer informatie over bestemmingen, zie het [&#x200B; overzicht van bestemmingen &#x200B;](../home.md).

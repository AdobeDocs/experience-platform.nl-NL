...
De volgende secties bevatten aanvullende informatie waarvan u moet weten dat u een gegevensstroom met de API [!DNL Flow Service] kunt verwijderen.
...
U hebt de [!DNL Flow Service] API gebruikt om een bestaande gegevensstroom naar een doel te verwijderen.

Voor stappen op hoe te om deze verrichtingen uit te voeren gebruikend het gebruikersinterface, verwijs naar het leerprogramma op [&#x200B; het schrappen van dataflows in UI &#x200B;](../ui/delete-destinations.md).

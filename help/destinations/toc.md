...
* UI-hulplijnen {#ui}
   ...
   * [Doelen bewerken](./ui/edit-destination.md)
...
* Doelcatalogus {#catalog}
   ...
   * Adobe-bestemmingen{#adobe}
      ...
      * [&#x200B; het publiek dat van Experience Platform  deelt](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html)
   ...
   * Advertising-bestemmingen{#advertising}
      ...
      * [Verouderde DSP-verbinding voor Adobe Advertising Cloud](./catalog/advertising/adobe-advertising-cloud-dsp-connection-legacy.md)
      ...
      * [(Verouderd) Amazon Ads-verbinding](./catalog/advertising/amazon-ads.md)
      * [Amazon Ads v2-verbinding](./catalog/advertising/amazon-ads-v2.md)
      ...
      * [Kevel-verbinding](./catalog/advertising/kevel.md)
      ...
      * [(Beta) Aangepaste Audience-verbinding bewerken](./catalog/advertising/reddit-custom-audience.md)
   ...
   * Opslagdoelen voor cloud {#cloud-storage}
      ...
      * [Verbinding met Azure Event Hubs](./catalog/cloud-storage/azure-event-hubs.md)
...
* Destination SDK {#destination-sdk}
   ...
   * Handleidingen {#guides}
      ...
      * Bestandsgebaseerde doelen configureren {#configure-file-based-destinations}
         ...
         * [Een Azure Data Lake Storage-bestemming configureren met aangepaste opties voor bestandsindeling en aangepaste configuratie van bestandsnaam](../destinations/destination-sdk/guides/batch/configure-adls-destination-with-custom-file-formatting.md)

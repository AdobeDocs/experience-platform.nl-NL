...
title: Dataflows voor doelen in de UI controleren
type: Tutorial
...
- **[!UICONTROL Identities failed]**: Het totale aantal profielidentiteiten dat niet aan de bestemming wegens fouten wordt geactiveerd.
  ...
  >[!IMPORTANT]
  >
  > Vanaf maart 2025 voert Adobe een update uit om de rapportnauwkeurigheid voor streamingdoelen te verbeteren. Deze verbetering zorgt voor een betere afstemming tussen de rapportage in Experience Platform en de doelplatforms.
  >
...
De publiek-vlakke controle voor het stromen bestemmingen is slechts beschikbaar voor bepaalde bestemmingen. Zie de [ sectie van het 0} publieksniveau voor een lijst van gesteunde bestemmingen.](#audience-level-view)
...
>title="Ontvangen profielen"
>abstract="Het totale aantal profielen dat is ontvangen in de dataflow-run. Voor geplande exportbewerkingen bevat dit profielen uit de meest recente publieksopname plus profielen waarvan het lidmaatschap of de identiteit van het publiek is gewijzigd tussen het maken van de momentopname en de exporttijd. Hierdoor kan dit aantal hoger zijn dan het aantal profielen in het publiek."
...
## Het dashboard voor controledoelen {#monitoring-destinations-dashboard}

>[!NOTE]
>
>De controlefunctionaliteit van bestemmingen wordt momenteel gesteund voor alle bestemmingen in Experience Platform *behalve* de [ Adobe Target ](/help/destinations/catalog/personalization/adobe-target-connection.md) bestemming.
...
### Weergave op publiek niveau {#audience-level-view}
...
Wanneer u neer in de dataflow looppas pagina van de [ publiek-vlakke mening ](#audience-level-view) boor, hebt u de optie om de dataflow looppas door de volgende opties te filtreren:
...
De detailspagina heeft ook een knevel om tussen dataflow loopfouten en publiek te schakelen. Deze optie is beschikbaar voor de bestemmingen die in de [ publiek-vlakke mening ](#audience-level-view) sectie worden vermeld.

...
De Dienst van de segmentatie staat u toe om segmenten en publiek van uw gegevens van het Profiel van de Klant in real time in Adobe Experience Platform tot stand te brengen. Het platform verstrekt gegevensstromen om deze stroom van gegevens van bronnen aan bestemmingen doorzichtig te volgen.
...
- [Segmentering](../../segmentation/home.md): De segmentatie staat u toe om segmenten en publiek van uw gegevens van het Profiel van de Klant in real time tot stand te brengen.
   - [Activeringstaken](../../destinations/ui/activation-overview.md): Een activeringstaak wordt gebruikt om het segment te activeren op een opgegeven bestemming.
   ...
   - [Exporttaken](../../segmentation/api/export-jobs.md): Een exporttaak is een asynchroon proces dat wordt gebruikt om de leden van het publiekssegment aan datasets voort te zetten.
...
Als u toegang wilt krijgen tot **[!UICONTROL Segments]** dashboard, selecteren **[!UICONTROL Monitoring]** in de linkernavigatie. Eén keer op de knop **[!UICONTROL Monitoring]** pagina, selecteert u de **[!UICONTROL Segments]** kaart.
...
Het dashboard zelf bevat meetgegevens voor zowel segmenten als segmenttaken. Standaard worden in het dashboard de segmentmetriek van de laatste 24 uur weergegeven. Lees voor meer informatie over de weergave voor segmenttaken de [segmenttaken controleren](#monitoring-segment-jobs-dashboard) sectie.
...
U kunt verder filteren naar een specifieke segmenttaak en de details ervan bekijken door het filterpictogram te selecteren (![Het filterpictogram.](../assets/ui/monitor-segments/filter-icon.png)). Er zijn twee verschillende soorten segmentbanen die gefilterd kunnen worden: activeringsbanen en evaluatietaken.
...
De dataflow van de evaluatietaak detailpagina toont informatie over de metriek en de segmenten van de looppas die met de segmentbaan verwant zijn. Een evaluatietaak is een asynchroon proces dat tot een publiekssegment leidt dat op het gespecificeerde segment wordt gebaseerd. Lees de zelfstudie voor meer informatie over evaluatietaken op [evalueren van een segment](../../segmentation/tutorials/evaluate-a-segment.md#evaluate-a-segment).
...
Als u toegang wilt krijgen tot **[!UICONTROL Segment Jobs]** dashboard, selecteren **[!UICONTROL Monitoring]** (![bewakingspictogram](../assets/ui/monitor-destinations/monitoring-icon.png)) in de linkernavigatie. Eén keer op de knop [!UICONTROL Monitoring] pagina, selecteert u **[!UICONTROL Segment Jobs]**. De [!UICONTROL Monitoring] het dashboard bevat metriek en informatie over de segmentevaluatie en de uitvoerbanen.
...
![Dashboard voor segmenttaken](../assets/ui/monitor-segments/segment-jobs-dashboard.png)
...
| **[!UICONTROL Type]** | Geeft het type segmenttaak aan: exporteren of evalueren. Merk op dat in beide gevallen de segmentbaan evalueert of uitvoert **alles** segmenten die tot een organisatie behoren. Voor meer informatie over exporttaken leest u de handleiding op de [eindpunt exporttaken](../../segmentation/api/export-jobs.md). Lees de zelfstudie voor meer informatie over evaluatietaken op [evalueren van een segment](../../segmentation/tutorials/evaluate-a-segment.md#evaluate-a-segment). |
| **[!UICONTROL Job start]** | De datum en tijd waarop de segmenttaak is gestart. |

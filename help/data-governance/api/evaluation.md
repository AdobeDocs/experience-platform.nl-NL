...
>[!WARNING]
>
>Het `/constraints` eindpunt voor gegevensset-based evaluatie is verouderd. Om beleidsschending te evalueren of veelvoudige evaluatietaken uit te voeren, gebruik [&#x200B; bulkevaluatie API (`/bulk-eval`) &#x200B;](#evaluate-policies-in-bulk) in plaats daarvan.

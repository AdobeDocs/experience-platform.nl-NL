...
| **derde-partij-Verkennend** | Gegevens verzameld door een externe organisatie die niet rechtstreeks met de betrokkene verband houdt. Het label moet worden toegepast op gegevens van derden die voor de funnel-prospectie naar nieuwe klanten worden gebruikt. |

...
* **toegang tot de toepassing:** u kunt tot Medewerker AI (Verouderd) in Adobe Experience Platform, Adobe Real-Time CDP, Adobe Journey Optimizer, en [&#x200B; Customer Journey Analytics &#x200B;](https://experienceleague.adobe.com/nl/docs/analytics-platform/using/ai-assistant) toegang hebben.
...
Als u beschikt over de benodigde machtigingen, hebt u toegang tot AI Assistant (verouderd) door het pictogram AI Assistant (verouderd) te selecteren in de bovenste koptekst van de toepassing die u gebruikt.

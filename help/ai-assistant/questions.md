...
+++Selecteer deze optie om geaccepteerde variaties van de vragen over de betrouwbaarheid van gegevenssets weer te geven
...
* Welke dataset vormt aan maximumaantal profielen in deze zandbak?
* Hoeveel segmenten zijn verwijderd in {RELATIVE_DATE} ?
* Geef me een profiel in {AUDIENCE_NAME}.
* Wat is het totale aantal profielen in mijn zandbak?
...
* Hoeveel batches worden er geladen {DATASET_NAME}

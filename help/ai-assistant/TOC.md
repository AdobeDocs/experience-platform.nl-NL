...
* [Productdocumentatie van AI Assistant (verouderd)](landing.md)
* [Overzicht van AI Assistant (verouderd)](home.md)
* [Toegang tot functies](access.md)
* [Vraag voor AI Assistant (verouderd)](questions.md)
...
* [Juridische disclaimer](legal-disclaimer.md)
* Nieuwe functies {#new-features}
   * [AI Assistant-mogelijkheden (verouderd) in Alpha en Beta](./new-features/alpha-beta.md)
...
* Modeldetails {#model-details}
   ...
   * [AI Assistant (Verouderd) Natural Operational Insights Language to SQL](./model-details/natural-language-to-sql.md)

...
mboxTrace en mboxDebug zijn vervangen. Gebruiken [[!DNL Web SDK] foutopsporing](https://experienceleague.adobe.com/docs/experience-platform/edge/fundamentals/debugging.html).

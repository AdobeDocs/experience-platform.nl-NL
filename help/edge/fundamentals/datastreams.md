...
| Veld | Beschrijving |
| --- | --- |
| [!UICONTROL Sandbox] | **(Vereist)** Selecteer de sandbox met Platforms waarnaar u gegevens wilt verzenden. Sandboxen zijn virtuele partities in Adobe Experience Platform waarmee u uw gegevens en implementaties kunt isoleren van die in uw organisatie.<br><br>Als u een gegevensstroom maakt zonder een sandbox te selecteren, kunt u later nog steeds een sandbox selecteren.<br><br>Wanneer een gegevensstroom is gemaakt en een sandbox is geselecteerd, kan de sandbox niet meer worden gewijzigd. De [!UICONTROL Sandbox] selectieveld is daarom niet beschikbaar wanneer u een bestaande gegevensstroom bewerkt met een geselecteerde sandbox.<br><br> De [!UICONTROL Sandbox] selectieveld is daarom niet beschikbaar bij het bewerken van een bestaande gegevensstroom.<br><br>Zie voor meer informatie over de rol van sandboxen in Experience Platform de klasse [sandboxdocumentatie](../../sandboxes/home.md). |

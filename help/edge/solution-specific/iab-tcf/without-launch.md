---
title: IAB TCF 2.0 gebruiken zonder Lancering
...
Om IAB TCF 2.0 met Experience Platform Launch en de uitbreiding van SDK van het Web te gebruiken AEP, moet u een beschikbaar schema XDM hebben. Als u geen van deze instellingen hebt ingesteld, begint u met het bekijken van de JavaScript Quick start guide [van de](../../getting-started/quick-start-without-launch.md) Adobe Experience Platform Web SDK voordat u verdergaat.

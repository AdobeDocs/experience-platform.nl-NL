...
Adobe Audience Manager (AAM) omvat steun voor IAB TCF 2.0, die u toelaat om, klant privacykeuzen aan stroomafwaartse partners te evalueren te respecteren en door:sturen. Lees voor meer informatie de documentatie over het [verzenden van gegevens naar de Audience Manager](../audience-manager/audience-manager-overview.md).
...
Voor meer informatie over hoe te om een Gebeurtenis van de Ervaring XDM in een hit van de Analyse om te zetten, begin door de documentatie van het [Analytics- overzicht](../analytics/analytics-overview.md) te lezen.
...
Voor meer informatie over het `setConsent` bevel, lees de documentatie over de [Ondersteunende Toestemming](../../fundamentals/supporting-consent.md).

...
* Lees de documentatie over [ het elementtypes van Gegevens ](/help/tags/extensions/client/web-sdk/data-element-types.md) en [ Identiteit in de Inzameling van Gegevens ](/help/collection/identity/overview.md) voor meer informatie over hoe te om primaire identiteit op SDK van het Web te vormen.

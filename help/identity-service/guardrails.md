...
* [Identiteitsgegevens in de Experience Platform Web SDK](/help/collection/use-cases/identity/id-overview.md)
...
In dit voorbeeld, wordt ECID :32110 opgenomen en met een grote grafiek bij `timestamp=51` verbonden, daardoor overschrijdend de grens van 50 identiteiten.

![](./images/guardrails/before-split.png)

>[!TAB  proces van de Schrapping ]

Dientengevolge, schrapt de Dienst van de Identiteit de oudste identiteit die op timestamp en identiteitstype wordt gebaseerd. In dit geval, wordt ECID :35577 geschrapt slechts uit de identiteitsgrafiek.

![](./images/guardrails/during-split.png)

>[!TAB  Uitvoer van de Grafiek ]

Als resultaat van het schrappen van ECID :35577, worden de randen die CRMID :60013 en CRMID :25212 met nu geschrapte ECID :35577 verbonden ook geschrapt. Door dit verwijderingsproces wordt de grafiek opgesplitst in twee kleinere grafieken.
...
Dientengevolge, schrapt de Dienst van de Identiteit de oudste identiteit slechts van de identiteitsgrafiek, die in dit geval ECID :35577 is. De schrapping van ECID :35577 resulteert ook in de schrapping van het volgende:

* Het verband tussen CRMID: 60013 en nu-geschrapte ECID :35577, zo resulterend in een grafiek gespleten scenario.

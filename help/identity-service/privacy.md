...
Bij het maken van taakaanvragen in de API moeten alle id&#39;s in gebruikers-id&#39;s een specifieke naamruimte en een specifiek type gebruiken. Een geldige naamruimte die door Identity Service wordt herkend, moet worden opgegeven voor de naamruimtewaarde. Gebruik `standard` voor standaardnaamruimten en gebruik `custom` voor aangepaste naamruimten.

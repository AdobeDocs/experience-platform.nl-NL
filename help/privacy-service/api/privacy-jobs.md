...
U kunt informatie over een specifieke baan, zoals zijn huidige verwerkingsstatus terugwinnen, door die baan `jobId` in de weg van een verzoek van de GET aan het `/jobs` eindpunt te omvatten.

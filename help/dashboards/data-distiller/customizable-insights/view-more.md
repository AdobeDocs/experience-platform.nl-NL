...
Zodra u a [ douaneinzicht ](./overview.md) met [ vraag pro wijze ](./query-pro-mode.md) hebt gecreeerd, kunt u uw grafiekgegevens in verschillende formaten bekijken. U kunt een tabelvorm van de resultaten weergeven of de gegevens downloaden als een CSV-bestand om te bekijken in een spreadsheet.
...
![ dialoog van A die een voorproef van uw inzicht en in tabelvorm resultaten van uw SQL toont die het inzicht produceerde.](../../images/customizable-insights/view-more-download-csv.png)

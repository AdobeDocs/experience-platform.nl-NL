...
Via het dashboard **[!UICONTROL License usage]** kunt u belangrijke informatie over het gebruik van de licentie van uw organisatie weergeven. Het dashboard is beschikbaar voor in aanmerking komende Experience Cloud-organisaties, waaronder organisaties die een licentie voor Adobe Experience Platform hebben en organisaties die dat niet doen. De weergegeven informatie wordt vastgelegd tijdens een dagelijkse momentopname van de omgeving van uw organisatie en wordt niet in real-time bijgewerkt.

De gebruiksrapporten van de vergunning verstrekken een hoge graad van granulariteit. De meeste metriek worden gedeeld over veelvoudige producten en wijzen op bijeengevoegd gebruik over alle producten die hen, niet per-producttotalen gebruiken.
...
Voor organisaties zonder een Adobe Experience Platform-toepassing (zoals Real-time Customer Data Platform, Adobe Journey Optimizer, Customer Journey Analytics enzovoort) geeft het dashboard alleen statistieken voor het gebruik van AI-kredieten weer.
...
>[!NOTE]
>
>Het dashboard voor licentiegebruik is niet standaard ingeschakeld. U moet **worden verleend&quot;[!UICONTROL View License Usage Dashboard] &quot;** toestemming om tot het toegang te hebben.
>
>Als uw organisatie Adobe Experience Platform-toepassingen in licentie geeft, geeft u deze toestemming in het toepasselijke productprofiel en de toepasselijke sandbox.
>
>Voor organisaties zonder een Adobe Experience Platform-toepassing (bijvoorbeeld organisaties met alleen AEM of alleen Workflow) is deze machtiging beschikbaar in de Adobe Admin Console onder de Adobe Experience Platform-productkaart (als deze is ingericht voor uw organisatie). Een beheerder moet de machtigingen aan een productprofiel toevoegen voordat gebruikers het dashboard kunnen weergeven.
...
De metriek die in uw dashboard verschijnen hangt van de producten en de aanspraken verbonden aan uw organisatie af. Als uw organisatie aan de [ gebruik-gebonden proef van de Agenten van Adobe Experience Platform ](https://experienceleague.adobe.com/en/docs/experience-cloud-ai/experience-cloud-ai/agents/trial) of vergunningenAdobe Experience Platform Agenten deelneemt, omvat het dashboard metrisch [!UICONTROL AI credits]. Als uw organisatie geen Adobe Experience Platform-licentie geeft, wordt het AI-kredietgebruik weergegeven als primaire maatstaf.

| Metrisch | Beschrijving |
|---|---|
| [!UICONTROL AI credits] | Het aantal AI-credits dat uw organisatie gebruikt bij het gebruik van Adobe Experience Platform Agents. AI-credits worden gebruikt tijdens de gebruiksgebonden proefversie van Adobe Experience Platform Agents en bij een licentie voor gebruik door agenten. Met deze maatstaf kunt u het AI-kredietverbruik controleren op basis van uw beschikbare machtiging. |
...
| <ul><li>RT KLANTENGEGEVENSPLAATFORM :OD</li><li>RT KLANTGEGEVENSPLATFORM VAN KLANT :OD PRFL AAN 10M</li><li>RT KLANTGEGEVENSPLATFORM VAN KLANT :OD PRFL AAN 50M</li></ul> | [ Adobe Real-Time Customer Data Platform ](https://helpx.adobe.com/legal/product-descriptions/real-time-customer-data-platform.html) |
| <ul><li>AEP :OD ACTIVATION</li><li>AEP:OD ACTIVERING PRFL NAAR 10M</li><li>AEP :OD ACTIVERING PRFL TOT 50M</li></ul> | [ de Activering van Adobe Experience Platform ](https://helpx.adobe.com/legal/product-descriptions/adobe-experience-platform0.html) |

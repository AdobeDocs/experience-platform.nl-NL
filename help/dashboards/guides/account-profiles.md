...
Selecteer in de resultaten op het tabblad [!UICONTROL Profile ID] de optie [!UICONTROL Browse] om het tabblad [!UICONTROL Details] voor het accountprofiel te openen.

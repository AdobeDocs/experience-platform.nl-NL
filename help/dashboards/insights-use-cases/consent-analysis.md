...
- Selecteer het pictogram `...` (ellipsen) in het [!UICONTROL Y-axis] veld en selecteer vervolgens de [!UICONTROL SUM] functie voor aggregatie in het vervolgkeuzemenu.
  ![ De widget composer stuurt de tendensen widget met het gegevensmodel, de lijst, en de y-as dropdown menu en de benadrukte eigenschap van SUM.](../images/insights-use-cases/consent-analysis/y-axis-sum-function.png)

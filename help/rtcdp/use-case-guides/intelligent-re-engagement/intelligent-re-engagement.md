...
Deze reis is gericht op producten die in de kar zijn geplaatst maar niet op zowel de website als de app zijn gekocht. Gebruikt voor het starten en stoppen van campagnes voor betaalde media
...
Deze reis richt productaankopen op zowel de website als de app.
...
### Een schemaontwerp en veldgroepen instellen

Er zijn vier schemaontwerpen die voor de intelligente herbetrokkenheidsreizen worden gebruikt. Voor elk schema moeten specifieke velden worden ingesteld, evenals enkele velden die sterk worden aanbevolen.

>[!BEGINTABS]

>[!TAB Klantkenmerken (profielschema)]

De veldgroepen die vereist zijn voor het profielschema zijn:
...
![Een opname van het schema met klantkenmerken met een lijst met veldgroepen.](../intelligent-re-engagement/images/customer-attributes.gif)

>[!TAB Digitale transacties van klanten]

De veldgroepen die vereist zijn voor Experience Event-schema voor online activiteit (niet Adobe Analytics Connector) zijn:
...
![Een opname van het schema voor digitale transacties van de klant die een lijst van gebiedsgroepen toont.](../intelligent-re-engagement/images/customer-digital-transactions.gif)

>[!TAB Offline transacties van de klant]

De veldgroepen die vereist zijn voor Experience Event-schema voor offline activiteit zijn:
...
![Een opname van het systeem van de klantenoff-line transacties die een lijst van gebiedsgroepen tonen.](../intelligent-re-engagement/images/customer-offline-transactions.gif)

>[!TAB Adobe-verbindingsschema]
...
![Een opname van het schema van de Verbinding van het Web van Adobe dat een lijst van gebiedsgroepen toont.](../intelligent-re-engagement/images/adobe-web-connector.png)
...
De volgende gebeurtenissen worden gebruikt voor de reis van de nieuwe service, waarbij profielen producten online bekeken en in de komende 24 uur niet aan het winkelwagentje toegevoegd hebben, gevolgd door geen merkbetrokkenheid in de drie dagen daarna.

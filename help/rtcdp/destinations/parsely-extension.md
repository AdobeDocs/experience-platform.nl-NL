...
# Parse.ly Analytics-extensie {#parsely-analytics-extension}

## Overzicht {#overview}

Parse.ly Analytics helpt meer dan 2500 bedrijven gegevens te gebruiken om hun online publiek te begrijpen. Met deze extensie installeert u een JavaScript-fragment dat bijhoudt hoe bezoekers de inhoud van uw site beïnvloeden.
...
U installeert als volgt de extensie Parse.ly:

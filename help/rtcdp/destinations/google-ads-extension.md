...
Deze extensie volgt conversies van gebruikers die op Google Ads klikken. U moet ook de extensie gtag.js installeren en deze toevoegen aan uw bibliotheek, omdat Google Ads hiervan afhankelijk is.

Google Ads is een advertentie-extensie in Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html)voor meer informatie over de extensiefunctionaliteit.
...
U installeert als volgt de Google Ads-extensie:

...
description: De extensie Bing Ads Universal Event Tracking (UET) is een advertentiedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# De extensie Bing Ads Universal Event Tracking (UET) {#bing-ads-extension}

## Overzicht {#overview}

Bing Adds Universal Event Tracking (UET) for Experience Platform Launch is een handige manier om te volgen wat er gebeurt nadat iemand op uw zoekadvertentie heeft geklikt. Door één UET-tag te gebruiken om op te nemen wat klanten op uw website doen, kunt u deze gegevens benutten, zodat u conversies of doelgroepen kunt bijhouden met behulp van remarketing lijsten.

Bing Ads Universal Event Tracking (UET) is een advertentie-extensie in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100154.html)voor meer informatie over de extensiefunctionaliteit.
...
U installeert de extensie Bing Ads Universal Event Tracking (UET) als volgt:

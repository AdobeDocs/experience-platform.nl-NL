...
description: De Inbox van de Bespreking URL uitbreiding is een stem van de klantenbestemming in het Platform van de Gegevens van de Klant van Adobe in real time. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De Inbox van de Bespreking URL uitbreiding is een stem van de klantenbestemming in het Platform van de Gegevens van de Klant van Adobe in real time. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# Inbox-extensie URL doorhalen {#talk-url-extension}
...
Inbox van de Bespreking URL is een stem van de klantenuitbreiding in het Platform van de Gegevens van de Klant van Adobe in real time. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html)voor meer informatie over de extensiefunctionaliteit.
...
U installeert als volgt de Inbox-extensie Talk URL:
...
Raadpleeg de pagina [Talk URL Inbox op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html)voor informatie over de configuratieopties voor extensies en installatieondersteuning.

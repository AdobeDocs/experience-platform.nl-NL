...
Implementeer Medallia snel en naadloos op uw wegeigenschappen. Met de extensie kunt u ook enquêtegebeurtenissen detecteren, feedback van klanten in real-time vastleggen via gegevenselementen en deze gebruiken in regels om de ervaring van uw klant aan te passen en gegevens te delen met Adobe Analytics.

Medallia is een stem van de klantenuitbreiding in het Platform van de Gegevens van de Klant van Adobe In real time. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103279.medallia-for-adobe-launch.html)voor meer informatie over de extensiefunctionaliteit.
...
De extensie Medallia installeren:

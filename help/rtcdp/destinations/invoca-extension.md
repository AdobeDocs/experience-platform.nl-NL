...
[!DNL Invoca Tags] is een stem van de klantenuitbreiding in het Platform van de Gegevens van de Klant van Adobe in real time. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op de Uitwisseling van [Adobe](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html).
...
![Invoc-extensie](assets/invoca-extension.png)

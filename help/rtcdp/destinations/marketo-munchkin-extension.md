...
description: De extensie Marketo Munchkin is een personalisatiebestemming in het Adobe Real-time klantgegevensplatform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie Marketo Munchkin is een personalisatiebestemming in het Adobe Real-time klantgegevensplatform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# Marketo Munchkin-extensie {#marketo-munchkin-extension}

## Overzicht {#overview}

Van beheer van leads tot marketing op basis van account vereenvoudigt het Marketo Engagement Platform hoe u de betrokkenheid bij klanten en vooruitzichten in elke fase van hun ervaring plant, ordent en meet.

Marketo&#39;s Munchkin JavaScript maakt het mogelijk bezoeken van eindgebruikerspagina&#39;s bij te houden en op uw Marketo-landingspagina&#39;s en externe webpagina&#39;s te klikken.

Marketo Munchkin is een e-mailextensie in het Adobe Real-time platform voor klantgegevens. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html)voor meer informatie over de extensiefunctionaliteit.
...
![Marketo Munchkin-extensie](assets/marketo-munchkin-extension.png)
...
De extensie Marketo Munchkin installeren:
...
Raadpleeg de pagina [Marketo Munchkin op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html)voor informatie over de configuratieopties voor extensies en installatieondersteuning.

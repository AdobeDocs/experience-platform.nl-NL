...
description: De extensie D&B Visitor Intelligence is een verpersoonlijkingsdoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie D&B Visitor Intelligence is een verpersoonlijkingsdoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
[!DNL D&B Visitor Intelligence] is een personalisatie-uitbreiding in het Platform van de Gegevens van de Klant van Adobe In real time. Raadpleeg de [D&amp;B-website](https://www.dnb.com/)voor meer informatie over de extensiefunctionaliteit.

---
title: Publiek Manager DIL-extensie
seo-title: Publiek Manager DIL-extensie
description: De DIL-extensie Audience Manager is een DMP-doel (Data Management Platform) in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De DIL-extensie Audience Manager is een DMP-doel (Data Management Platform) in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# Publiek Manager DIL-extensie {#aam-dil-extension}

## Overzicht {#overview}

Dit is de extensie Adobe Audience Manager Data Integration Library (client-side implementatie). Opmerking: Deze extensie is niet bedoeld voor het doorsturen aan de serverzijde (SSF) van Adobe Analytics-gegevens. Gebruik voor SSF de extensie Adobe Analytics. Belangrijk: Vanaf versie 8.0 is DIL sterk afhankelijk van de Experience Cloud ID Service, versie 3.3 of hoger. Implementeer zowel Experience Cloud ID Service als DIL voor de volledige mogelijkheden voor gegevensintegratie van Audience Manager.

Publiek Manager DIL is een uitbreiding van het Platform van het Beheer van Gegevens (DMP) in het Platform van de Gegevens van de Klant van Adobe In real time. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de de uitbreidingspagina [van de Manager van de](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/adobe-audience-manager-extension.html) Audience in de documentatie van de Lancering van het Platform van de Ervaring.
...
![Publiek Manager DIL-extensie](/help/rtcdp/destinations/assets/aam-dil-extension.png)
...
U installeert als volgt de DIL-extensie Audience Manager:
...
Voor informatie over de opties van de uitbreidingsconfiguratie, zie de de uitbreidingspagina [van de Manager van de](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/adobe-audience-manager-extension.html) Publiek in de documentatie van de Lancering van de Ervaring.

...
description: De extensie Tekstconversie bijhouden is een analysedoel in het Adobe Real-time Klantgegevensplatform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie Tekstconversie bijhouden is een analysedoel in het Adobe Real-time Klantgegevensplatform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# Extensie tekstconversie bijhouden {#yext-extension}

## Overzicht {#overview}

Met de extensie Tekstconversie bijhouden kunt u conversies meten die aan uw gebruik van Text-producten kunnen worden toegeschreven.

Yext Conversion Tracking is een analytische extensie in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html)voor meer informatie over de extensiefunctionaliteit.
...
U installeert als volgt de extensie Tekstomzetting:
...
Raadpleeg de pagina [Yext Conversion Tracking op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html)voor informatie over de configuratieopties voor extensies en de installatieondersteuning.

...
description: De SessionCam-extensie is een analysedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De SessionCam-extensie is een analysedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# SessionCam-extensie {#sessioncam-extension}

## Overzicht {#overview}

SessionCam verstrekt een essentiële reeks hulpmiddelen die gebruikersgedrag openbaren en u de belangrijkste problemen tonen om te bevestigen.

SessionCam is een uitbreiding voor analysemogelijkheden in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100517.html)voor meer informatie over de extensiefunctionaliteit.
...
Om de uitbreiding te installeren SessionCam:

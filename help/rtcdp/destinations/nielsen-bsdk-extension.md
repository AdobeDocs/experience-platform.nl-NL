...
description: THe Nielsen BSDK-extensie is een analysedoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie Nielsen BSDK is een analysedoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
[!DNL Nielsen BSDK] is een uitbreiding voor analysemogelijkheden in Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.html)voor meer informatie over de extensiefunctionaliteit.
...
De [!DNL Nielsen BSDK] extensie installeren:
...
Raadpleeg de pagina [Nielsen BSDK op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.html)voor informatie over de configuratieopties voor extensies en installatieondersteuning.

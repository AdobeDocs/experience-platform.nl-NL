...
description: De Nielsen BSDK-extensie is een analysedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie Nielsen BSDK is een analysedoel in het Adobe Real-time klantgegevensplatform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
Nielsen BSDK is een uitbreiding voor analysemogelijkheden in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.html)voor meer informatie over de extensiefunctionaliteit.
...
U installeert als volgt de extensie Nielsen BSDK:

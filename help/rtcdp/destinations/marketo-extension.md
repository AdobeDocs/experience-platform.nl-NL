...
description: De extensie Marketo is een e-mailbestemming in Real-time Customer Data Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op de Uitwisseling van Adobe.
seo-description: De extensie Marketo is een e-mailbestemming in Real-time Customer Data Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de uitbreidingspagina op de Uitwisseling van Adobe.
...
[!DNL Marketo's] krachtige software voor marketingautomatisering helpt marketers de kunst en wetenschap van digitale marketing te master om klanten en vooruitzichten aan te trekken.

[!DNL Marketo] is een e-mailextensie in Real-time Customer Data Platform. Voor meer informatie over de uitbreidingsfunctionaliteit, zie de [uitbreidingspagina op de Uitwisseling](https://exchange.adobe.com/experiencecloud.details.101071.marketo-for-adobe-launch.html)van Adobe.
...
![Marketo-extensie](assets/marketo-extension.png)
...
De [!DNL Marketo] extensie installeren:
...
Voor informatie over de opties van de uitbreidingsconfiguratie en installatiesteun, zie de pagina van de [Marketo op de Uitwisseling](https://exchange.adobe.com/experiencecloud.details.101071.marketo-for-adobe-launch.html)van de Adobe.

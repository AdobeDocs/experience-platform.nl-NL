...
description: De extensie Marketo is een e-maildoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie Marketo is een e-maildoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
[!DNL Marketo] is een e-mailextensie in Adobe Real-time Customer Data Platform. Zie de [extensiepagina op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101071.marketo-for-adobe-launch.html)voor meer informatie over de extensiefunctionaliteit.

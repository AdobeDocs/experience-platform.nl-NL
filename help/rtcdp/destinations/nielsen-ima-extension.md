...
description: THe Nielsen IMA Handler extension is an analytics destination in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De Nielsen IMA Handler-extensie is een analysedoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
[!DNL Nielsen IMA Handler] is een uitbreiding voor analysemogelijkheden in Adobe Real-time Customer Data Platform.

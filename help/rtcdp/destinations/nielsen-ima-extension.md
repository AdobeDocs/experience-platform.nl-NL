...
seo-description: De Nielsen IMA Handler-extensie is een analysedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
Nielsen IMA Handler is een uitbreiding voor analysemogelijkheden in het Adobe Real-time Customer Data Platform.
...
U installeert als volgt de extensie Nielsen IMA Handler:

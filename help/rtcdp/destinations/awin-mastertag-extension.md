...
description: De Awin Advertiser Mastertag-extensie is een advertentie-bestemming in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# Awin Advertiser Mastertag-extensie {#awin-mastertag-extension}

## Overzicht {#overview}

De MasterTag is een JavaScript-bibliotheek met alle functies die vereist zijn voor de Awin-trackingsoplossing en moet onvoorwaardelijk worden toegevoegd aan elke pagina op de site, inclusief de bevestigingspagina, maar exclusief pagina&#39;s die betalingsgegevens weergeven of verwerken.

Awin Advertiser Mastertag is een advertentie-extensie in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103176.awin-advertiser-mastertag.html)voor meer informatie over de extensiefunctionaliteit.
...
De extensie Awin Advertiser Mastertag installeren:
...
Raadpleeg de pagina [Awin Advertiser Mastertag op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103176.awin-advertiser-mastertag.html)voor informatie over de configuratieopties voor extensies en de installatieondersteuning.

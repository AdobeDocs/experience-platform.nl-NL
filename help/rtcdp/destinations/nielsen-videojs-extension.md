...
Nielsen Digital SDK-startextensie biedt publieksmeting via de volgende digitale meetproducten:
...
Nielsen VideoJS Player Handler is een uitbreiding voor analysemogelijkheden in Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html)voor meer informatie over de extensiefunctionaliteit.
...
U installeert als volgt de extensie Nielsen VideoJS Player Handler:

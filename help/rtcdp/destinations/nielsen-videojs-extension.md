...
description: THe Nielsen VideoJS Player Handler extension is an analytics destination in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De Nielsen VideoJS Player Handler-extensie is een analysedoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
[!DNL Nielsen VideoJS Player Handler] is een uitbreiding voor analysemogelijkheden in Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html)voor meer informatie over de extensiefunctionaliteit.
...
Raadpleeg de pagina [Nielsen Digital SDK op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html)voor informatie over de configuratieopties voor extensies en installatieondersteuning.

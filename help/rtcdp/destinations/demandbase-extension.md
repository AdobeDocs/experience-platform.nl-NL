...
description: De extensie Demandbase is een analysedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie Demandbase is een analysedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# Demandbase-extensie {#demandbase-extension}

## Overzicht {#overview}

Download de Demandbase B2B-accountinzichten rechtstreeks naar Adobe Analytics, waar u het verkeer en het gedrag kunt segmenteren op basis van Industry, Revenue en uw doelaccounts. Deze op account gebaseerde weergave biedt unieke inzichten in betrokkenheid, conversie en de bron voor uw meest waardevolle bezoekers.

Demandbase is een uitbreiding voor analysemogelijkheden in Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101605.html)voor meer informatie over de extensiefunctionaliteit.
...
U installeert als volgt de extensie Demandbase:
...
Voor informatie over de opties van de uitbreidingsconfiguratie, zie de pagina [van de](https://exchange.adobe.com/experiencecloud.details.101605.html) Vereiste uitbreiding op de Uitwisseling van Adobe.

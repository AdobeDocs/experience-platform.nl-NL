...
description: De Flashtalk OneTag-extensie is een advertentiedoel in het Adobe Real-time klantgegevensplatform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# OneTag-extensie knipperen {#flashtalking-extension}

## Overzicht {#overview}

Met de Flash Talk OneTag-extensie voor het starten van het Experience Platform kunt u gemakkelijk sitehandelingen toewijzen aan weergave, video en mobiele advertentie-activiteiten. Implementeer de FlashTalk OneTag met behulp van Launch op uw webeigenschappen.

OneTag met FlashTalk is een advertentie-extensie in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)voor meer informatie over de extensiefunctionaliteit.
...
U installeert als volgt de FlashTalk OneTag-extensie:
...
Zie de pagina [Flashtalk OneTag op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)voor informatie over de configuratieopties en installatieondersteuning voor extensies.

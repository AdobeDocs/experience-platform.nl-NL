...
# Experience Cloud ID Service-extensie {#adobe-ecid-extension}

## Overzicht {#overview}

Deze extensie implementeert de Experience Cloud ID Service, die bezoekers identificeert voor alle Experience Cloud-oplossingen.
...
U installeert als volgt de Extension Experience Cloud ID Service:
...
Zie de pagina [over de uitbreiding van de service voor](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html) Experience Cloud ID in de documentatie bij Starten van Experience voor meer informatie over de configuratieopties voor extensies en installatieondersteuning.

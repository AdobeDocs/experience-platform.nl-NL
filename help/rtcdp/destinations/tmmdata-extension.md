...
description: De TMMData-extensie is een analysedoel in het Adobe Real-Time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De TMMData-extensie is een analysedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# TMMData-extensie {#tmmdata-extension}

## Overzicht {#overview}

Het platform van de Stichting van TMMData voor de Wolk van de Marketing van Adobe verstrekt marketing teams van de hulpmiddelen om tot al hun kritieke gegevensbronnen toegang te hebben en te mengen - met inbegrip van interne/externe en online/off-line gegevens - voor betrouwbare, uitvoerige dwars-kanaalanalyse, met geautomatiseerde campagneopstelling en directe invoer aan Adobe en andere analytische en hulpmiddelen van BI.

TMMData is een uitbreiding voor analysemogelijkheden in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](hhttps://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html)voor meer informatie over de extensiefunctionaliteit.
...
De extensie TMMData installeren:

...
Met de extensie Websites bijhouden van Adobe kunnen adverteerders Adform Tracking Points moeiteloos op hun sites implementeren via het Launch-platform van het Experience Platform.

Adform is een analyseextensie in Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange voor meer informatie over de extensiefunctionaliteit](https://exchange.adobe.com/experiencecloud.details.103195.adform-website-tracking.html)

...
description: De extensie Adform is een analysedoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie Adform is een analysedoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
[!DNL Adform] is een uitbreiding voor analysemogelijkheden in Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange voor meer informatie over de extensiefunctionaliteit](https://exchange.adobe.com/experiencecloud.details.103195.adform-website-tracking.html)
...
Raadpleeg de pagina [Adform op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103195.adform-website-tracking.html)voor informatie over de configuratieopties voor extensies en de installatieondersteuning.

...
description: De extensie DoubleClick Floodlight (Beta) is een advertentiedoel in het Platform van klantgegevens in Adobe Real-time. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie DoubleClick Floodlight (Beta) is een advertentiedoel in het Platform van klantgegevens in Adobe Real-time. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
[!DNL DoubleClick Floodlight] (Beta) is een advertentie-extensie in Adobe Real-time Customer Data Platform. Raadpleeg de [!DNL Google] ondersteuningsdocumentatie voor [DoubleClick Floodlight](https://support.google.com/dcm/answer/2823388?hl=en)voor meer informatie over de extensiefunctionaliteit.

...
# Extensie voor digitale feedback bevestigen

## Overzicht {#overview}

Met de bevestigingsoplossing voor digitale feedback kunt u uw websiteverkeer veranderen in real-time inzichten. Met Bevestiging, kunnen onopvallende en hoogst gerichte onderzoeken worden getoond volgens uw vereisten, die bezoekers aanmoedigen om feedback te verstrekken, zoals:
...
De extensie Digitale feedback bevestigen installeren:
...
Zie de pagina Digitale feedback [bevestigen op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html)voor informatie over de configuratieopties voor extensies en de installatieondersteuning.

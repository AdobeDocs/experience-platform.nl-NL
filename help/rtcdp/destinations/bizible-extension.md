...
description: De Bizible-extensie is een e-maildoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De Bizible-extensie is een e-maildoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
Bizible is de toonaangevende B2B-attributieoplossing die u een ongekende zichtbaarheid geeft in uw gegevens, zodat u slimme beslissingen kunt nemen die de groei stimuleren.

Bizible is een e-mailextensie in Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101055.bizible-analytics.html)voor meer informatie over de extensiefunctionaliteit.
...
De extensie Bizible installeren:
...
Zie de pagina [Bizible op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101055.bizible-analytics.html)voor informatie over de configuratieopties voor extensies en de installatieondersteuning.

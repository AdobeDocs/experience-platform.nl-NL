...
description: De Adobe Media Analytics for Audio and Video-extensie is een analysedoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De Adobe Media Analytics for Video-extensie is een analysedoel in het Adobe Real-time klantgegevensplatform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
Adobe Media Analytics for Audio and Video is een invoegtoepassing voor de basisanalysemogelijkheden die clients een robuuste meting biedt voor video, audio en advertenties.

Adobe Media Analytics for Audio and Video is een uitbreiding voor analysemogelijkheden in Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100157.html)voor meer informatie over de extensiefunctionaliteit.
...
![Adobe Media Analytics voor audio- en video-extensie](/help/rtcdp/destinations/assets/adobe-analytics-extension.png)
...
U installeert als volgt de extensie Adobe Analytics for Video:
...
Raadpleeg de pagina [over Adobe Media Analytics voor audio- en video-extensie in de documentatie bij Starten van Experience voor meer informatie over de configuratieopties voor extensies](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/media-analytics-extension/overview.html) .

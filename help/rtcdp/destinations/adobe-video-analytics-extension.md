...
description: De extensie Adobe Media Analytics for Audio en Video is een analysedoel in het Platform Klantgegevens in Adobe Real-time. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie Adobe Media Analytics for Video is een analysedoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
Adobe Media Analytics for Audio and Video is een invoegtoepassing voor de basis-Analytics die clients een robuuste meting biedt voor video, audio en advertenties.

Adobe Media Analytics for Audio and Video is een uitbreiding voor analysemogelijkheden in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100157.html)voor meer informatie over de extensiefunctionaliteit.
...
Raadpleeg de pagina [met extensies](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/media-analytics-extension/overview.html) Adobe Media Analytics for Audio en Video in de [!DNL Experience Launch] documentatie voor informatie over de configuratieopties voor extensies.

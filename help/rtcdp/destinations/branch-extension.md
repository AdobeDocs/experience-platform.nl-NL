...
description: De extensie Branch is een advertentie-bestemming in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie Branch is een advertentie-bestemming in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
Branch is een advertentie-extensie in Adobe Real-time Customer Data Platform. Zie de pagina met [functies](https://branch.io/features/) op de website Branch voor meer informatie over de extensiefunctionaliteit.

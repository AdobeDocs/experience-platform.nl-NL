...
description: THe Quantum Metric-extensie is een analysedoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie Quantum Metric is een analysedoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
[!DNL Quantum Metric's] Dankzij de integratie met Adobe Launch kunt u zonder problemen [!DNL Quantum Metric's] gegevensverzamelingstag implementeren. Bovendien biedt deze extensie de mogelijkheid om Launch Data Elements vast te leggen die nuttige informatie van de [!DNL Quantum Metric] API bevatten.

[!DNL Quantum Metric] is een uitbreiding voor analysemogelijkheden in Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html)voor meer informatie over de extensiefunctionaliteit.

...
description: THe Quantum Metric-extensie is een analysedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie Quantum Metric is een analysedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# Metrische kwantumextensie {#quantum-metric-extension}

## Overzicht {#overview}

De integratie van Quantum Metric met Adobe Launch maakt de codeloze implementatie van de tag voor gegevensverzameling van Quantum Metric mogelijk. Bovendien biedt deze extensie de mogelijkheid om Launch Data Elements vast te leggen die nuttige informatie bevat van de metrische API van Quantum.

Quantum Metric is een uitbreiding voor analysemogelijkheden in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html)voor meer informatie over de extensiefunctionaliteit.
...
![Metrische kwantumextensie](assets/quantum-metric-extension.png)
...
De extensie Quantum Metric installeren:
...
Raadpleeg de pagina [Quantum Metric op Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html)voor informatie over de configuratieopties voor extensies en de installatieondersteuning.

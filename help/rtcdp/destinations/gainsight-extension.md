...
description: De extensie Gainsight is een personalisatiedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie Gainsight is een personalisatiedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# Verkenningsextensie {#gainsight-extension}

## Overzicht {#overview}

Met inzicht kunnen eigenaars van producten met de tools volledig inzicht krijgen in het gedrag van gebruikers, productacceptatie stimuleren en feedback van gebruikers verzamelen.

Gainsight is een verpersoonlijkingsuitbreiding in het Platform van de Gegevens van de Klant van Adobe In real time. Zie de extensiepagina op [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html)voor meer informatie over de extensiefunctionaliteit.
...
U installeert als volgt de extensie Gainsight:
...
Raadpleeg de pagina [Gainsight op Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html)voor informatie over de configuratieopties voor extensies en de installatieondersteuning.

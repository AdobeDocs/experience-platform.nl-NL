...
description: De DialogTech-extensie is een analysedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De DialogTech-extensie is een analysedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# DialogTech-extensie {#dialogtech-extension}

## Overzicht {#overview}

Het JavaScript-fragment DialogTech SourceTrak opnemen in Adobe Launch

DialogTech is een analytische uitbreiding in het Platform van de Gegevens van de Klant van Adobe in real time. Raadpleeg de [Dialogtech-website](https://www.dialogtech.com/)voor meer informatie over de extensiefunctionaliteit.
...
U installeert als volgt de extensie DialogTech:

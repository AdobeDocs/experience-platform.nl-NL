...
description: De extensie DialogTech is een analysedoel in het Platform van klantgegevens in Adobe Real-time. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie DialogTech is een analysedoel in het Platform van klantgegevens in Adobe Real-time. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
[!DNL DialogTech] is een uitbreiding voor analysemogelijkheden in Adobe Real-time Customer Data Platform. Raadpleeg de [Dialogtech-website](https://www.dialogtech.com/)voor meer informatie over de extensiefunctionaliteit.

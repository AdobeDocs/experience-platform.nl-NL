...
description: De extensie JW Player Analytics (BETA) is een analysedoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De extensie JW Player Analytics (BETA) is een analysedoel in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# [!DNL JW Player Analytics] (BETA)-verlenging {#jw-player-analytics-extension}

## Overzicht {#overview}

Deze extensie installeert de [!DNL JW Player] adapter om [!DNL JW Player] gebeurtenissen te verbinden met Adobe Video Analytics. Maak gebruik van de kracht van Adobe Video Analytics om meer inzicht te krijgen in de videoweergavegewoonten van uw klanten.

[!DNL JW Player Analytics] (BETA) is een uitbreiding voor analysemogelijkheden in Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html)voor meer informatie over de extensiefunctionaliteit.
...
De extensie [!DNL JW Player Analytics] (BETA) installeren:
...
Zie de extensiepagina [JW Player Analytics (BETA) in Adobe Exchange voor informatie over de configuratieopties voor extensies](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html) .

...
description: De uitbreiding JW Player Analytics (BETA) is een analysedoel in het Platform van de Gegevens van de Klant van Adobe in real time. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De uitbreiding JW Player Analytics (BETA) is een analysedoel in het Platform van de Gegevens van de Klant van Adobe in real time. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# JW Player Analytics-extensie (BETA) {#jw-player-analytics-extension}

## Overzicht {#overview}

Deze extensie installeert de JW Player-adapter om JW Player-gebeurtenissen aan te sluiten op Adobe Video Analytics. Maak gebruik van de kracht van Adobe Video Analytics om meer inzicht te krijgen in de videoweergavegewoonten van uw klanten.

JW Player Analytics (BETA) is een uitbreiding voor analysemogelijkheden in Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html)voor meer informatie over de extensiefunctionaliteit.
...
U installeert als volgt de extensie JW Player Analytics (BETA):
...
Zie de extensiepagina [](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html) JW Player Analytics (BETA) in Adobe Exchange voor informatie over de configuratieopties voor extensies.

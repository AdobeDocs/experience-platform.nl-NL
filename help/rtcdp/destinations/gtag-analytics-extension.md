...
description: De Google Global Site Tag-extensie is een analysedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
seo-description: De Google Global Site Tag-extensie is een analysedoel in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
# Google Global Site Tag-extensie {#gtag-analytics-extension}

## Overzicht {#overview}

Gegevens verzenden naar Google Analytics, Google Ads en het Google Marketing Platform via Google&#39;s Global Site Tag of gtag.js. U kunt meerdere accounts per product configureren.

Google Global Site Tag is een uitbreiding voor analysemogelijkheden in het Adobe Real-time Customer Data Platform. Zie de extensiepagina op [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html)voor meer informatie over de extensiefunctionaliteit.
...
De Google Global Site Tag-extensie installeren:

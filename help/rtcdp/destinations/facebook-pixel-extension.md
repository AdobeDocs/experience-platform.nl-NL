...
description: De Facebook Pixel-extensie is een advertentie-bestemming in Adobe Real-time Customer Data Platform. Zie de extensiepagina op Adobe Exchange voor meer informatie over de extensiefunctionaliteit.
...
[!DNL Facebook Pixel] is een advertentie-uitbreiding in het Platform van de Gegevens van de Klant van Adobe In real time. Raadpleeg de [Facebook Pixel-website](https://developers.facebook.com/docs/facebook-pixel/)voor meer informatie over de extensiefunctionaliteit.

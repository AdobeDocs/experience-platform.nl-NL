...
* **de resolutie van de Entiteit**: Verbeterde identiteitsresolutie voor B2B entiteiten, verbeterde gegevenskwaliteit, en verminderde duplicatie om nauwkeurigere segmentatie en samenvoeging toe te laten.

>[!TIP]
>
>Afhankelijk van de grootte en complexiteit van het publiek, kan het zijn dat u kleine wijzigingen ondervindt in de tijd die nodig is voor de evaluatie van het publiek en de activering van het publiek.
>
>U wordt aangemoedigd om segmentatieruntime te controleren, in het bijzonder als uw bedrijfsprocessen op de geschikte voltooiing van segmentatie en activering vertrouwen. Zo kunt u ervoor zorgen dat uw workflows probleemloos blijven verlopen en kunt u eventuele onverwachte wijzigingen proactief aanpakken.

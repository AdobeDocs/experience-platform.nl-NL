...
De Uitgave van Adobe Real-time Customer Data Platform B2B verstrekt verscheidene standaard [ klassen van het Gegevensmodel van de Ervaring (XDM) ](../../xdm/schema/composition.md#class) die details over essentiële B2B gegevensentiteiten, zoals rekeningen, kansen, campagnes, en meer vangen. Bovendien staat de Uitgave van Real-Time CDP B2B u toe om vele-aan-één verhoudingen tussen deze schema&#39;s te bepalen zodat kunnen zij aan de geavanceerde gevallen van het segmentatiegebruik deelnemen.

>[!IMPORTANT]
>
>U moet toegang tot de Uitgave van Real-Time CDP B2B hebben opdat B2B- schema&#39;s aan [ in real time het Profiel van de Klant ](../../profile/home.md) deelnemen.

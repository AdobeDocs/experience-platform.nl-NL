...
Met het Adobe Real-time Customer Data Platform kunnen merken hun gegevens van de eerste partij op verantwoordelijke wijze aanvullen met waardevolle inzichten, id&#39;s en kenmerken van een of meer vertrouwde partners.

Adobe begrijpt dat er geen standaardaanpak is en biedt naadloze interoperabiliteit met gegevens en identiteitspartners om een geïndividualiseerde en doordachte betrokkenheid in alle fasen van de levenscyclus van de klant te bevorderen. Deze mogelijkheden worden geschraagd door een vertrouwd op gegeven governance kader, dat voor genuanceerde controle toestaat op waar en hoe de partnergegevens worden gebruikt. Bijvoorbeeld, kunt u partner verstrekte inzichten voor segmentatie maar niet voor verpersoonlijking willen gebruiken.
...
>[!VIDEO](https://video.tv.adobe.com/v/3452459/?captions=dut&learn=on)
...
Deze stap wordt behandeld in de [&#x200B; eerste vereisten &#x200B;](#prerequisites-and-planning) en Adobe veronderstelt dat u de juiste contractuele overeenkomsten op zijn plaats met vertrouwde op gegevensverkopers hebt om uw eerste-partijprofielen te verhogen.

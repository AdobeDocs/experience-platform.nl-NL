...
U kunt niet alleen een publiek maken op basis van on-site betrokkenheid en marketingberichten personaliseren, u kunt ook Adobe-ondersteuning voor partner-id&#39;s gebruiken om opnieuw contact op te nemen met bezoekers die betaalmedia-bestemmingen gebruiken.
...
- [Berekende kenmerken](/help/profile/computed-attributes/overview.md)
- [Bestemmingen](/help/destinations/home.md)
- [Dataverzameling](/help/collection/home.md)
...
Leren hoe te om gegevens in Real-Time CDP het best in te voeren gebruikend Web SDK, te lezen gelieve de [ secties van het gegevensbeheer en van de de inzameling van gebeurtenisgegevens ](./onsite-personalization.md#data-management) van de onsite het gebruiksgeval van het verpersoonlijkingsgebruik.
...
>[!NOTE]
>
>Voor meer gedetailleerde informatie bij het creëren van gegevens verwerkte attributen, te lezen gelieve de [ gegevens verwerkte gids UI van attributen ](/help/profile/computed-attributes/ui.md).
...
>[!NOTE]
>
>Voor meer gedetailleerde informatie over het gebruiken van de Bouwer van het Segment, gelieve de [ gids UI van de Bouwer van het Segment ](/help/segmentation/ui/segment-builder.md) te lezen.
...
Om de gegevens verwerkte attributen toe te voegen, onder **[!UICONTROL Attributes]**, selecteer **[!UICONTROL XDM Individual Profile]**, die door **[wordt gevolgd huurder identiteitskaart van uw organisatie ](/help/xdm/api/getting-started.md#know-your-tenant-id).** , **[!UICONTROL SystemComputedAttributes]** en **[!UICONTROL PartnerID]** . Voeg nu de **[!UICONTROL Value]** van het berekende kenmerk toe aan de sectie met kenmerken van het canvas.
...
>
>Voor meer informatie bij het activeren van publiek aan een bestemming, te lezen gelieve het [ activeringsoverzicht ](/help/destinations/ui/activation-overview.md).

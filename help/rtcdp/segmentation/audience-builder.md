...
In de sectie **[!UICONTROL Populated]** wordt het aantal records weergegeven waarin het kenmerk is ingevuld in verhouding tot het totale aantal beschikbare records en het percentage accounts dat een waarde voor dit veld heeft.
...
![&#x200B; popover A die de statistieken voor een attribuut, met inbegrip van de minimum, gemiddelde, en maximumwaarden toont.](../assets/segmentation/audience-builder/statistics.png)
...
![&#x200B; het innametype voor de attributen wordt getoond.](/help/rtcdp/assets/segmentation/audience-builder/ingestion-type.png)

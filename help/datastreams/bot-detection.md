...
Met beide detectie kunt u gebeurtenissen identificeren die zijn gegenereerd door [[!DNL Web SDK]](../edge/home.md), [[!DNL Mobile SDK]](https://developer.adobe.com/client-sdks/home/) en [[!DNL Server API]](../server-api/overview.md) als gegenereerd door bekende spinnen en bots.
...
![Afbeelding van gegevensstreams-gebruikersinterface met de optie Boot Detection gemarkeerd](assets/bot-detection/bot-detection.png)

De **[!UICONTROL Bot Detection Rules]** wordt weergegeven.

![Afbeelding van gegevensstreams-gebruikersinterface met de optie Boot Detection gemarkeerd](assets/bot-detection/bot-detection-page.png)
...
![Afbeelding van de instellingen voor botdetectie worden weergegeven met de IAB-spinnen en de lijst met beide ingeschakeld.](assets/bot-detection/bot-detection-list.png)
...
1. Selecteer **[!UICONTROL Add New Rule]**.
   ...
   ![Afbeelding van het scherm Instellingen voor beide detectie met de knop Nieuwe regel toevoegen gemarkeerd.](assets/bot-detection/bot-detection-new-rule.png)

2. Typ een naam voor de regel in het dialoogvenster **[!UICONTROL Rule Name]** veld.

   ![Afbeelding van het scherm met de regelnaam van de beide detectie.](assets/bot-detection/rule-name.png)
...
3. Selecteren **[!UICONTROL Add new IP condition]** om een nieuwe op IP gebaseerde regel toe te voegen. U kunt de regel door IP adres of door IP adreswaaier bepalen.
   ...
   ![Afbeelding van het scherm met de beide detectieregel waarbij het IP-adresveld is gemarkeerd.](assets/bot-detection/ip-address-rule.png)

   ![Afbeelding van het scherm met de detectieregel van de bot en het veld IP-bereik gemarkeerd.](assets/bot-detection/ip-range-rule.png)
...
4. Als u koptekstvoorwaarden aan uw regel wilt toevoegen, selecteert u **[!UICONTROL Add header conditions group]** en selecteer vervolgens de koppen die u voor de regel wilt gebruiken.
   ...
   ![Afbeelding van het regelscherm voor botdetectie met de koptekstvoorwaarden gemarkeerd.](assets/bot-detection/header-conditions.png)

   Voeg vervolgens de voorwaarden toe die voor de geselecteerde koptekst moeten worden gebruikt.

   ![Afbeelding van het regelscherm voor botdetectie met de koptekstvoorwaarden gemarkeerd.](assets/bot-detection/header-condition-rule.png)
...
5. Nadat u de gewenste regels voor beide detectie hebt geconfigureerd, selecteert u **[!UICONTROL Save]** om de regels toe te passen op uw gegevensstroom.
   ...
   ![Afbeelding van het regelscherm voor botdetectie met de koptekstvoorwaarden gemarkeerd.](assets/bot-detection/bot-detection-save.png)
...
![Afbeelding van beide detectieregel op basis van één IP-adres.](assets/bot-detection/bot-detection-one-ip.png)
...
![Afbeelding van beide detectieregel op basis van twee IP-adressen.](assets/bot-detection/bot-detection-two-ips.png)
...
![Afbeelding van beide detectieregel op basis van IP-bereik.](assets/bot-detection/bot-detection-range.png)
...
![Afbeelding van beide detectieregel op basis van IP-adres en aanvraagheader.](assets/bot-detection/bot-detection-header-ip.png)

...
Gebruik datastream overschrijvingen om extra configuraties voor uw gegevensstreams te definiëren, die via de SDK of Mobile SDK van het Web aan de Edge Network worden doorgegeven.
...
2. Vervolgens moet u de overschrijvingen op een van de volgende manieren naar de Edge Network verzenden:
   ...
   * Door het Web SDK [&#x200B; markeringsuitbreiding &#x200B;](../tags/extensions/client/web-sdk/configure/configuration-overrides.md).
...
>[!IMPORTANT]
>
>[&#x200B; de integratie van Edge Network API &#x200B;](https://developer.adobe.com/data-collection-apis/docs/api/) steunt momenteel geen gegevensstroomoverschrijvingen.
><br>
...
De configuratieoverschrijvingen van de gegevensstroom laten u de volgende configuraties van de gegevensstroom wijzigen:
...
Zodra u de gegevensstroom hebt gecreeerd, geef de [&#x200B; dienst van Adobe Analytics &#x200B;](configure.md#analytics) uit die u hebt toegevoegd en gebruik de **[!UICONTROL Report Suite Overrides]** sectie om de gewenste gegevensstroom met voeten te treden, zoals aangetoond in het hieronder beeld.
...
* **SDK van het Web**: Zie [&#x200B; datastream configuratie met voeten treedt &#x200B;](/help/collection/js/commands/configure/edgeconfigoverrides.md) voor de voorbeelden van de de bibliotheekcode van JavaScript.

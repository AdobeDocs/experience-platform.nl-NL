...
Zie [&#x200B; Adobe Analytics met Edge Network &#x200B;](https://experienceleague.adobe.com/nl/docs/analytics/implementation/aep-edge/overview) in de de implementatiegids van de Analyse voor meer informatie uitvoeren.
...
| [!UICONTROL Offer Decisioning] | Laat [&#x200B; Offer Decisioning &#x200B;](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioning/get-started-decision/starting-offer-decisioning.html?lang=nl-NL) voor de implementaties van SDK van het Web toe. |

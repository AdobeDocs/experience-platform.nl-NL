...
title: Trefwoordtags toepassen in de API voor tags van inhoud
...
In de volgende tabel worden de benoemde entiteiten weergegeven [!DNL Content Tagging AI] heeft vastgesteld:

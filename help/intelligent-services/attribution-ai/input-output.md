...
title: Invoer en uitvoer van Attribution AI
...
# [!DNL Attribution AI] invoer en uitvoer

In het volgende document worden de verschillende invoer- en uitvoerbestanden beschreven die in worden gebruikt [!DNL Attribution AI].

## [!DNL Attribution AI] invoergegevens

[!DNL Attribution AI] gebruikt [!DNL Consumer Experience Event] gegevens om algoritmische scores te berekenen. Voor meer informatie over [!DNL Consumer Experience Event], gelieve te verwijzen naar de [Voorbereidende gegevens voor gebruik in de Intelligente documentatie](../data-preparation.md)van de Diensten.
...
Attribution AI geeft de toewijzingsscores in het meest granulaire niveau weer, zodat u de scores met elke gewenste scorekolom kunt segmenteren en dichten. Als u deze scores in de gebruikersinterface wilt weergeven, leest u de sectie over het [weergeven van onbewerkte muziekpaden](#raw-score-path). Als u de scores wilt downloaden met de API, gaat u naar de [downloadscores in het Attribution AI](./download-scores.md) -document.
...
| geo (String) | Waar | De geografische locatie waar de conversie is uitgevoerd `placeContext.geo.countryCode`. <br> **Voorbeeld:** VS |
...
| scores (Object) | Waar | Aanraakpuntbijdrage voor deze conversie als score. Zie de sectie [Samengevoegde](#aggregated-attribution-scores) toewijzingsscores voor meer informatie over de scores die in dit object worden geproduceerd. |
...
In de onderstaande tabel worden de toewijzingsscores toegewezen aan de onbewerkte scores. Als u de onbewerkte scores wilt downloaden, gaat u naar de [downloadscores in de documentatie van de Attribution AI](./download-scores.md) .
...
| kanaal (String) | ENUM | Onwaar | De `channel._type` eigenschap die wordt gebruikt om een ruwe classificatie van kanalen met gelijkaardige eigenschappen in [!DNL Consumer Experience Event] XDM te verstrekken. <br> **Voorbeeld**: ZOEKEN |
...
In de onderstaande tabel worden de geaggregeerde scores toegewezen aan de onbewerkte scores. Als u de onbewerkte scores wilt downloaden, gaat u naar de [downloadscores in de documentatie van de Attribution AI](./download-scores.md) . Als u de onbewerkte muziekpaden vanuit de gebruikersinterface wilt weergeven, gaat u naar het gedeelte over het [weergeven van onbewerkte muziekpaden](#raw-score-path) in dit document.
...
Zodra u uw gegevens hebt voorbereid en al uw geloofsbrieven en schema&#39;s op zijn plaats hebt, begin door de [gebruikershandleiding](./user-guide.md)van de Attribution AI te volgen. Deze gids begeleidt u door het creëren van een geval voor Attribution AI.
...
- [Overzicht](../../rtcdp/overview.md) van realtime-klantprofiel: Real-time Customer Data Platform (Real-time CDP) is gebaseerd op  [!DNL Adobe Experience Platform]en helpt bedrijven bekende en onbekende gegevens samen te brengen om klantprofielen te activeren door middel van intelligente beslissingen gedurende de hele reis van de klant. CDP in real time combineert veelvoudige bronnen van ondernemingsgegevens om verenigde profielen in real time tot stand te brengen die kunnen worden gebruikt om één-aan-één gepersonaliseerde klantenervaringen over alle kanalen en apparaten te verstrekken.

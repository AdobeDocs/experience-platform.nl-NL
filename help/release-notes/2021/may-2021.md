...
| Widget maken en beheren | Alle standaard- en aangepaste widgets zijn toegankelijk voor marketers in een gecentraliseerde opslagplaats voor het democratiseren van inzichten bij het maken en delen van inzichten:<br/><ul><li>Het standaardlusje bevat Adobe-verstrekte widgets die binnen de dashboardcontext toegankelijk zijn. </li><li>Het aangepaste tabblad bevat aangepaste widgets die door de organisatie zijn gemaakt, waaronder een optie om widgets te verbergen voor weergave.</li><li>Met de workflow voor het maken van widgets in profielen en inzichten van het publiek kunt u aangepaste widgets bewerken, selecteren, voorvertonen en publiceren.</li></ul> |
...
- Elke organisatie van het Experience Cloud komt met een vooraf gecreëerde standaardproductiestandaard. Deze sandbox fungeert als standaardbestemming voor elk verzoek dat vanuit een andere Adobe- of niet-Adobe-toepassing naar Platform wordt verzonden en dat (nog) niet voldoet aan de sandbox-standaard. De standaardproductiestandaard kan niet worden teruggesteld als de identiteitsgrafiek binnen het ook door Adobe Analytics voor de [ Cross eigenschap van de Analyse van het Apparaat (CDA) ](https://experienceleague.adobe.com/docs/analytics/components/cda/overview.html?lang=nl) wordt ontvangen, of als de identiteitsgrafiek binnen het ook wordt gebruikt door Adobe Audience Manager voor de [ Mensen Gebaseerde Eigenschappen (PBD) ](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/destinations/people-based/people-based-destinations-overview.html?lang=nl) eigenschap.

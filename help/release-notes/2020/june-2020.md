...
| Functie | Beschrijving |
| ------- | ----------- |
| Aanvullende API- en UI-ondersteuning voor cloudopslagsystemen | Nieuwe bronaansluitingen voor Apache HDFS |
| Aanvullende API- en UI-ondersteuning voor databases | Nieuwe bronschakelaars voor Couchbase. |

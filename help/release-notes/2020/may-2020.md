...
|--- | ---|
| [(Beta) Amazon Kinesis-bestemming](/help/rtcdp/destinations/amazon-kinesis-destination.md) | In dit artikel wordt uitgelegd hoe u een real-time uitgaande verbinding maakt met uw [!DNL Amazon Kinesis] opslagruimte om gegevens vanuit Adobe Experience Platform te streamen. |
| [(Beta) Azure Event Hubs-bestemming](/help/rtcdp/destinations/azure-event-hubs-destination.md) | In dit artikel wordt uitgelegd hoe u een real-time uitgaande verbinding maakt met uw [!DNL Azure Event Hubs] opslagruimte om gegevens vanuit Adobe Experience Platform te streamen. |

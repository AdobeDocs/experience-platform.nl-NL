...
## Experience Platform Web SDK en Experience Platform Edge Network
...
| AEP Web SDK Mixin | Een combinatie voor gebruik met AEP Web SDK die alle gesteunde gebieden omvat. |
| Besturingselementen voor cursusinstemming | Biedt bedrijven controle over opt-in en opt-out van de AEP Web SDK |
| Ondersteuning voor foutopsporing aan de clientzijde in de nieuwe Experience Cloud Debugger Extension | Zie verzoeken van de AEP web SDK en randsporen om te zien hoe gegevens door het systeem stromen. |

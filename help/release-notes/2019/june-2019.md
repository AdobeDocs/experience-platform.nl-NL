...
| -----------| ---------- |
| Provisioning en computerisolatie | Specifieke computerbronnen beschikbaar stellen die nodig zijn om gegevenswetenschappers in staat te stellen niet-vertrouwde code uit te voeren binnen [!DNL Experience Platform] op veilige wijze. |
...
| Gegevensvisualisatie | Mogelijkheid om SQL-query&#39;s uit te voeren in [!DNL Jupyter Notebooks] om gegevens prep en eigenschapengineering te versnellen. |
...
| Connectiviteit hulpprogramma voor databasebeheer | Verbinden [!DNL Aqua Data Studio] of [!DNL DB Visualizer] tot [!DNL Query Service] voor de functionaliteit voor gegevensexploratie en het maken van gegevenssets. [!DNL Query Service] steunt ook connectiviteit van R Studio. Zoek de verificatiegegevens op het tabblad Referenties. |
...
Meer informatie over [!DNL Query Service], zie de [productdocumentatie](../../query-service/home.md).

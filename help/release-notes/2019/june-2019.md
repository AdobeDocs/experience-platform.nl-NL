---
title: Aanvullende informatie voor Adobe Experience Platform van juni 2019
description: Aanvullende informatie voor Adobe Experience Platform van juni 2019
...
| Gegevensexploratie | Naadloze toegang tot XDM-gegevens die in [!DNL Experience Platform] worden opgenomen, is geïntegreerd met [!DNL Experience Platform Data Access] SDK. |
...
| Ontwerpmodel | Template en Runtimes die gegevenswetenschappers toelaten om zich op Modelontwikkeling te concentreren zonder het moeten infrastructuurcode uitvoeren om tot gegevens toegang te hebben en middelen te verwerken. U kunt modelcode importeren en deze optimaliseren om inzichten af te leiden van gegevens in [!DNL Experience Platform] . |
...
| Batch-scoring | Verrijken [!DNL Real-Time Customer Profile] met leerinzichten van machines of schrijf deze als datasets terug naar [!DNL Experience Platform] |
| Planning | Geïntegreerd met de [!DNL Experience Platform] Orchestration Service om modeltraining, -scoring en -functiepijpleidingen te automatiseren met door de gebruiker gedefinieerde schema&#39;s via API&#39;s. |
...
* Kan een door [!DNL Experience Platform] opgegeven veldgroep niet uitbreiden door een veld toe te voegen.

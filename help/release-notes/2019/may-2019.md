...
| [!DNL Schema Library] | De [!DNL Schema Library] bevat alles [!DNL Schema Registry] middelen, met inbegrip van de middelen die door een individuele organisatie zijn vastgesteld en die welke door Adobe aan alle gebruikers ter beschikking worden gesteld; [!DNL Experience Platform] partners, en verkopers de waarvan toepassingen met worden geïntegreerd [!DNL Experience Platform]. |

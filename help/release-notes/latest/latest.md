...
- [Opmerkingen bij de release van Adobe Experience Platform](#adobe-experience-platform-release-notes)
   - [Dashboards {#dashboards}](#dashboards-dashboards)
      - [Accountprofielen, dashboards](#account-profiles-dashboards)
      - [Profieldashboards](#profile-dashboards)
      - [Doeldashboards](#destinations-dashboards)
   ...
   - [Klantprofiel in realtime {#profile}](#real-time-customer-profile-profile)
...
Zie het document over [opwaardering van monitorprofielen in de gebruikersinterface](../../dataflows/ui/b2b/monitor-profile-enrichment.md).

Voor instructies over hoe te om verwante rekeningen in segmentdefinities te gebruiken, zie de gids over [Gebruiksscenario&#39;s voor segmentatie voor Real-time Customer Data Platform B2B Edition](../../rtcdp/segmentation/b2b.md#related-accounts).

Meer over Echte - tijdCDP B2B Uitgave leren, zie [Real-time CDP B2B-overzicht](../../rtcdp/overview.md).

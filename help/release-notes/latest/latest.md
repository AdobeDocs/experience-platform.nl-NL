...
Voor meer informatie raadpleegt u het [capaciteitsoverzicht](../../landing/license-usage-and-guardrails/capacity.md).
...
| [[!DNL The Trade Desk]](../../destinations/catalog/advertising/tradedesk.md) interne upgrade | Vanaf vrijdag 31 juli 2025 kunt u twee [!DNL The Trade Desk]-kaarten naast elkaar zien in de bestemmingencatalogus. Dit komt door een interne upgrade van de bestemmingsservice. <br><br>De naam van de bestaande [!DNL The Trade Desk]-bestemmingsconnector is gewijzigd in **[!UICONTROL (Deprecated) The Trade Desk]** en er is nu een nieuwe kaart met de naam **[!UICONTROL The Trade Desk]** beschikbaar. Gebruik de nieuwe **[!UICONTROL The Trade Desk]**-verbinding in de catalogus voor nieuwe activeringsgegevensstromen. <br><br>Als er actieve gegevensstromen naar de bestemming **[!UICONTROL (Deprecated) The Trade Desk]** zijn, worden deze automatisch bijgewerkt. U hoeft dus niets te doen. <br><br>Als u gegevensstromen maakt via de [Flow Service API](https://developer.adobe.com/experience-platform-apis/references/destinations/), moet u uw [!DNL flow spec ID] en [!DNL connection spec ID] bijwerken naar de volgende waarden:<ul><li>Stroomspecificatie-ID: `86134ea1-b014-49e8-8bd3-689f4ce70578`</li><li>Verbindingsspecificatie-ID: `1029798b-a97f-4c21-81b2-e0301471166e`</li></ul> |
...
| [!BADGE Beperkte bèta]{type=Informative} Marketingacties voor bestemmingen bewerken | U kunt nu [marketingacties bewerken](/help/destinations/ui/edit-activation.md#edit-marketing-actions) voor bestaande bestemmingen. Deze functie is momenteel in beperkte bèta. Neem contact op met uw Adobe-vertegenwoordiger om toegang aan te vragen. |
| [!BADGE Beperkte bèta]{type=Informative} Bestemmingen bewerken | U kunt nu [uw bestemmingsconfiguratie bewerken](/help/destinations/ui/edit-destination.md) nadat u deze hebt gemaakt. Deze functie is momenteel in beperkte bèta. Neem contact op met uw Adobe-vertegenwoordiger om toegang aan te vragen. |
...
| Ondersteuning voor voorlopige verwijdering van records in [!DNL Salesforce] | De bron [!DNL Salesforce] ondersteunt nu het opnemen van voorlopig verwijderde records via een optionele `includeDeletedObjects`-parameter. Wanneer deze optie is ingesteld op true, kunnen klanten voorlopig verwijderde records opnemen in hun [!DNL Salesforce]-query&#39;s en deze records importeren in Experience Platform. Lees de [[!DNL Salesforce] brondocumentatie](../../sources/connectors/crm/salesforce.md) voor meer informatie. |

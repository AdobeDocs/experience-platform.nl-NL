...
For more information, see the [Agent Orchestrator documentation](https://experienceleague.adobe.com/nl/docs/experience-cloud-ai/experience-cloud-ai/agents/agent-orchestrator). -->
...
| AES256 encryptiesteun voor [&#x200B; Amazon S3 &#x200B;](../../destinations/catalog/cloud-storage/amazon-s3.md#destination-details) bestemmingen | U kunt nu AES256-codering configureren voor uw Amazon S3-export. Er zijn twee opties beschikbaar: <ul><li>**[!UICONTROL Default]**: Als u geen aangepast beleid hebt toegepast op uw emmers, worden de gegevens in rust versleuteld wanneer deze in S3 landt met het algoritme AES256. Als u echter aangepast beleid hebt toegepast, respecteert Experience Platform dit beleid en blijft Amazon S3 het aangepaste coderingsbeleid toepassen dat u hebt geconfigureerd.</li><li>**[!UICONTROL SSE-S3/AES256]**: Experience Platform voegt de `s3:x-amz-server-side-encryption": "AES256` -header in de export toe en gegevens worden in rust gecodeerd wanneer deze in S3 landt met het AES256-algoritme.</li></ul>  <br> Deze release wordt geleidelijk uitgevoerd en is op 30 januari voltooid. |

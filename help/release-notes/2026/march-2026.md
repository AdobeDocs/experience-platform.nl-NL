...
| --- | --- |
| Record verwijderen met meerdere gegevenssets (alleen API) | Schrap identiteiten over één, veelvoudige, of alle datasets in één enkel API verzoek, vereenvoudigend de werkschema&#39;s van de gegevenshygiëne. U kunt schrapping tot de profieldiensten ook beperken slechts, verlatend de verslagen van het gegevensmeer onveranderd. Zie het [ Verslag schrap de gids van de het werkorden ](../../hygiene/api/workorder.md) voor meer details. |
...
De capaciteit verstrekt een uitvoerige mening van 0} begeleidingen van uw organisatie [ en geeft aanbevelingen op hoe te om potentiële capaciteitsschendingen op te lossen door uw capaciteiten op een zandbakniveau toe te wijzen.](../../rtcdp/guardrails/overview.md)

**Nieuwe functie**

| Functie | Beschrijving |
| ------- | ----------- |
| Edge-segmentatiedoorvoer | U kunt nu instructies voor de doorvoer van randsegmentatie zien en beheren. Voor meer informatie, lees het [ overzicht van de Capaciteit ](/help/landing/license-usage-and-guardrails/capacity.md#edge-segmentation-throughput). |
| Ondersteuning voor de bewaking van Edge-gegevensstreams | Controle in real time voor uw Edge gegevensstromen is nu beschikbaar, die transparantie in productie en andere metriek verstrekken. Voor meer informatie, leest de [ gids van de controlerand ](/help/dataflows/ui/monitor-edge.md). |

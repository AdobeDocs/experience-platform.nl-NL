...
| Functie | Beschrijving |
| ------- | ----------- |
| Gebeurtenissen | U kunt nu de terugzoekperiode van gebeurtenissen instellen wanneer u door uw profielen bladert. Dit laat u de gebeurtenissen zien waaraan het profiel voor de gespecificeerde tijdspanne wordt geassocieerd. Voor meer informatie, lees de [&#x200B; gids UI van het Profiel &#x200B;](/help/profile/ui/user-guide.md#events). |

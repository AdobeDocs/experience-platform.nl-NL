...
| Veldgroepen | [[!UICONTROL XDM Individual Prospect Profile]](https://github.com/adobe/xdm/pull/1721/files) | De optie `partnerProspect` voor metagegevenstags is toegevoegd aan de klasse [!UICONTROL XDM Individual Prospect Profile] . |
...
| Veldgroepen | [[!UICONTROL MediaAnalytics Interaction Details]](https://github.com/adobe/xdm/pull/1716/files) | Er is een nieuw veld voor mediarapportage toegevoegd. |

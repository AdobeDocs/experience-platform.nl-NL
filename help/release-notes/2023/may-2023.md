...
| manifestbestand opnemen in export naar opslagdoelen voor bètawolken | U kunt nu een manifest-JSON-bestand opnemen dat informatie bevat over de exportlocatie, de exportgrootte en meer bij het exporteren van gegevens naar de zes bètadoelen voor cloudopslag - [(Beta) Amazon S3](/help/destinations/catalog/cloud-storage/amazon-s3.md), [(Beta) Azure Blob](/help/destinations/catalog/cloud-storage/azure-blob.md), [(Beta) Azure Data Lake Storage Gen2](/help/destinations/catalog/cloud-storage/adls-gen2.md), [(Bèta) Gegevenslandingszone](/help/destinations/catalog/cloud-storage/data-landing-zone.md), [(bèta) Google Cloud Storage](/help/destinations/catalog/cloud-storage/google-cloud-storage.md), [(bèta) SFTP](/help/destinations/catalog/cloud-storage/sftp.md). <br><br> Meer informatie vindt u in de **[!UICONTROL Destination details]** van de hierboven gekoppelde pagina&#39;s. |

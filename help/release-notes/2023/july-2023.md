...
| --- | --- | --- |
| Klasse | [[!UICONTROL XDM Individual Prospect Profile]](https://github.com/adobe/xdm/pull/1758/files) | Gebruik deze klasse om perspectiefprofielen in te brengen die van de top-of-de-funnel van gegevensverkopers van het gebruiksgeval van de klantenverwerving worden geput. |
...
| --- | --- | --- |
| Veldgroepen | [[!UICONTROL MediaAnalytics Interaction Details]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` is bijgewerkt van experimenteel naar `stable` . |
| Veldgroepen | [[!UICONTROL Media Interaction Details]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` is bijgewerkt van `stable` tot `deprecated` . |

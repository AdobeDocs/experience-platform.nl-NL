...
| --- | --- | --- |
| Web SDK | Propositie-interacties automatisch bijhouden | U kunt nu de eigenschap `autoCollectPropositionInteractions` in Web SDK gebruiken om te bepalen of Web SDK automatisch propositie-interacties moet verzamelen. Raadpleeg de [`autoCollectPropositionInteractions`](/help/collection/js/commands/configure/autocollectpropositioninteractions.md)-documentatie voor meer informatie. |

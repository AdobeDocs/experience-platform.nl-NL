...
| --- | --- |
| Waarschuwing foutpercentage bestemming | Een nieuw alarm is toegevoegd voor bestemmingen: **het mislukkingstarief van de Bestemming overschrijdt drempel**. Deze waarschuwing geeft een melding wanneer het aantal mislukte records tijdens de gegevensactivering de toegestane drempel heeft overschreden, zodat u snel kunt reageren op activeringsproblemen. Lees de documentatie over [&#x200B; standaardalarm regels &#x200B;](../../observability/alerts/rules.md) voor meer informatie. |

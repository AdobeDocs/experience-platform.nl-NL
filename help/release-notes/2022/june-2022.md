...
| [ geeft voorstellingen ](/help/collection/use-cases/personalization/rendering-personalization-content.md) in enig-paginatoepassingen zonder stijgende metriek terug. | Met de zojuist toegevoegde opdracht `applyPropositions` kunt u een array met voorstellingen van [!DNL Target] weergeven of uitvoeren in toepassingen die uit één pagina bestaan, zonder de metriek [!DNL Analytics] en [!DNL Target] te verhogen. Dit verhoogt de nauwkeurigheid van de rapportage. |

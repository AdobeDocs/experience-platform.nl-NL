...
| Functie | Beschrijving |
| ------- | ----------- |
| Toestemming voor beleidshandhaving (beperkte beschikbaarheid) | Als uw organisatie het add-on aanbieden van het Schild van de Gezondheid heeft gekocht, kunt u toestemmingsbeleid [ nu tot stand brengen om ](../../data-governance/policies/user-guide.md#consent-policy) klantentoestemmingen en voorkeur in segmentparticipatie [ automatisch af te dwingen.](../../data-governance/enforcement/auto-enforcement.md#consent-policy-evaluation) |
...
| --- | --- | --- |
| Veldgroepen | [[!UICONTROL Change set]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/changeset.schema.json) | Hiermee legt u wijzigingen op rijniveau vast in en van gegevenssets. Deze veldgroep kan door elke klasse worden gebruikt. |
| Veldgroepen | [[!UICONTROL Reference keys]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-reference-keys.schema.json) | Vangt verwijzingssleutels voor schema&#39;s ExperienceEvent, toestaand u om verhoudingen met schema&#39;s te bouwen die op andere klassen worden gebaseerd. |
...
| Veldgroepen | [[!UICONTROL Record Status]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/record-status.schema.json) | Status van veldgroep bijgewerkt van `experimental` tot `stable` . |
| Veldgroepen | (Meerdere) | Verschillende B2B-veldgroepen zijn bijgewerkt, zodat bepaalde id-velden worden vervangen door sleuteltekstvelden die het gegevenstype [[!UICONTROL B2B Source]](../../xdm/data-types/b2b-source.md) gebruiken. De vorige id-velden worden in een toekomstige update vervangen. Verwijs naar het volgende [ trekkingsverzoek ](https://github.com/adobe/xdm/pull/1533/files#diff-720c0bb1d1cbaf622f5656c2a4b62d35830c75f6563794da72a280a6a520fbc1) voor een volledige lijst van veranderingen in de beïnvloede gebiedsgroepen. |

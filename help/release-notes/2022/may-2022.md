...
| Functie | Beschrijving |
| --- | --- |
| Verlopen gegevensset | [Verlopen planning](../../hygiene/ui/dataset-expiration.md) voor gegevensbestanden voor Platforms. |
...
| Ondersteuning voor gegevenstoewijzing voor XDM-objecten | XDM-objecten naast gegevenslaagobjecten toewijzen wanneer [configureren van Data Prep voor gegevensverzameling](../../datastreams/data-prep.md#select-data). |

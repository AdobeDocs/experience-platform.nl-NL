...
| Veldgroep | [[!UICONTROL Media Interaction Details]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-media.schema.json) | Een veldgroep voor de [!UICONTROL XDM ExperienceEvent] klasse die details over een mediacommunicatie vastlegt. |

...
### Een object naar een sandbox kopiëren {#express-copy}

>[!IMPORTANT]
>
>De functie voor expressies bevindt zich momenteel in de bètaversie en is alleen beschikbaar voor bepaalde klanten. Express copy (Beta) ondersteunt momenteel alleen schema- en brongegevens.

U kunt express tot exemplaar van de pagina van de objecten inventaris toegang hebben. Als u bijvoorbeeld een lijst met beschikbare schema&#39;s wilt weergeven, selecteert u **[!UICONTROL Schemas]** in de linkernavigatie en selecteert u vervolgens de tab **[!UICONTROL Browse]** . Selecteer vervolgens de ellips (`...`) naast het geselecteerde schema om de besturingsopties in een vervolgkeuzemenu weer te geven. Selecteer **[!UICONTROL Add to package]** in de vervolgkeuzelijst.

![ Lijst van schema&#39;s die het dropdown menu tonen dat de [!UICONTROL Add to package] controle benadrukt.](../images/ui/sandbox-tooling/add-to-package-express.png)

Het dialoogvenster **[!UICONTROL Add to package]** wordt weergegeven. Selecteer de optie **[!UICONTROL Express copy]** en selecteer vervolgens de optie **[!UICONTROL Target sandbox]** in het vervolgkeuzemenu. Selecteer ten slotte **[!UICONTROL Add]** om uw keuzes te bevestigen.

![[!UICONTROL Add to package] , waarin een geselecteerd pakket uit het vervolgkeuzemenu wordt weergegeven. ](../images/ui/sandbox-tooling/express-copy.png)

>[!NOTE]
>
> Met Express Copy worden de geselecteerde objecten samen met de vereiste afhankelijkheden automatisch verpakt en in de doelsandbox geïmplementeerd. Als een afhankelijk object al in de doelsandbox bestaat, wordt het opnieuw gebruikt, anders wordt een nieuw object gemaakt.

Als u de status van uw express-kopieerverzoek wilt controleren, selecteert u **[!UICONTROL Sandboxes]** in de linkernavigatie en selecteert u vervolgens het tabblad **[!UICONTROL Jobs]** . Er wordt een lijst met alle taken en de huidige verwerkingsstatus weergegeven.

![ het baanlusje dat een lijst van banen toont.](../images/ui/sandbox-tooling/sandboxes-jobs.png)

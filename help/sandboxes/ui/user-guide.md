...
Selecteer **[!UICONTROL Sandboxen]** in de gebruikersinterface van het Experience Platform in de linkernavigatie om het **[!UICONTROL Sandboxen]** dashboard te openen. Het dashboard bevat alle beschikbare sandboxen voor uw organisatie, inclusief het type sandbox (productie of ontwikkeling) en de status (actief, maken, verwijderen of mislukt).
...
Nadat u de sandbox hebt gemaakt, vernieuwt u de pagina en verschijnt de nieuwe sandbox in het dashboard **[!UICONTROL Sandboxen]** met de status &quot;[!UICONTROL Creating]&quot;. Nieuwe sandboxen nemen ongeveer 15 minuten in beslag om door het systeem te worden ingericht, waarna de status van deze sandboxen verandert in &quot;[!UICONTROL Active]&quot;.
...
Als u een sandbox in de UI opnieuw wilt instellen, selecteert u **[!UICONTROL Sandboxen]** in de linkernav en selecteert u vervolgens de sandbox die u opnieuw wilt instellen. Selecteer **[!UICONTROL Sandbox opnieuw instellen]** in het dialoogvenster dat aan de rechterkant van het scherm wordt weergegeven.
...
Er verschijnt een bevestigingsbericht en de status van de sandbox verandert in &quot;**[!UICONTROL Resetting]&quot;**. Zodra het door het systeem is voorzien, zal zijn staat bijwerken aan **&quot;[!UICONTROL Actief]&quot;** of **&quot;[!UICONTROL Mislukt]&quot;**.
...
Als u een sandbox in de UI wilt verwijderen, selecteert u **[!UICONTROL Sandboxen]** in de linkernav en selecteert u vervolgens de sandbox die u wilt verwijderen. Selecteer **[!UICONTROL Sandbox verwijderen]** in het dialoogvenster dat aan de rechterkant van het scherm wordt weergegeven.
...
Er wordt een bevestigingsbericht weergegeven en de sandbox wordt verwijderd uit de werkruimte **[!UICONTROL Sandboxen]**.

...
| --- | --- | --- | --- |
| Adobe Advertising - Code-aanwezigheid | 5 | De Adobe Advertising-tag is niet beschikbaar in het DOM. | Voer de markering van Adobe Advertising uit gebruikend de [ de markeringsuitbreiding van Adobe Advertising ](../../destinations/catalog/advertising/adobe-advertising-cloud.md). |
| Adobe Advertising - Geïmplementeerde segmentpixel | 5 | Upgrade de Adobe Advertising-segmentpixels naar de nieuwe Adobe Advertising-tags voor alleen afbeeldingen. Het gebruik van verouderde AMO-segmenttags kan leiden tot gegevensverlies. | Voer het het segmentpixel van Adobe Advertising uit gebruikend de [ markeringsuitbreiding van Adobe Advertising ](../../destinations/catalog/advertising/adobe-advertising-cloud.md). |

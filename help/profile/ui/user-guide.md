...
Op het **[!UICONTROL Browse]** lusje kunt u uw profielen of in a **kaart** mening of a **lijst** mening bekijken door de knevel te selecteren.

![ de kaart en de knevel van de lijstmening wordt benadrukt.](../images/user-guide/change-browse-view.png)
...
Het tabblad **[!UICONTROL Details]** bevat gedetailleerdere informatie over het geselecteerde profiel. Het tabblad Details wordt in verschillende secties verdeeld, afhankelijk van de kaart- of grafiekweergave. Voor de kaartweergave worden de klantprofielinzichten, AI insight-widgets, aanpasbare widgets en automatisch geclassificeerde widgets weergegeven terwijl voor de grafiekweergave de profielkenmerken en ervaringsgebeurtenissecties worden weergegeven.

![ de pagina van profieldetails wordt getoond.](../images/user-guide/profile-details.png)

Bovendien kunt u schakelen of de door AI gegenereerde inzichten worden weergegeven, de details voor hub in vergelijking met edge tonen en kiezen tussen kaart- of grafiekweergaven.
...
In de sectie **[!UICONTROL Profile attributes]** wordt een hiërarchische grafiekweergave van de profielgegevens weergegeven. In deze weergave vertegenwoordigt het centrale knooppunt het profiel zelf, vertegenwoordigen secundaire knooppunten de veldgroepen en vertegenwoordigen de resterende knooppunten eigenschappen binnen elke veldgroep.

In de grafiekweergave kunt u de knooppunten slepen en neerzetten om de volgorde van de knooppunten te wijzigen, de knooppunten samen te vouwen en uit te vouwen om meer details over de kenmerken weer te geven, te zoeken en te filteren op kenmerk, en in- en uitzoomen om de kenmerkdetails beter weer te geven.

![ de grafiekmening voor het profiel wordt getoond, tonend de diverse knopen die omhoog het profiel maken.](/help/profile/images/user-guide/profile-attribute-graph.png)

#### Gebeurtenissen van Experience {#experience-events}

In de sectie **[!UICONTROL Experience events]** wordt een tijdlijn weergegeven van ervaringsgebeurtenissen die het profiel bevatten. In deze sectie worden standaard ervaringsgebeurtenissen weergegeven in de laatste 48 uur. U kunt het datumbereik echter instellen voor maximaal 30 dagen.

![ de sectie van de Gebeurtenissen van de Ervaring wordt getoond, tonend een chronologie van ervaringsgebeurtenissen die het profiel bevatten.](/help/profile/images/user-guide/experience-event-graph.png)

Als u **[!UICONTROL View event]** selecteert, kunt u de gebeurteniskenmerken zien die aan de geselecteerde gebeurtenis zijn gekoppeld. Dit zijn onder andere het pad, het kenmerk, de weergavenaam en de waarde.

![ de attributen popover van de Gebeurtenis wordt getoond, tonend verdere details met betrekking tot de gebeurtenis.](/help/profile/images/user-guide/event-attributes-graph.png)
...
>[!NOTE]
>
>De weergave van de gebeurtenissen kan maximaal 15 minuten worden vertraagd.

Het tabblad **[!UICONTROL Events]** bevat standaard gegevens van de afgelopen 48 uur, waarbij de 100 meest recente ExperienceEvents aan de klant zijn gekoppeld. Deze gegevens kunnen het openen van e-mail, winkelwagentjes en paginaweergaven omvatten. U kunt het datumbereik ook instellen voor maximaal 30 dagen. Als u **[!UICONTROL View all]** selecteert voor een afzonderlijke gebeurtenis, worden aanvullende velden en waarden vastgelegd als onderdeel van de gebeurtenis.

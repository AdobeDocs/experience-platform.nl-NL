...
Selecteer in het scherm **[!UICONTROL Workflows]** de optie **[!UICONTROL CSV toewijzen aan XDM-schema]** onder de sectie **[!UICONTROL Gegevensinvoer]** en selecteer vervolgens **[!UICONTROL Starten]**.

![](../images/tutorials/map-a-csv-file/workflows.png)

De **[!UICONTROL CSV toewijzen aan XDM schema]** werkschema verschijnt, beginnend op **[!UICONTROL Doel]** stap. Kies een dataset voor binnenkomende gegevens waarin moeten worden opgenomen. U kunt of een bestaande dataset gebruiken of nieuwe creëren.

**Een bestaande gegevensset gebruiken**

Als u uw CSV-gegevens wilt opnemen in een bestaande gegevensset, selecteert u **[!UICONTROL Bestaande gegevensset gebruiken]**. U kunt of een bestaande dataset terugwinnen gebruikend de onderzoeksfunctie of door door de lijst van bestaande datasets in het paneel te scrollen.

![](../images/tutorials/map-a-csv-file/use-existing-dataset.png)

Als u uw CSV-gegevens wilt opnemen in een nieuwe gegevensset, selecteert u **[!UICONTROL Nieuwe gegevensset maken]** en voert u een naam en beschrijving in voor de gegevensset in de opgegeven velden. Selecteer een schema door of de onderzoeksfunctie te gebruiken of door door de lijst van schema&#39;s te scrollen verstrekt. Selecteer **[!UICONTROL Volgende]** om door te gaan.

![](../images/tutorials/map-a-csv-file/create-new-dataset.png)

## Gegevens toevoegen

De stap **[!UICONTROL Gegevens toevoegen]** wordt weergegeven. Sleep het CSV-bestand naar de beschikbare ruimte en zet het neer of selecteer **[!UICONTROL Kies bestanden]** om het CSV-bestand handmatig in te voeren.

![](../images/tutorials/map-a-csv-file/add-data.png)

De sectie **[!UICONTROL Voorbeeldgegevens]** wordt weergegeven zodra het bestand is geüpload, met daarin de eerste tien rijen met gegevens. Nadat u hebt bevestigd dat de gegevens naar behoren zijn geüpload, selecteert u **[!UICONTROL Volgende]**.
...
De **[!UICONTROL Bron toewijzen aan doelveld]** popover wordt weergegeven. Van hieruit kunt u selecteren welk veld u wilt toewijzen, gevolgd door **[!UICONTROL Opslaan]** om uw nieuwe toewijzing toe te voegen.
...
Selecteer **[!UICONTROL Berekend veld toevoegen]** knoop om verder te gaan.

![](../images/tutorials/map-a-csv-file/add-calculated-field.png)

Het deelvenster **[!UICONTROL Berekend veld maken]** wordt weergegeven. Het linkerdialoogvenster bevat de velden, functies en operatoren die in berekende velden worden ondersteund. Selecteer een van de tabbladen om functies, velden of operatoren toe te voegen aan de expressie-editor.

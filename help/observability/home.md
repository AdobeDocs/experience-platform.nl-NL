...
description: Adobe Experience Platform Observability Insights is een RESTful API waarmee u belangrijke metriek op de activiteiten van het Platform kunt blootstellen. Deze metriek verstrekt inzicht in het gebruiksstatistieken van het Platform, gezondheid-controles voor de diensten van het Platform, historische tendensen, en prestatiesindicatoren voor diverse functies van het Platform.
...
Met Adobe Experience Platform [!DNL Observability Insights] kunt u de activiteiten van het platform volgen aan de hand van statistische gegevens en gebeurtenismeldingen. Dit document biedt een overzicht van de verschillende mogelijkheden die de service biedt, samen met koppelingen naar verdere documentatie voor meer informatie.
...
Met Experience Platform kunt u zich abonneren op waarschuwingen op basis van specifieke waarden voor waarneming wanneer een bepaalde set voorwaarden in uw platformbewerkingen wordt bereikt. Een waarschuwing kan de vorm aannemen van een eenmalige melding of kan worden herhaald over een vooraf bepaald tijdsinterval totdat de omstandigheden die de waarschuwing hebben veroorzaakt, zijn opgelost.

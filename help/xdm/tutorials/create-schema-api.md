...
## Gebruik UI om uw schema te bevestigen {#validate-in-ui}

Gebruik de gebruikersinterface van Experience Platform om te controleren of het schema dat u via de API van [!DNL Schema Registry] hebt gemaakt, de juiste structuur, eigenschappen en identiteitsconfiguratie heeft. Voer de volgende stappen uit:
...
Het schemacanvas toont de volledige structuur van uw schema. Controleren of:
...
Selecteer vervolgens het hoofdknooppunt van het schema om het deelvenster **[!UICONTROL Schema properties]** te openen en bevestig de belangrijkste metagegevens:

* Schema `$id`
* Weergavenaam
* Status van profielactivering

De `$id` moet overeenkomen met de waarde die wordt geretourneerd in de API-reactie.
...
Elk identiteitsveld dat aan het schema wordt toegevoegd, wordt weergegeven in de sectie **[!UICONTROL Identities]** van het deelvenster **[!UICONTROL Composition]** . Selecteer een identiteitsveld om de eigenschappen ervan in het rechterdeelvenster weer te geven. Bevestig voor elk identiteitsveld:

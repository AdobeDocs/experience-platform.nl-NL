...
## XDM-veldtypen definiëren in de API
...
Zoek eerst het gewenste veldtype en gebruik de voorbeeldcode om uw API-aanvraag samen te stellen voor het [maken van een mix](../api/create-mixin.md) of het [maken van een gegevenstype](../api/create-data-type.md).

...
>title="Schema in gebruik bewerken"
>abstract="Dit schema wordt reeds gebruikt door datasets of ingestitiewerkstromen. Wijzigingen in bestaande velden of identiteiten kunnen fouten met de opname veroorzaken als gegevensstromen worden uitgevoerd of gepland. Nadat de opname begint, slechts worden de additieve schemaveranderingen gesteund."
...
>[!NOTE]
>
>U kunt een het breken verandering in een schema slechts introduceren als het nog niet is gebruikt om gegevens in Experience Platform in te voeren en niet voor gebruik in het Profiel van de Klant in real time is toegelaten. Nochtans, zodra het schema in Experience Platform is gebruikt, moet het aan het additieve versieringsbeleid houden. Zodra een dataset voor het schema wordt gecreeerd, worden de regels van de Evolutie van het Schema strikt afgedwongen door het systeem voor alle gebieden in het schema. De velden worden niet-bewerkbaar in alle XDM-schema&#39;s waar naar wordt verwezen.

...
description: U kunt specifieke middelen in de Registratie API van het Schema omhoog kijken door een verzoek te doen van de GET dat $id (URL-Gecodeerde URI) van het middel in de verzoekweg omvat.

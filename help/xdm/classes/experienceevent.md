...
### Voorgestelde waarden voor `eventType` {#eventType}

In de volgende tabel worden de voorgestelde standaardwaarden voor `eventType`, alsmede de definities ervan:
...
In de volgende tabel worden de voorgestelde standaardwaarden voor `producedBy`:

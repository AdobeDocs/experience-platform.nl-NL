...
| `decisioning.propositionTrigger` | Gebeurtenissen van dit type worden lokaal opgeslagen door de Web SDK, maar worden niet verzonden naar de Edge Network. Telkens wanneer aan een liniaal wordt voldaan, wordt een gebeurtenis gegenereerd en lokaal opgeslagen (als die instelling is ingeschakeld). |

...
+++Selecteer deze optie om een diagram weer te geven van het gegevenstype Advertising Details Collection.
...
| [[!UICONTROL Ad Name]](https://experienceleague.adobe.com/docs/media-analytics/using/implementation/variables/ad-parameters.html?lang=nl-NL#ad-name) | `friendlyName` | string | Ja | De leesbare naam van de advertentie. In de rapportage is &quot;Advertentienaam&quot; de classificatie en &quot;Advertentienaam (variabele)&quot; de eVar. |

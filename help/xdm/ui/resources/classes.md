...
>[!NOTE]
>
>De acties XDM zijn beschikbaar bij de inventarislijst en de mening van het middeldetail (**[!UICONTROL More]**). De volledige acties zijn slechts op douane (huurder-bepaalde) middelen van toepassing; de standaardmiddelen hebben beperkte opties. Zie [&#x200B; schema&#39;s, klassen, gebiedsgroepen, en gegevenstypes beheren: acties en schrapping &#x200B;](../explore.md#xdm-resource-actions).
...
De workflow voor het maken van schema&#39;s wordt weergegeven. Selecteer [!UICONTROL Schema details] in de sectie **[!UICONTROL Other]** . Er wordt een lijst met beschikbare klassen weergegeven. Selecteer **[!UICONTROL Create class]**.
...
>[!IMPORTANT]
>
>Wanneer het bouwen van een schema dat een klasse uitvoert die door uw organisatie wordt bepaald, herinner dat de groepen van het schemagebied voor gebruik slechts met compatibele klassen beschikbaar zijn. Aangezien de klasse die u hebt gedefinieerd nieuw is, worden er geen compatibele veldgroepen weergegeven in het dialoogvenster **[!UICONTROL Add field group]** . In plaats daarvan, zult u nieuwe gebiedsgroepen [&#x200B; voor gebruik met die klasse moeten creëren &#x200B;](./field-groups.md#create). De volgende keer dat u een schema samenstelt dat de nieuwe klasse implementeert, worden de gedefinieerde veldgroepen weergegeven en beschikbaar voor gebruik.
...
U kunt een klasse bewerken via de schemaworkflow door een bestaand schema te bewerken dat de klasse uitbreidt of door handmatig een schema te maken. Het is niet mogelijk een klasse rechtstreeks te bewerken. Selecteer een bestaande klasse of [!UICONTROL Browse] vanuit het tabblad [!UICONTROL Schemas] in de **[!UICONTROL Create a schema]** -werkruimte.

...
>[!NOTE]
>
>Als u geen acties zoals **schrapping** of **de structuur van JSON van het Exemplaar** kunt vinden, verzeker u met een douane (huurder-bepaald) middel werkt en tot het van het menu van de lijstrij of de detailmening (**[!UICONTROL More]**) toegang heeft. De beschikbaarheid van handelingen is ook afhankelijk van machtigingen en gebruiksbeperkingen. Zie [ schema&#39;s, klassen, gebiedsgroepen, en gegevenstypes beheren: acties en schrapping ](./explore.md#xdm-resource-actions).
...
+++Selecteren om een voorbeeld-JSON-lading uit te vouwen

...
In de onderstaande documentatie vindt u informatie over hoe u een FTP-server kunt verbinden met het [!DNL Platform] gebruik van API&#39;s of de gebruikersinterface:

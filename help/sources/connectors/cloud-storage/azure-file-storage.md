...
Met bronnen voor cloudopslag kunt u uw eigen gegevens overbrengen naar Platform zonder dat u deze hoeft te downloaden, opmaken of uploaden. Ingebedde gegevens kunnen worden opgemaakt als XDM JSON, XDM parquet, of afgebakend. Elke stap van het proces is geïntegreerd in het Bronwerkschema. Met Platform kunt u gegevens van Azure File Storage via batches inbrengen.

In de onderstaande documentatie vindt u informatie over het maken van een verbinding tussen Azure File Storage en Platform via API&#39;s of de gebruikersinterface:

## Connect Azure File Storage naar Platform met behulp van API&#39;s

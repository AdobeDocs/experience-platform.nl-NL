...
>[!IMPORTANT]
>
>Gebruikers moeten de interactieve verificatie van het toetsenbord uitschakelen in de configuratie van de SFTP-server voordat ze verbinding maken. Als u de instelling uitschakelt, kunnen wachtwoorden handmatig worden ingevoerd in plaats van via een service of programma. Zie [Component Pro document](https://doc.componentpro.com/ComponentPro-Sftp/authenticating-with-a-keyboard-interactive-authentication) voor meer informatie over Interactieve Authentificatie van het Toetsenbord.

De documentatie hieronder verstrekt informatie over hoe te om een server van SFTP aan [!DNL Platform] te verbinden gebruikend APIs of de gebruikersinterface:

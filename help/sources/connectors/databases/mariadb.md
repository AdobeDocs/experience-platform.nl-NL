...
topic: overview
description: In de onderstaande documentatie vindt u informatie over het tot stand brengen van een verbinding tussen MariaDB en Platform via API's of de gebruikersinterface.
...
Experience Platform verleent steun voor het opnemen van gegevens van een derdegegevensbestand. [!DNL Platform] kan met verschillende types van gegevensbestanden zoals relationeel, NoSQL, of gegevenspakhuizen verbinden. Tot de ondersteuning voor databaseproviders behoren [!DNL MariaDB].
...
In de onderstaande documentatie vindt u informatie over het maken van een verbinding [!DNL MariaDB] [!DNL Platform] met API&#39;s of de gebruikersinterface:

## Verbinding maken [!DNL MariaDB] met API&#39; [!DNL Platform] s

- [Een MariaDB-connector maken met de Flow Service API](../../tutorials/api/create/databases/mariadb.md)
...
## Verbinding maken [!DNL MariaDB] met [!DNL Platform] de gebruikersinterface

- [Een MariaDB-bronconnector maken in de gebruikersinterface](../../tutorials/ui/create/databases/mariadb.md)

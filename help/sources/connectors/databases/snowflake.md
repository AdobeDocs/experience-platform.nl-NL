...
Geef waarden op voor de volgende gebruikersgegevens om via accountsleutelverificatie verbinding te maken met Experience Platform op Azure. [!DNL Snowflake]
...
Om zeer belangrijk-paarauthentificatie te gebruiken, produceer eerst een zeer belangrijk paar met 2048 bits RSA. Geef vervolgens waarden op voor de volgende gebruikersgegevens om verbinding te maken met Experience Platform op Azure met behulp van sleutelparverificatie.

---
keywords: Experience Platform;home;populaire onderwerpen;Apache Hive;Hive;hive;Azure HDInsights;azure hdinsights;
...
# (Beta) [!DNL Apache Hive] op [!DNL Azure HDInsights] -connector
...
In de onderstaande documentatie vindt u informatie over het tot stand brengen van een verbinding tussen [!DNL Apache Hive] en [!DNL Azure HDInsights] en [!DNL Experience Platform] via API&#39;s of de gebruikersinterface:

## Verbind [!DNL Apache Hive] op [!DNL Azure HDInsights] met [!DNL Experience Platform] gebruikend APIs
...
## Verbind [!DNL Apache Hive] op [!DNL Azure HDInsights] met [!DNL Experience Platform] gebruikend UI

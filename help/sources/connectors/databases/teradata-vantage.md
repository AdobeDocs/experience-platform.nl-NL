...
In de onderstaande documentatie vindt u informatie over de verbinding [!DNL Teradata Vantage] naar Platform met API&#39;s of de gebruikersinterface:
...
## Verbinden [!DNL Teradata Vantage] naar Platform met behulp van UI

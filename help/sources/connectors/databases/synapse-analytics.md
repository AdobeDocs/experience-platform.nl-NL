...
Het Platform van de ervaring verleent steun voor het opnemen van gegevens van een derdegegevensbestand. Het platform kan met verschillende types van gegevensbestanden zoals relationeel, NoSQL, of gegevenspakhuizen verbinden. Tot de ondersteuning voor databaseproviders behoren Azure Synapse Analytics.

In de onderstaande documentatie vindt u informatie over hoe u Azure Synapse Analytics kunt verbinden met Platform via API&#39;s of de gebruikersinterface:

## Connect Azure Synapse Analytics to Platform met API&#39;s
...
## Connect Azure Synapse Analytics to Platform met behulp van de gebruikersinterface

...
In de onderstaande documentatie vindt u informatie over het maken van een verbinding [!DNL Azure Synapse Analytics] [!DNL Platform] met API&#39;s of de gebruikersinterface:

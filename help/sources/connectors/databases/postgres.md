...
[!DNL Experience Platform] verleent steun voor het opnemen van gegevens van een derdegegevensbestand. [!DNL Platform] kan verbinding maken met verschillende typen databases, zoals relationeel, NoSQL of data warehouse. Tot de ondersteuning voor databaseproviders behoren [!DNL PostgreSQL].
...
In de onderstaande documentatie vindt u informatie over het maken van een verbinding [!DNL PostgreSQL] [!DNL Platform] met API&#39;s of de gebruikersinterface:

## Verbinding maken [!DNL PostgreSQL] met API&#39; [!DNL Platform] s
...
## Verbinding maken [!DNL PostgreSQL] met [!DNL Platform] de gebruikersinterface

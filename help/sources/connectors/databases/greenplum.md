...
Verschillende typen databases van derden worden ondersteund, waaronder relationele databases, NoSQL-databases of data warehouse. Ondersteuning voor databaseproviders omvat [!DNL GreenPlum].
...
In de onderstaande documentatie vindt u informatie over het maken van een verbinding [!DNL GreenPlum] [!DNL Platform] met API&#39;s of de gebruikersinterface:

## Verbinding maken [!DNL GreenPlum] met API&#39; [!DNL Platform] s
...
## Verbinding maken [!DNL GreenPlum] met [!DNL Platform] de gebruikersinterface

- [Creeer een GreenPlum bronschakelaar in UI](../../tutorials/ui/create/databases/greenplum.md)

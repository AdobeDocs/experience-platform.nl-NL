...
In de onderstaande documentatie vindt u informatie over het tot stand brengen van een verbinding tussen [!DNL Oracle] en [!DNL Platform] via API&#39;s of de gebruikersinterface:
...
## Verbind [!DNL Oracle] met [!DNL Platform] gebruikend UI

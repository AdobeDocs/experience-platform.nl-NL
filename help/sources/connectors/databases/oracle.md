...
In de onderstaande documentatie vindt u informatie over hoe u [!DNL Oracle] kunt verbinden met [!DNL Platform] via API&#39;s of de gebruikersinterface:

## Verbind [!DNL Oracle] met [!DNL Platform] gebruikend APIs

- [Een Oracle-bronverbinding maken met de Flow Service API](../../tutorials/api/create/databases/oracle.md)
...
## [!DNL Oracle] verbinden met [!DNL Platform] gebruikend UI

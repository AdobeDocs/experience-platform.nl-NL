---
keywords: Experience Platform;home;populaire onderwerpen;HP Vertica;hp vertica
...
Adobe Experience Platform biedt native connectiviteit voor databaseproviders, zoals [!DNL Microsoft], MySQL en [!DNL Azure]. U kunt uw gegevens van deze systemen naar [!DNL Platform].
...
In de onderstaande documentatie vindt u informatie over de verbinding [!DNL HP Vertica] tot [!DNL Platform] API&#39;s of de gebruikersinterface gebruiken:

## Verbinden [!DNL HP Vertica] tot [!DNL Platform] gebruiken, API&#39;s
...
## Verbinden [!DNL HP Vertica] tot [!DNL Platform] gebruiken van UI

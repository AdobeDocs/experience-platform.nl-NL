...
topic: overview
description: In de onderstaande documentatie vindt u informatie over hoe u Google BigQuery kunt verbinden met Platform via API's of de gebruikersinterface.

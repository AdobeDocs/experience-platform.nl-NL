...
[!DNL Experience Platform] verleent steun voor het opnemen van gegevens van een derdegegevensbestand. [!DNL Platform] kan verbinding maken met verschillende typen databases, zoals relationeel, NoSQL of data warehouse. Tot de ondersteuning voor databaseproviders behoren [!DNL Azure Table Storage].
...
In de onderstaande documentatie vindt u informatie over het maken van een verbinding [!DNL Azure Table Storage] [!DNL Platform] met API&#39;s of de gebruikersinterface:

## Verbinding maken [!DNL Azure Table Storage] met API&#39; [!DNL Platform] s
...
## Verbinding maken [!DNL Azure Table Storage] met [!DNL Platform] de gebruikersinterface

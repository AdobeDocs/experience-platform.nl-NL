...
| video | advertising.adAssetReference._id | string | Identificatiecode van het advertentie-element. |
...
| videoplayernaam | media.mediaTimed.primaryAssetViewDetails.playerName | string | De naam van de videospeler. |
| videokanaal | media.mediaTimed.primaryAssetViewDetails.broadcastChannel | string | Het videokanaal. |
| videoadplayernaam | advertising.adAssetViewDetails.playerName | string | De naam van de videospeler. |
| videohoofdstuk | media.mediaTimed.mediaChapter.chapterAssetReference._id | string | De naam van het hoofdstuk Video |
...
| videoshow | media.mediaTimed.primaryAssetReference._iptc4xmpExt.Series._iptc4xmpExt.Name | string | Videoshow. |
| videoseizoen | media.mediaTimed.primaryAssetReference._iptc4xmpExt.Season._iptc4xmpExt.Name | string | Videoseizoen. |
| videoaflevering | media.mediaTimed.primaryAssetReference._iptc4xmpExt.episode._iptc4xmpExt.Name | string | Video-aflevering. |
...
| post_cust_hit_time_gmt | timestamp | string | Dit wordt slechts gebruikt in timestamp-Toegelaten datasets. Dit is de tijdstempel die samen met het bestand wordt verzonden, op basis van Unix-tijd. |

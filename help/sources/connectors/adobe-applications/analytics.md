---
title: Adobe Analytics-bronconnector voor rapportsuite-gegevens
...
# Adobe Analytics-bronconnector voor rapportsuite-gegevens
...
| Nieuwe gegevens aan Customer Journey Analytics zonder [&#x200B; stitching &#x200B;](https://experienceleague.adobe.com/docs/analytics-platform/using/stitching/overview.html?lang=nl-NL) | &lt; 3,75 uur |
...
Voor meer informatie over de latentie van Customer Journey Analytics, zie: [&#x200B; Guardrails van Customer Journey Analytics &#x200B;](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-admin/guardrails.html?lang=nl-NL).
...
Als u voor productiesandboxen een licentie hebt verleend voor de extra SKU die u het recht geeft om meer dan 13 maanden historische backfill-gegevens te importeren, neemt u contact op met Adobe om de uitgebreide backfill aan te vragen.

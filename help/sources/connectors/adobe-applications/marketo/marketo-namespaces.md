...
| `TECHNICAL_ACCOUNT_ID` | Een referentie die wordt gebruikt om aan [&#x200B; Adobe Developer Console &#x200B;](https://developer.adobe.com/) te integreren. Voer de onderstaande stappen uit om uw technische account-id op te halen:<ul><li>Navigeer aan [&#x200B; Adobe Developer Console &#x200B;](https://developer.adobe.com/) en open uw project.</li><li>Open de **referentie** die _Rekening van de Dienst (JWT)_ gebruikt. **Nota**: Dit kan als &quot;Onderneming&quot;in oudere UI worden bedoeld.</li><li>De verificatiegegevens moeten uw client-id, technische account-id, organisatie-id en andere JWT-metagegevens weergeven.</li></ul>. | `D42AEVJZTTJC6LZADUBVPA15@techacct.adobe.com` |
...
| `PLATFORM_URL` | Het URL-eindpunt waarnaar u API-aanroepen maakt. Deze waarde is vast en wordt altijd ingesteld op: `platform.adobe.io/` . | `platform.adobe.io/` |

...
## De [!DNL Salesforce] source voor Experience Platform instellen op Azure {#azure}

Volg de onderstaande stappen om te leren hoe u uw [!DNL Salesforce] -account voor Experience Platform op Azure kunt instellen.
...
+++De handleiding voor de variabele tabel weergeven
...
1. Ga naar **[!DNL Manage Connected Apps]**.

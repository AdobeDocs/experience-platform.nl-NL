...
In de onderstaande documentatie vindt u informatie over het tot stand brengen van een verbinding tussen [!DNL ServiceNow] en [!DNL Experience Platform] via API&#39;s of de gebruikersinterface:

## Verbind [!DNL ServiceNow] met [!DNL Experience Platform] gebruikend APIs
...
## Verbind [!DNL ServiceNow] met [!DNL Experience Platform] gebruikend UI

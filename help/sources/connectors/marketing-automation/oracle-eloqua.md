...
Experience Platform biedt ondersteuning voor het opnemen van gegevens van een derde marketingautomatiseringssysteem. Ondersteuning voor marketingautomatiseringsproviders omvat [!DNL Oracle Eloqua] .
...
## Verbinding maken [!DNL Oracle Eloqua] met Experience Platform via API&#39;s

* [Een Oracle Eloqua-basisverbinding maken met de Flow Service API](../../tutorials/api/create/marketing-automation/oracle-eloqua.md)
...
## Verbinding maken [!DNL Oracle Eloqua] met Experience Platform via de gebruikersinterface

* [Een Oracle Eloqua-bronverbinding maken in de gebruikersinterface](../../tutorials/ui/create/marketing-automation/oracle-eloqua.md)

---
title: Uw Source (Streaming SDK) documenteren
...
* [ Instructies bij het begrip van de aroma van de Prijsverhoging van de Adobe ](https://experienceleague.adobe.com/docs/contributor/contributor-guide/writing-essentials/markdown.html#custom-markdown-extensions).
...
U kunt een vooraf ingevuld [ API documentatiesjabloon ](streaming-template-api.md) of het [ UI documentatiemalplaatje ](streaming-template-ui.md) gebruiken om in het creëren van documentatie voor uw bron bij te wonen. Hieronder vindt u instructies voor het bewerken van de sjabloon en het openen van een pull-verzoek. De ingediende documentatie voor uw nieuwe bron zal door het de documentatieteam van de Adobe worden herzien en worden gepubliceerd.

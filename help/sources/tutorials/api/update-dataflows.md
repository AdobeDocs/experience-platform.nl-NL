...
>
>* U kunt de `startTime` van een gegevensstroom niet bijwerken als de oorspronkelijk geplande `startTime` al heeft plaatsgevonden. Deze beperking is van toepassing op zowel ingeschakelde als uitgeschakelde gegevensstromen.

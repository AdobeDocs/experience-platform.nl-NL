...
>[!AVAILABILITY]
>
>* Het vastleggen van wijzigingsgegevens wordt ondersteund voor de volgende bronnen: [!DNL Amazon S3], [!DNL Data Landing Zone], [!DNL Marketo Engage], [!DNL Microsoft Dynamics] en [!DNL Salesforce] .
>
>* U kunt het vastleggen van wijzigingsgegevens ook inschakelen voor [!DNL Amazon S3] - en [!DNL Data Landing Zone] -bronnen wanneer u Adobe Experience Platform gebruikt op Amazon Web Services (AWS) in een VA6-datacenter. Experience Platform op AWS is momenteel beschikbaar voor een beperkt publiek. Voor meer details over infrastructuursteun, zie het [&#x200B; multi-wolkenoverzicht van Experience Platform &#x200B;](../../../landing/multi-cloud.md).

...
Deze zelfstudie behandelt de stappen voor het ophalen van gegevens van een toepassing van een extern protocol en het opnemen ervan in Adobe Experience Platform via bronconnectors en de [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).

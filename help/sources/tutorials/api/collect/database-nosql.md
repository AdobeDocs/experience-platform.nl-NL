...
Opdat de brongegevens in Platform worden gebruikt, moet een doelXDM schema worden gecreeerd om de brongegevens volgens uw behoeften te structureren. Het doelXDM schema wordt dan gebruikt om een dataset van het Platform tot stand te brengen waarin de brongegevens bevat zijn. Dit doel-XDM-schema breidt ook de klasse [!DNL XDM Individual Profile] uit.

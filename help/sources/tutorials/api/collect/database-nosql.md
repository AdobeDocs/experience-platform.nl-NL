...
topic: overview
description: Deze zelfstudie behandelt de stappen voor het ophalen van gegevens uit een database van derden en het opnemen van gegevens in het Platform via bronconnectors en API's.

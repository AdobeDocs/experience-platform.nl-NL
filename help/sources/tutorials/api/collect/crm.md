...
Deze zelfstudie behandelt de stappen voor het ophalen van gegevens van een extern CRM-systeem en het doorvoeren van deze gegevens [!DNL Platform] via bronconnectors en API&#39;s.
...
Om vraag aan Platform APIs te maken, moet u eerst het [authentificatieleerprogramma](../../../../tutorials/authentication.md)voltooien. Het voltooien van de zelfstudie over verificatie biedt de waarden voor elk van de vereiste headers in alle API-aanroepen, zoals hieronder wordt getoond: [!DNL Experience Platform]

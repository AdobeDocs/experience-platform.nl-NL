...
Deze zelfstudie vereist dat u toegang hebt tot een betalingstoepassing via een geldige verbinding, en dat u informatie hebt over het bestand dat u in het Platform wilt plaatsen (inclusief het pad en de structuur van het bestand). Als u deze informatie niet hebt, raadpleegt u de zelfstudie over [het verkennen van een betalingstoepassing met de Flow Service API](../explore/payments.md) voordat u deze zelfstudie probeert.
...
| -------- | ----------- |
| `connectionId` | De unieke verbindings-id van de betalingstoepassing van derden waartoe u toegang hebt. |

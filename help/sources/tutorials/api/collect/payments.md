...
# Maak een gegevensstroom voor betaalbronnen met de opdracht [!DNL Flow Service] API

In deze zelfstudie worden de stappen beschreven voor het ophalen van gegevens van een betalingsbron en het naar Platform brengen van deze gegevens met behulp van [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).

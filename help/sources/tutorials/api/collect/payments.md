...
In deze zelfstudie worden de stappen beschreven voor het ophalen van gegevens van een betalingsbron en het doorsturen van gegevens naar het platform [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).

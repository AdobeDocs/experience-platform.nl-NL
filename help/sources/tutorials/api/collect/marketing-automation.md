...
Een geslaagde reactie retourneert details van de nieuwe toewijzing inclusief de unieke id (`id`). Sla deze waarde op zoals u deze later nodig hebt voor het maken van een gegevensstroom.

...
topic: overview
type: Tutorial
description: Deze zelfstudie gebruikt de Flow Service API om u door de stappen te laten lopen om Experience Platform] aan MariaDB te verbinden.
...
# Een [!DNL MariaDB]-connector maken met de [!DNL Flow Service]-API

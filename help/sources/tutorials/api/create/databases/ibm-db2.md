...
title: Een IBM DB2-bronverbinding maken met de Flow Service API
topic-legacy: overview
type: Tutorial
description: Leer hoe u IBM DB2 met de Flow Service API kunt verbinden.
...
# Een IBM DB2-bronverbinding maken met de API [!DNL Flow Service]
...
Deze zelfstudie gebruikt de [!DNL Flow Service] API om u door de stappen te laten lopen om IBM DB2 (hierna &quot;DB2&quot; genoemd) aan [!DNL Experience Platform] te verbinden.
...
Zie [dit DB2-document](https://www.ibm.com/support/knowledgecenter/SSFMBX/com.ibm.swg.im.dashdb.doc/connecting/connect_credentials.html) voor meer informatie over aan de slag gaan.
...
Om een DB2 verbinding tot stand te brengen, moet zijn unieke identiteitskaart van de verbindingsspecificatie als deel van het verzoek van de POST worden verstrekt. De verbindingsspecificatie-id voor DB2 is `09182899-b429-40c9-a15a-bf3ddbc8ced7`.

...
Als u een basis-verbindings-id wilt maken, vraagt u een POST naar het `/connections` -eindpunt en geeft u de [!DNL Teradata Vantage] -verificatiegegevens op als onderdeel van de aanvraaginstantie.

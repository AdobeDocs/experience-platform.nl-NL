...
Dit leerprogramma begeleidt u door de stappen om een basisverbinding tot stand te brengen voor [!DNL Apache Spark] op [!DNL Azure HDInsights] (hierna &quot;[!DNL Spark]&quot;) gebruiken [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
...
| `username` | De gebruikersnaam die u gebruikt voor toegang [!DNL Spark] Server. |
...
Om een identiteitskaart van de basisverbinding te creëren, doe een verzoek van de POST aan `/connections` als u uw [!DNL Spark] verificatiereferenties als onderdeel van de aanvraagparameters.

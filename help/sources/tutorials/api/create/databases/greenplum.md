...
Als u een basis-verbindings-id wilt maken, vraagt u een POST naar het `/connections` -eindpunt en geeft u de [!DNL GreenPlum] -verificatiegegevens op als onderdeel van de aanvraagparameters.

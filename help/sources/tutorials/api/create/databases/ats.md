...
# Een Azure Table Storage-connector maken met behulp van de Flow Service API
...
Deze zelfstudie gebruikt de Flow Service API om u door de stappen te laten lopen om Azure Table Storage (hierna &quot;ATS&quot; genoemd) te verbinden met Experience Platform.
...
De volgende secties bevatten aanvullende informatie die u moet weten om met succes verbinding te kunnen maken met ATS via de Flow Service API.

### Vereiste referenties verzamelen

Voor de Dienst van de Stroom om met ATS te verbinden, moet u waarden voor de volgende verbindingseigenschappen verstrekken:

...
Om een identiteitskaart van de basisverbinding te creëren, doe een verzoek van de POST aan `/connections` als u uw [!DNL Couchbase] verificatiereferenties als onderdeel van de aanvraagparameters.

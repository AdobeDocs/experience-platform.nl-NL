...
Deze zelfstudie begeleidt u door de stappen om een basisverbinding voor [!DNL Apache Hive] op [!DNL Azure HDInsights] (verder genoemd als &quot;[!DNL Hive]&quot;) tot stand te brengen gebruikend [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).

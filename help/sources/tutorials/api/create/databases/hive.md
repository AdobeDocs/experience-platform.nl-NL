...
# Een Apache Hive maken op Azure HDInsights-connector met de Flow Service API
...
Deze zelfstudie gebruikt de Flow Service API om u door de stappen te laten lopen om Apache Hive op Azure HDInsights aan Experience Platform te koppelen.
...
De volgende secties verstrekken extra informatie die u zult moeten weten om met succes met Hive gebruikend de Dienst API van de Stroom te verbinden.

### Vereiste referenties verzamelen

Voor de Dienst van de Stroom om met Hive te verbinden, moet u waarden voor de volgende verbindingseigenschappen verstrekken:

| Credentials | Beschrijving |
| ---------- | ----------- |
| `host` | IP-adres of hostnaam van de Hive-server. |
...
| `connectionSpec.id` | De unieke id die nodig is om een verbinding te maken. De verbindingsspecificatie-id voor Hive is: `aac9bbd4-6c01-46ce-b47e-51c6f0f6db3f` |
...
Om een verbinding van de Hive tot stand te brengen, moet zijn unieke identiteitskaart van de verbindingsspecificatie als deel van het POST- verzoek worden verstrekt. De verbindingsspecificatie-id voor Hive is `aac9bbd4-6c01-46ce-b47e-51c6f0f6db3f`.
...
| --------- | ----------- |
| `auth.params.connectionString` | De verbindingstekenreeks die aan uw Hive-account is gekoppeld. |
| `connectionSpec.id` | De specificatie-id van de Hive-verbinding: `aac9bbd4-6c01-46ce-b47e-51c6f0f6db3f`. |
...
Aan de hand van deze zelfstudie hebt u een Hive-verbinding gemaakt met de Flow Service API en hebt u de unieke id-waarde van de verbinding verkregen. U kunt deze id in de volgende zelfstudie gebruiken terwijl u leert hoe u databases kunt [verkennen met behulp van de Flow Service API](../../explore/database-nosql.md).

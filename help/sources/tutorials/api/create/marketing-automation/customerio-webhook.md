...
## Verbinding maken met Experience Platform via de [!DNL Flow Service] API[!DNL Customer.io] {#connect-platform-to-flow-api}

In het volgende voorbeeld worden de stappen beschreven die u moet uitvoeren om een bronverbinding en een gegevensstroom te maken om uw [!DNL Customer.io] gebeurtenisgegevens naar Experience Platform te brengen.
...
De laatste stap naar het verzenden van gegevens van [!DNL Customer.io] naar Experience Platform is het maken van een gegevensstroom. Momenteel zijn de volgende vereiste waarden voorbereid:

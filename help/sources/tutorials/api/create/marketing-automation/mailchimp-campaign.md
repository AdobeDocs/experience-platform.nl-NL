...
Het volgende leerprogramma begeleidt u door de stappen om een bronverbinding en een dataflow tot stand te brengen om [!DNL Mailchimp Campaign] gegevens aan Platform te brengen gebruikend [[!DNL Flow Service]  API ](https://www.adobe.io/experience-platform-apis/references/flow-service/).
...
Nadat u de verificatiereferenties van [!DNL Mailchimp] hebt opgehaald, kunt u nu beginnen met het maken van een gegevensstroom om [!DNL Mailchimp Campaign] -gegevens naar het platform te brengen. De eerste stap bij het maken van een gegevensstroom is het maken van een basisverbinding.

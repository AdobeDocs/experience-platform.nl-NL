...
# Een [!DNL Shopify] aansluiting maken met de [!DNL Flow Service] API
...
Deze zelfstudie gebruikt de [[!DNL Flow Service]](https://www.adobe.io/apis/experienceplatform/home/api-reference.html#!acpdr/swagger-specs/flow-service.yaml) API om u door de stappen te laten lopen waarmee u verbinding [!DNL Shopify] kunt maken [!DNL Experience Platform].
...
In de volgende secties vindt u aanvullende informatie die u nodig hebt om verbinding te kunnen maken met [!DNL Shopify] [!DNL Flow Service] de API.

### Vereiste referenties verzamelen

Als u verbinding wilt [!DNL Flow Service] maken met [!DNL Shopify], moet u waarden opgeven voor de volgende verbindingseigenschappen:
...
Raadpleeg dit [Shopify-verificatiedocument](https://shopify.dev/concepts/about-apis/authentication)voor meer informatie over aan de slag gaan.
...
Een verbinding specificeert een bron en bevat uw geloofsbrieven voor die bron. Er is slechts één verbinding per [!DNL Shopify] account vereist, omdat deze kan worden gebruikt om meerdere bronconnectors te maken voor het inbrengen van verschillende gegevens.
...
Om een [!DNL Shopify] verbinding tot stand te brengen, moet zijn unieke identiteitskaart van de verbindingsspecificatie als deel van het verzoek van de POST worden verstrekt. De verbindingsspecificatie-id voor [!DNL OData] is `4f63aa36-bd48-4e33-bb83-49fbcd11c708`.
...
| `connectionSpec.id` | De id van de [!DNL Shopify] verbindingsspecificatie: `4f63aa36-bd48-4e33-bb83-49fbcd11c708`. |
...
Aan de hand van deze zelfstudie hebt u een [!DNL Shopify] verbinding gemaakt met de [!DNL Flow Service] API en hebt u de unieke id-waarde van de verbinding verkregen. U kunt deze id gebruiken in de volgende zelfstudie als u leert hoe u eCommerce-verbindingen kunt [verkennen met behulp van de Flow Service API](../../explore/ecommerce.md).
...
Als u een basis-verbindings-id wilt maken, vraagt u een POST-aanvraag naar het `/connections` -eindpunt en geeft u de [!DNL Zoho CRM] -verificatiegegevens op als onderdeel van de aanvraagparameters.

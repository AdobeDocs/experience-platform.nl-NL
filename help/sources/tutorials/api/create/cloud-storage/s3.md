...
| -------- | ----------- |
| `auth.params.s3AccessKey` | De toegangssleutel verbonden aan uw [!DNL S3] emmertje. |
| `auth.params.s3SecretKey` | Uw geheime sleutel verbonden aan uw [!DNL S3] emmertje. |
| `connectionSpec.id` | De [!DNL S3] ID van de verbindingsspecificatie: `ecadc60c-7455-4d87-84dc-2a0e293d997b` |

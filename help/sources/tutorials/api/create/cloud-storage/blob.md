...
In deze zelfstudie wordt de [!DNL Flow Service]-API gebruikt om u door de stappen te laten lopen om [!DNL Experience Platform] te verbinden met een [!DNL Azure Blob]-opslag (hierna &quot;Blob&quot; genoemd).

Als u liever de gebruikersinterface in [!DNL Experience Platform] wilt gebruiken, biedt de [UI-zelfstudie ](../../../ui/create/cloud-storage/blob.md) van de bronconnector van Azure Blob stapsgewijze instructies voor het uitvoeren van vergelijkbare acties.
...
De volgende secties bevatten aanvullende informatie die u nodig hebt om een verbinding met een blob-opslag met de API [!DNL Flow Service] tot stand te brengen.

### Vereiste referenties verzamelen

Als u [!DNL Flow Service] wilt laten verbinden met de blob-opslag, moet u waarden opgeven voor de volgende verbindingseigenschap:

...
# (bèta) Een gegevensstroom maken voor een [!DNL OneTrust Integration] bron die de [!DNL Flow Service] API
...
| `auth.params.` | Bevat de geloofsbrieven die worden vereist om uw bron voor authentiek te verklaren. De hoofdhost en het toegangstoken voor verbinding met de API. |
| `auth.params.host` | Het milieu waarvan [!DNL OneTrust Integration] gegevens moeten worden opgehaald. |

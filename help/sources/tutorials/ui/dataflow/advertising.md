---
keywords: Experience Platform;home;populaire onderwerpen;configureren, gegevensstroom;advertentieaansluiting
solution: Experience Platform
title: Een gegevensstroom maken met een Advertising Source in de gebruikersinterface
type: Tutorial
description: Een dataflow is een geplande taak die gegevens van een bron aan een dataset van Experience Platform terugwint en opneemt. Deze zelfstudie bevat stappen voor het maken van een gegevensstroom voor een advertentiebron met behulp van de gebruikersinterface van Experience Platform.
...
# Een gegevensstroom maken met een advertentiebron in de gebruikersinterface

Een dataflow is een geplande taak die gegevens van een bron aan een dataset in Adobe Experience Platform terugwint en opneemt. Deze zelfstudie bevat stappen voor het maken van een gegevensstroom voor een advertentiebron met de gebruikersinterface van Experience Platform.

>[!NOTE]
>
>* Als u een gegevensstroom wilt maken, moet u al over een geverifieerd account bij een advertentiebron beschikken. Een lijst van leerprogramma&#39;s voor het creëren van verschillende reclame bronrekeningen in UI kan in het [ overzicht van bronnen ](../../../home.md#advertising) worden gevonden.
...
Na het maken van uw advertentiebronaccount wordt de stap **[!UICONTROL Add data]** weergegeven, waarmee u een interface hebt om de tabelhiërarchie van uw advertentiebronaccount te verkennen.

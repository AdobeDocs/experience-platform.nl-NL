...
Bovendien moet u voor deze zelfstudie al een advertentieaccount hebben gemaakt. Een lijst met zelfstudies voor het maken van verschillende betalingsconnectors in de gebruikersinterface vindt u in het [overzicht van bronconnectors](../../../home.md).

## Gegevens selecteren

Nadat u uw advertentieaccount hebt gemaakt, wordt de stap **[!UICONTROL Gegevens selecteren]** weergegeven en krijgt u een interactieve interface om de bestandshiërarchie te verkennen.
...
Het dialoogvenster **[!UICONTROL Selecteer schema]** wordt weergegeven. Selecteer het schema u wenst om op de nieuwe dataset toe te passen, dan klik **[!DNL Done]**.

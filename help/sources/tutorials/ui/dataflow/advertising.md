...
Een gegevensstroom is een geplande taak die gegevens van een bron aan een dataset van het Platform van de Ervaring van Adobe terugwint en opneemt. Deze zelfstudie bevat stappen voor het configureren van een nieuwe gegevensstroom met uw advertentieaccount.

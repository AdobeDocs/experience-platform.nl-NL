...
description: Deze zelfstudie bevat stappen voor het maken van een gegevensstroom voor een analysebron met behulp van de gebruikersinterface van Experience Platform.
...
Een dataflow is een geplande taak die gegevens van een bron aan een dataset in Adobe Experience Platform terugwint en opneemt. Deze zelfstudie bevat stappen voor het maken van een gegevensstroom voor een analysebron met de gebruikersinterface van Experience Platform.

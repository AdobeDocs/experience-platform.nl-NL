...
| Achtergrond | Een booleaanse waarde die bepaalt welke gegevens eerst worden ingevoerd. Als **[!UICONTROL Backfill]** wordt toegelaten, zullen alle huidige dossiers in de gespecificeerde weg tijdens de eerste geplande opname worden opgenomen. Als **[!UICONTROL Backfill]** is uitgeschakeld, worden alleen de bestanden opgenomen die worden geladen tussen de eerste opname en de **[!UICONTROL Starttijd]**. Bestanden die vóór **[!UICONTROL Begintijd]** zijn geladen, worden niet opgenomen. |

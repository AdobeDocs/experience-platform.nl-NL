...
Nadat u uw CRM-bronaccount hebt gemaakt, wordt de stap **[!UICONTROL Add data]** weergegeven, waarmee u een interface hebt waarmee u de tabelhiërarchie van uw CRM-account kunt verkennen.

...
title: Creeer een Gegevensstroom Gebruikend een Bron van de Automatisering van de Marketing in UI
topic-legacy: overview
type: Tutorial
description: Een dataflow is een geplande taak die gegevens van een bron aan een dataset van de Platform terugwint en opneemt. Deze zelfstudie bevat stappen voor het maken van een gegevensstroom voor een marketingautomatiseringsbron met behulp van de gebruikersinterface van het Platform.
...
# Een gegevensstroom maken met behulp van een marketingautomatiseringsbron in de gebruikersinterface

Een dataflow is een geplande taak die gegevens van een bron aan een dataset in Adobe Experience Platform terugwint en opneemt. Deze zelfstudie bevat stappen voor het maken van een gegevensstroom voor een marketingautomatiseringsbron met behulp van de interface van het Platform.
...
Nadat u uw bronaccount voor marketingautomatisering hebt gemaakt, kunt u **[!UICONTROL Add data]** De stap verschijnt, die een interface voor u verstrekken om de de lijsthiërarchie van uw van de bron van de marketing automatisering van de rekening te onderzoeken.
...
Door deze zelfstudie te volgen, hebt u een gegevensstroom gemaakt om gegevens van uw marketingautomatiseringsbron naar het Platform te brengen. Binnenkomende gegevens kunnen nu door downstreamgebruikers worden gebruikt [!DNL Platform] diensten zoals [!DNL Real-time Customer Profile] en [!DNL Data Science Workspace]. Raadpleeg de volgende documenten voor meer informatie:

...
Door deze zelfstudie te volgen, hebt u een gegevensstroom gemaakt om gegevens van uw marketingautomatiseringsbron naar Platform te brengen. Binnenkomende gegevens kunnen nu door downstreamgebruikers worden gebruikt [!DNL Platform] diensten zoals [!DNL Real-Time Customer Profile] en [!DNL Data Science Workspace]. Raadpleeg de volgende documenten voor meer informatie:

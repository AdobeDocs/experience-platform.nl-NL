...
Bovendien is het voor deze zelfstudie nodig dat u al een databaseaccount hebt gemaakt. Een lijst met zelfstudies voor het maken van verschillende databaseverbindingen in de gebruikersinterface vindt u in het dialoogvenster [overzicht van bronconnectors](../../../home.md).

## Gegevens toevoegen

Nadat u uw databaseaccount hebt gemaakt, **[!UICONTROL Add data]** stap wordt weergegeven en biedt een interactieve interface waarmee u de databasehiërarchie kunt verkennen.
...
De *Toewijzing* stap verschijnt, verstrekkend een interactieve interface om de brongegevens aan een dataset van het Platform in kaart te brengen.
...
Om gegevens in een bestaande dataset in te voeren, selecteer **[!UICONTROL Existing dataset]** klikt u op het pictogram van de gegevensset.
...
Binnen de **[!UICONTROL Sources]** werkruimte, selecteert u de **[!UICONTROL Dataflows]** tab. Selecteer vervolgens de gegevensstroom die u wilt uitschakelen.

![](../../../images/tutorials/dataflow/databases/list-of-dataflows.png)

De **[!UICONTROL Properties]** wordt aan de rechterkant van het scherm weergegeven, inclusief een **[!UICONTROL Enabled]** schakelknop. Selecteer de schakeloptie om de gegevensstroom uit te schakelen. Dezelfde schakeloptie kan worden gebruikt om een gegevensstroom opnieuw in te schakelen nadat deze is uitgeschakeld.

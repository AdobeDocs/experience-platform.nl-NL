...
Nadat u het bronaccount voor uw toestemming en voorkeuren hebt gemaakt, kunt u **[!UICONTROL Add data]** De stap verschijnt, die een interface voor u verstrekt om de de lijsthiërarchie van uw toestemming en van de voorkeur rekening te onderzoeken.
...
Door deze zelfstudie te volgen, hebt u een gegevensstroom gemaakt om gegevens van uw toestemmings- en voorkeursbron naar Platform te brengen. Binnenkomende gegevens kunnen nu door downstreamgebruikers worden gebruikt [!DNL Platform] diensten zoals [!DNL Real-Time Customer Profile] en [!DNL Data Science Workspace]. Raadpleeg de volgende documenten voor meer informatie:

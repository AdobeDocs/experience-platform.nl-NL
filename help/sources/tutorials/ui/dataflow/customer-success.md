...
Binnen de *[!UICONTROL Bronwerkruimte]* , selecteer de bron van het klantensucces u wenst om onder de categorie van het Succes *[!UICONTROL van de]* Klant te bekijken. Selecteer *[!UICONTROL Connect-bron]* om de verificatieinterface te starten. Als u een bestaande gegevensstroom wilt weergeven, selecteert u *[!UICONTROL Bestaande account]* en selecteert u de account die u wilt openen.

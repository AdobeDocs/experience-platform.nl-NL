...
title: Vorm een Dataflow voor een Verbinding van de Bron van de eCommerce in UI
topic-legacy: overview
type: Tutorial
description: Een dataflow is een geplande taak die gegevens van een bron aan een bron terugwint en opneemt [!DNL Platform] dataset. Deze zelfstudie biedt stappen om een nieuwe gegevensstroom te configureren met behulp van uw eCommerce-account.
...
# Een gegevensstroom configureren voor een eCommerce-verbinding in de gebruikersinterface

Een dataflow is een geplande taak die gegevens van een bron aan een bron terugwint en opneemt [!DNL Platform] dataset. Deze zelfstudie biedt stappen om een nieuwe gegevensstroom te configureren met behulp van uw **[!UICONTROL eCommerce]** account.
...
Voor deze zelfstudie is bovendien vereist dat u al een **[!UICONTROL eCommerce]** account. Een lijst met zelfstudies voor het maken van verschillende **[!UICONTROL eCommerce]** connectors in de gebruikersinterface zijn te vinden in de [overzicht van bronconnectors](../../../home.md).

## Gegevens selecteren

Nadat u uw **[!UICONTROL eCommerce]** de **[!UICONTROL Select data]** wordt weergegeven met een interactieve interface waarmee u de bestandshiërarchie kunt verkennen.
...
Door deze zelfstudie te volgen, hebt u een gegevensstroom gemaakt die u wilt gebruiken **[!UICONTROL eCommerce]** gegevens en heeft inzicht gekregen in de gegevenscontroles. Binnenkomende gegevens kunnen nu door downstreamgebruikers worden gebruikt [!DNL Platform] diensten zoals [!DNL Real-time Customer Profile] en [!DNL Data Science Workspace]. Raadpleeg de volgende documenten voor meer informatie:

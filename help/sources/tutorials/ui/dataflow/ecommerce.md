...
title: Vorm een dataflow voor een schakelaar eCommerce in UI
topic: overview
type: Tutorial
description: Een dataflow is een geplande taak die gegevens van een bron aan [!DNL Platform] adataset terugwint en opneemt. Deze zelfstudie biedt stappen om een nieuwe gegevensstroom te configureren met behulp van uw eCommerce-account.
...
# Vorm een dataflow voor een schakelaar eCommerce in UI

Een dataflow is een geplande taak die gegevens van een bron aan een [!DNL Platform] dataset terugwint en opneemt. Deze zelfstudie biedt stappen om een nieuwe gegevensstroom te configureren met behulp van uw **[!UICONTROL eCommerce]** -account.
...
Bovendien vereist deze zelfstudie dat u al een **[!UICONTROL eCommerce]** -account hebt gemaakt. Een lijst van leerprogramma&#39;s voor het creëren van verschillende **[!UICONTROL eCommerce]** schakelaars in UI kan in het overzicht [van](../../../home.md)bronschakelaars worden gevonden.

## Gegevens selecteren

Nadat u uw **[!UICONTROL eCommerce]** -account hebt gemaakt, wordt de stap Gegevens **** selecteren weergegeven en krijgt u een interactieve interface om de bestandshiërarchie te verkennen.
...
Wanneer u de brongegevens hebt gevonden, selecteert u de map en selecteert u **[!UICONTROL Volgende]**.
...
![revisie](../../../images/tutorials/dataflow/ecommerce/review.png)
...
Door deze zelfstudie te volgen, hebt u met succes een dataflow gecreeerd om gegevens van de **[!UICONTROL Handel]** in te brengen en inzicht verworven in de controles van datasets. Inkomende gegevens kunnen nu worden gebruikt door downstreamdiensten [!DNL Platform] zoals [!DNL Real-time Customer Profile] en [!DNL Data Science Workspace]. Raadpleeg de volgende documenten voor meer informatie:

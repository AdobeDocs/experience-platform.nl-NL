...
# Een gegevensstroom configureren voor een betalingsconnector in de gebruikersinterface

Een gegevensstroom is een geplande taak die gegevens van een bron aan een dataset van het Platform van de Ervaring van Adobe terugwint en opneemt. Deze zelfstudie bevat stappen voor het configureren van een nieuwe gegevensstroom met uw betaalaccount.
...
Bovendien moet u voor deze zelfstudie al een betaalaccount hebben gemaakt. Een lijst van leerprogramma&#39;s voor het creëren van verschillende betalingsschakelaars in UI kan in het overzicht [van](../../../home.md)bronschakelaars worden gevonden.

## Gegevens selecteren

Nadat u uw betaalaccount hebt gemaakt, wordt de stap Gegevens ** selecteren weergegeven. Deze stap bevat een interactieve interface waarmee u de bestandshiërarchie kunt verkennen.
...
Selecteer de directory die u wilt gebruiken en selecteer vervolgens **Volgende**.
...
In het scherm *Toewijzing* kunt u ook de *Delta-kolom* instellen. Wanneer de datasetstroom wordt gecreeerd, kunt u om het even welk tijdstempelgebied als basis plaatsen om te beslissen welke verslagen in geplande stijgende ingestities moeten worden opgenomen.
...
De stap met de details *van de* Dataset-stroom wordt weergegeven. Hier moet u een naam en een optionele beschrijving opgeven voor de gegevenssetstroom. Selecteer **Volgende** als u klaar bent.

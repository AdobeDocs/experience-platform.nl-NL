...
Bovendien moet u voor deze zelfstudie al een betaalaccount hebben gemaakt. Een lijst met zelfstudies voor het maken van verschillende betalingsconnectors in de gebruikersinterface vindt u in de [overzicht van bronconnectors](../../../home.md).

## Gegevens selecteren

Nadat u uw betaalrekening hebt gemaakt, **[!UICONTROL Select data]** wordt weergegeven met een interactieve interface waarmee u de bestandshiërarchie kunt verkennen.

...
Deze zelfstudie bevat stappen voor het maken van een [!DNL Square] bronconnector met behulp van de gebruikersinterface van Platform.
...
Als u toegang wilt krijgen tot uw [!DNL Square] accountplatform, moet u de volgende waarden opgeven:
...
Nadat u de vereiste gegevens hebt verzameld, voert u de onderstaande stappen uit om uw [!DNL Square] -account te koppelen aan Platform.
...
Aan de hand van deze zelfstudie hebt u een bronverbinding tussen uw [!DNL Square] -account en Platform geverifieerd en gemaakt. U kunt nu aan het volgende leerprogramma verdergaan en [ een dataflow creëren om betalingsgegevens in Platform ](../../dataflow/payments.md) te brengen.

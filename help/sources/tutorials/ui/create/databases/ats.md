...
Nadat u de vereiste gegevens hebt verzameld, voert u de onderstaande stappen uit om een nieuwe ATS-account te maken waarmee u verbinding kunt maken [!DNL Platform].
...
Selecteer **[!UICONTROL Nieuw account]** als u nieuwe referenties gebruikt. Geef in het invoerformulier dat wordt weergegeven, de verbinding een naam, een optionele beschrijving en uw ATS-referenties. Als u klaar bent, selecteert u **[!UICONTROL Connect]** en laat u de nieuwe account enige tijd beginnen.

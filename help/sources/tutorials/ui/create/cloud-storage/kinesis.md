...
Meld u aan bij [Adobe Experience Platform](https://platform.adobe.com) en selecteer vervolgens **[!UICONTROL Bronnen]** in de linkernavigatiebalk voor toegang tot de werkruimte *Bronnen* . Op het tabblad *Catalogus* worden diverse bronnen weergegeven waarmee u verbinding kunt maken [!DNL Platform]. Elke bron toont het aantal bestaande rekeningen verbonden aan hen.

Selecteer in de categorie *[!UICONTROL Cloud Storage]* de optie **[!UICONTROL Amazon Kinesis]** gevolgd door Gegevens **** toevoegen om een nieuwe [!DNL Kinesis] aansluiting te maken.

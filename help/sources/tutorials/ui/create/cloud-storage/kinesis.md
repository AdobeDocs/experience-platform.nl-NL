...
Selecteer **[!UICONTROL Amazon Kinesis]** onder de categorie **[!UICONTROL Cloud Storage]**. Als dit uw eerste keer gebruikend deze schakelaar is, uitgezocht **[!UICONTROL vorm]**. Anders, uitgezocht **[!UICONTROL voeg gegevens]** toe om een nieuwe [!DNL Kinesis] schakelaar tot stand te brengen.
...
Als u nieuwe geloofsbrieven gebruikt, selecteer **[!UICONTROL Nieuwe Rekening]**. Geef in het invoerformulier dat wordt weergegeven een naam, een optionele beschrijving en uw [!DNL Kinesis]-referenties op. Selecteer **[!UICONTROL Connect]** als u klaar bent en wacht dan enige tijd tot de nieuwe verbinding tot stand is gebracht.

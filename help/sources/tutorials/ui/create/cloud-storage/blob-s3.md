...
De bronschakelaars in Adobe Experience Platform verstrekken de capaciteit om van buitenaf afkomstige gegevens op een geplande basis in te voeren. Deze zelfstudie biedt stappen voor het maken van een [!DNL Azure Blob] (hierna &quot;Blob&quot; genoemd) of [!DNL Amazon] S3 (hierna &quot;S3&quot; genoemd) bronconnector met behulp van de [!DNL Platform] gebruikersinterface.
...
Op dezelfde manier om tot uw S3 emmer toegang te hebben [!DNL Platform] vereist u om uw geldige waarden voor de volgende geloofsbrieven te verstrekken:
...
Nadat u de vereiste gegevens hebt verzameld, voert u de onderstaande stappen uit om een nieuwe Blob- of S3-account te maken waarmee u verbinding kunt maken [!DNL Platform].
...
Selecteer onder de categorie *[!UICONTROL Databases]* de optie **[!UICONTROL Azure Blob Storage]** of **[!UICONTROL Amazon S3]** en klik **op het plus-pictogram (+)** om een nieuwe [!DNL Blob] of S3-connector te maken.
...
Selecteer **[!UICONTROL Nieuw account]** als u nieuwe referenties gebruikt. Geef in het invoerformulier dat wordt weergegeven, de verbinding een naam, een optionele beschrijving en uw [!DNL Blob] of S3-referenties. Als u klaar bent, selecteert u **[!UICONTROL Connect]** en laat u de nieuwe account enige tijd beginnen.

![verbinden](../../../../images/tutorials/create/blob/new.png)

### Bestaande account

Als u een bestaande account wilt verbinden, selecteert u de [!DNL Blob] of S3-account waarmee u verbinding wilt maken en selecteert u **[!UICONTROL Volgende]** om door te gaan.

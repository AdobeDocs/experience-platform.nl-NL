---
title: Batchgegevens vanuit Kobie in Experience Platform invoegen met behulp van de gebruikersinterface
description: Leer hoe u met de gebruikersinterface batchgegevens van Kobie in Adobe Experience Platform kunt opnemen.
badge: Beta
hide: true
hidefromtoc: true
...
# Batchgegevens vanuit [!DNL Kobie] in Experience Platform opnemen met de gebruikersinterface

Lees deze zelfstudie om te leren hoe u batchgegevens van uw [!DNL Kobie] -account in Adobe Experience Platform kunt invoeren met de werkruimte voor bronnen in de gebruikersinterface.
...
Als u gegevens uit [!DNL Kobie] wilt invoeren, selecteert u de **[!UICONTROL Kobie Batch Source Connector]** bronkaart onder *[!UICONTROL Loyalty]* en selecteert u vervolgens **[!UICONTROL Add data]** .
...
Als u een nieuwe account voor uw [!DNL Kobie] -bron wilt maken, selecteert u **[!UICONTROL New account]** en geeft u een naam en een optionele beschrijving voor uw account op. Geef vervolgens uw [!DNL Kobie] -domein en uw [!UICONTROL Kobie Management API Key] op. Als u klaar bent, selecteert u **[!UICONTROL Connect to source]** en laat u de verbinding enkele ogenblikken tot stand brengen.



### Een bestaande account gebruiken

Als u een bestaande account wilt gebruiken, selecteert u **[!UICONTROL Existing account]** en selecteert u de [!DNL Kobie] -account die u wilt gebruiken in de accountinterface.
...
>[!IMPORTANT]
>
>Lees voor meer informatie over het toewijzen van [!DNL Kobie] -brongegevens het [[!DNL Kobie] overzicht]

...
Selecteer **[!DNL Demandbase Intent]** onder de categorie *[!UICONTROL B2B]* en selecteer vervolgens **[!UICONTROL Set up]** .
...
>title="Domeinbron"
>abstract="Terwijl Adobe de XDM accountOrganization.website gebruikt, kunnen er klanten zijn die aangepaste velden gebruiken voor hun respectievelijke websites. Daarom moet u ervoor zorgen dat uw domeinbron het domein/website gebied is dat uw verslagen van de de rekeningsrekening van de Vraag tegen Experience Platform rekeningen zal aanpassen."

## Dataflow plannen {#schedule-dataflow}

>[!CONTEXTUALHELP]
>id="platform_sources_demandbase_schedule"
>title="Uw gegevensstroom plannen"
>abstract="Demandbase laat gegevens eenmaal per week vallen op maandagochtend om 17:00 uur UTC. Daarom moet u uw tijd van het innamebegin na UTC 5:00PM vormen. Bovendien moet u de innametijd met Demandbase bevestigen aangezien zij hun programma kunnen veranderen, wanneer het laten vallen van dossiers aan Adobe."

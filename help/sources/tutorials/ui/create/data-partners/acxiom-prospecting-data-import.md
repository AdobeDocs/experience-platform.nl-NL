...
* **Interval**: Zodra u een frequentie selecteert, kunt u het interval dan vormen die het tijdkader tussen elke opname plaatsen te vestigen. Bijvoorbeeld, als u uw frequentie aan dag plaatst en het interval aan 15 vormt, dan zal uw dataflow om de 15 dagen lopen. Interval kan niet op nul worden ingesteld en moet op ten minste 15 worden ingesteld.
* **Tijd van het Begin** - timestamp voor de geprojecteerde looppas, die in UTC tijdzone wordt voorgesteld.

...
description: Leer hoe u door bronobjecten zoals accounts en gegevensstromen in de gebruikersinterface van Experience Platform kunt navigeren.
hide: true
hidefromtoc: true
...
Het is handig om inzicht te krijgen in de volgende Experience Platform-functies en -concepten voordat u gaat werken met de objectnavigatiegereedschappen in de werkruimte Bronnen:
...
* [&#x200B; Administratieve Markeringen &#x200B;](../../../administrative-tags/overview.md): Gebruik administratieve markeringen om meta-gegevenssleutelwoorden op uw voorwerpen toe te passen en onderzoek toe te laten om dat voorwerp binnen het ecosysteem van Experience Platform te vinden.
...
Selecteer in de gebruikersinterface van Experience Platform [!UICONTROL Sources] in de linkernavigatie en selecteer vervolgens **[!UICONTROL Accounts]** in de bovenste koptekst. U kunt uw bronrekeningen filtreren die op de bron worden gebaseerd dat zij met of de gebruiker werden gecreeerd die hen creeerde.
...
Door dit document te lezen hebt u geleerd hoe u door de pagina&#39;s met bronaccounts en gegevensstromen kunt navigeren. Voor meer informatie over bronnen leest u het [overzicht van bronnen](../../home.md).

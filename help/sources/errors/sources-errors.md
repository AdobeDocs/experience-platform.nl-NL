...
| `1001-401` | Onbevoegd | De gebruiker is niet geautoriseerd. Neem contact op met uw beheerder om toegang te krijgen tot de bron. |
...
| `1014-400` | Ongeldig argument voor verzoek | Het verzoek kan niet worden verwerkt. {detailsMessage} |

## Framework-fouten

| Foutcode | Titel | Gedetailleerd bericht |
| --- | --- | --- |
| `1100-400` | Ongeldig verzoek | Het verzoek kan niet worden verwerkt. {detailsMessage} |
...
| `1102-404` | Bron niet gevonden | De gevraagde bron is niet gevonden. {detailsMessage} |
...
| `1105-401` | Onbevoegd | De gebruiker is niet geautoriseerd. {detailsMessage} |
| `1106-403` | Verboden | De gewenste bewerking is niet toegestaan. {detailsMessage} |
| `1107-412` | Voorwaarde is mislukt | Aan de voorwaarde die wordt gedefinieerd door de headers if-Unmodified-Since of if-None-Match is niet voldaan. {detailsMessage} |
...
| `1202-400` | Ongeldig verzoek | publicKeyId ontbreekt in de transformations={transformations} van de stroom. Geef een publicKeyId op in het verzoek en probeer het opnieuw. |
| `1203-400` | Ongeldig verzoek | De coderingssleutel bestaat niet tegen keyID={keyID} in de transformations={transformations} van de flow. Controleer de opgegeven keyID en probeer het opnieuw. |
...
| Foutcode | Titel | Gedetailleerd bericht |
| --- | --- | --- |
| `1300-400` | Ongeldig verzoek | De aanvraag voor een patchverbinding wordt niet ondersteund voor de connector {connectorType}. Controleer het opgegeven verzoek en probeer het opnieuw. |
...
| `1302-400` | Ongeldig verzoek | Het opgegeven verificatietype = {authType} wordt niet ondersteund voor connector={connectorType}. Gelieve te verstrekken een geldig autentype voor de bepaalde schakelaar. |
...
| `1304-400` | Ongeldig verzoek | Het verplichte veld {field} is niet opgegeven. Geef het veld {field} op en probeer het opnieuw. |
...
| `1307-400` | Ongeldig verzoek | De specificatie-id van de doelverbinding is niet geldig={targetConnectionSpecId}. De toegestane waarde is: `c604ff05-7f1a-43c0-8e18-33bf874cb11c`. |
...
| 1312-400 | Ongeldig verzoek | De opgegeven parameterwaarde {paramValue} is geen geldige invoer voor property={requestParam}. Geef een geldige parameterwaarde op en probeer het opnieuw. |
...
| `1318-400` | Ongeldig verzoek | {gecombineerdeMessage}. Controleer het opgegeven verzoek en probeer het opnieuw. |
| `1319-400` | Ongeldig verzoek | De {param} moet onderdeel zijn van de bovenliggende verzameling. Geef {param} op in de bovenliggende verzameling en probeer het opnieuw. |
| `1320-400` | Ongeldig verzoek | De waarde {idType} mag niet null of leeg zijn. Geef een geldig {idType} op en probeer het opnieuw. |
...
| `1323-400` | Ongeldig verzoek | De {entity} mag niet null of leeg zijn in de bronverbinding: {sourceConnection}. Geef een geldige {entity} op en probeer het opnieuw. |
...
| `1325-400` | Ongeldig verzoek | De parameter dataSetId mag niet null of leeg zijn in de doelverbinding: {TargetConnection}. Geef een geldige param voor gegevenssetId op en probeer het opnieuw. |
...
| `1327-400` | Ongeldig verzoek | De indeling van de verschafte brongegevens={sourceFormat} in SourceConnection wordt niet ondersteund. De toegestane waarden zijn: {values}. Geef toegestane waarden op en probeer het opnieuw. |
...
| `1329-400` | Ongeldig verzoek | De parameter: {param} mag niet null of leeg zijn in de opgegeven aanvraag. Geef een geldige {param} op en probeer het opnieuw. |
...
| `1332-400` | Ongeldig verzoek | Het bronverbindingsverzoek met connectionSpecId: {connectionSpecId} kan geen baseConnectionId hebben. Verwijder de baseConnectionId en probeer het opnieuw. |
| `1333-400` | Onjuiste aanvragen | De flowRunAction={flowRunAction} wordt niet ondersteund voor een bron met spec id={specId}. Voer een geldige handeling voor het uitvoeren van de flow in en probeer het opnieuw. |
| `1334-400` | Ongeldig verzoek | De vraagparam: {param} mag niet leeg zijn. Geef een geldige {param} op en probeer het opnieuw. |
...
| `1336-400` | Ongeldig verzoek | Verbinding verkennen wordt niet ondersteund voor specificatie-id van verbinding: {connectionSpecId}. Geef de ondersteunde verbindingsspecificatie-id op en probeer het opnieuw. |
| `1337-400` | Ongeldig verzoek | {QueryParam} mag niet leeg zijn voor objectType={objectType}. Geef geldige {QueryParam} op en probeer het opnieuw. |
| `1338-400` | Ongeldig verzoek | De verbindings-id {connectionType} mag niet null zijn in flowRequest. Geef een geldige {connectionType}-verbinding-id op in flowRequest. |
| `1339-400` | Ongeldig verzoek | De indeling van de organisatie={imsOrg} in de aanvraag is ongeldig. Geef een geldige organisatie-id op en probeer het opnieuw. |
...
| `1345-400` | Ongeldig verzoek | Definities ontbreken in 1 of meer segmenten in paden: &#39;dls:partitieSpec/dls:fileFormat&#39;, &#39;dls:partitieSpec/dls:partitieTemplate&#39;,&#39;dls:partitieSpec/dls:fileFormat/@type&#39;, &#39;dls:partitieSpec/dls:fileFormat/dls:csvDelimiters&#39; in &#39;odi.json&#39;. Geef de juiste definities op in &#39;odi.json&#39; en probeer het opnieuw. |
...
| `1347-400` | Ongeldig verzoek | De definitie dls:csvDelimiters&#39; in &#39;odi.json&#39; wordt niet ondersteund. De ondersteunde csvDelimiters zijn: [&#39;,&#39;]. Geef de juiste definities op in &#39;odi.json&#39; en probeer het opnieuw. |
...
| `1353-400` | Ongeldig verzoek | Het filter bij de bron wordt nog niet ondersteund voor de {connectorType} -connector. Controleer de ondersteunde connectors in de documentatie: https://experienceleague.adobe.com/docs/experience-platform/sources/api-tutorials/filter.html. |
...
| `1359-400` | Ongeldig verzoek | De param {param} ontbreekt in de aanvraag. Geef een geldige {param} op en probeer het opnieuw. |
...
| `1365-400` | Ongeldig verzoek | Het pad {path} in ops is ongeldig. Geef een geldig pad op {pad} en probeer het opnieuw. |
...
| `1371-400` | Ongeldig verzoek | De detectie van bestandseigenschappen wordt niet ondersteund voor connector {connectorType}. Geef de bestandseigenschappen handmatig op. |
| `1372-400` | Ongeldig verzoek | De huidige bewerking is niet toegestaan. Verkennen via verbindingsspecificatie is niet toegestaan voor verbindingsspecificatie ID={connectionSpecId}. |
...
| `1379-400` | Ongeldig verzoek | Er is een fout opgetreden tijdens het valideren van de invoer {waarde} voor filter bij de bron. Het gegevenstype van de kolom bij de bron is {columnDataType} en value DataType [String] komt niet overeen. Geef een geldige {value} op en probeer het opnieuw. |
...
| `1382-400` | Ongeldig verzoek | De deltabkolom moet overeenkomen met de waarde die aanwezig is in de transformaties van de flow. Geef een geldige deltakolom op en probeer het opnieuw. |
...
| `1384-400` | Ongeldig verzoek | De params={params} die zijn opgegeven voor het maken van flowuitvoering, zijn ongeldig of leeg. Geef geldige parameters op en probeer het opnieuw. |
| `1385-400` | Ongeldig verzoek | De verstrekte connectorType={connectorType} wordt niet ondersteund voor het maken van flowlooppas. Geef een geldig type connector op en probeer het opnieuw. |
| `1386-400` | Ongeldig verzoek | De flowId={flowId} met planningParams frequency={frequency} wordt niet ondersteund voor het maken van flowuitvoering. Geef een geldige frequentie op en probeer het opnieuw. |
| `1387-400` | Ongeldig verzoek | De flowRunId={flowRunId} heeft een ongeldige status={state} om opnieuw te worden geactiveerd. Probeer het later opnieuw en neem contact op met de klantenondersteuning als het probleem zich blijft voordoen. |
| `1388-400` | Ongeldig verzoek | De flow={flow} bevindt zich in state={state} en kan niet opnieuw worden geactiveerd. De flow moet zijn ingeschakeld om opnieuw te worden geactiveerd. |
...
| `1391-400` | Ongeldig verzoek | Kan SchemaMetaData niet parseren in sourceConnection voor Id={sourceConnectionId}. Controleer het schemaMetaData in uw verzoek en probeer het opnieuw. |
| `1392-400` | Ongeldig verzoek | Kan Transformaties niet parseren in stroomverzoek voor flowId={flowId}. Controleer de transformaties in uw verzoek en probeer het opnieuw. |
| `1393-400` | Ongeldig verzoek | De opgegeven parameter {parameter} is null of leeg. Geef een geldige {parameter} op en probeer het opnieuw. |
| `1394-400` | Ongeldig verzoek | De minimumwaarde voor een parameter {parameter} is 1. Geef een geldige {parameter} op en probeer het opnieuw. |
...
| `1396-400` | Ongeldig verzoek | Kan geen overeenkomende indeling vinden. Geef een overeenkomende indeling op en probeer het opnieuw. |
...
| `1398-400` | Ongeldig verzoek | De verstrekte concrete actie: {action} wordt niet ondersteund. Controleer de opgegeven bewerking en probeer het opnieuw. |
...
| `1401-400` | Ongeldig verzoek | De opgegeven flow run action={flowRunAction} wordt niet ondersteund. Voer een geldige handeling voor het uitvoeren van de flow in en probeer het opnieuw. |
...
| Foutcode | Titel | Gedetailleerd bericht |
| --- | --- | --- |
| `1600-400` | Ongeldig verzoek | Het verzoek kan niet worden verwerkt. {detailsMessage} |
...
| `1602-404` | Bron niet gevonden | De gevraagde bron is niet gevonden. {detailsMessage} |
...
| `1605-401` | Onbevoegd | De gebruiker is niet geautoriseerd. {detailsMessage} |
| `1606-403` | Verboden | De gewenste bewerking is niet toegestaan. {detailsMessage} |
| `1607-412` | Voorwaarde is mislukt | Aan de voorwaarde die wordt gedefinieerd door de headers if-Unmodified-Since of if-None-Match is niet voldaan. {detailsMessage} |
...
| `1702-400` | Ongeldig verzoek | Het SAS Type={sasType} dat voor de landingszone is opgegeven, is niet toegestaan. Geef een geldige SAS op en probeer het opnieuw. |
| `1703-400` | Ongeldig verzoek | Vernieuwen van referenties is niet toegestaan. |
| `1704-400` | Ongeldig verzoek | De sleutels die voor storageAccountName={accountName} in subscriptionId={subscriptionId} en resourceGroupName={resourceGroupName} worden geretourneerd, hebben de verkeerde notatie. Controleer uw aanvraag en probeer het opnieuw. Neem contact op met de ondersteuningsafdeling als het probleem zich blijft voordoen. |
...
| `1708-400` | Ongeldig verzoek | De containerconfiguratie kan niet null zijn in landingZoneType={landingZoneType}. Controleer of de configuratie van de container niet null is en probeer het opnieuw. |
| `1709-400` | Ongeldig verzoek | De SAS-gegevens mogen niet null zijn voor {tokenConfig} in landingZoneType={landingZoneType}. Geef een geldige SAS op in de configuratie en probeer het opnieuw. |
...
| `1711-400` | Ongeldig verzoek | De SAS-gegevens zijn niet gevonden voor de opgegeven gegevenslandingszone van het type: {landingZoneUseCase}. Controleer of de SAS-gegevens voor het opgegeven landingstype zijn verstrekt. |
| `1712-400` | Ongeldig verzoek | De vastgestelde actie voor de landingszone: {actionType} is niet toegestaan. Geef een geldige handeling op voor het aanlanden van gegevens en probeer het opnieuw. |
| `1713-400` | Ongeldig verzoek | Het {OperationType} is niet toegestaan voor het opgegeven {tokenType}. Controleer uw aanvraag en probeer het opnieuw. |
| `1714-400` | Ongeldig verzoek | De clientId={clientId} mag deze bewerking niet uitvoeren. Controleer uw aanvraag met machtigingen en probeer het opnieuw. |
